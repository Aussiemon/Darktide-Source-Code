-- chunkname: @dialogues/generated/circumstance_vo_darkness_psyker_male_a.lua
...
local circumstance_vo_darkness_psyker_male_a = {
	combat_pause_circumstance_unnatural_dark_lights_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_a__asset_unnatural_dark_b_02",
			[2] = "loc_psyker_male_a__asset_unnatural_dark_b_03"
		},
