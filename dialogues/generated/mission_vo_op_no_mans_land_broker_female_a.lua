-- chunkname: @dialogues/generated/mission_vo_op_no_mans_land_broker_female_a.lua

local mission_vo_op_no_mans_land_broker_female_a = {
...
return settings("mission_vo_op_no_mans_land_broker_female_a", mission_vo_op_no_mans_land_broker_female_a)
