-- chunkname: @dialogues/generated/mission_vo_hm_complex_cryptic_b.lua

local mission_vo_hm_complex_cryptic_b = {
...
return settings("mission_vo_hm_complex_cryptic_b", mission_vo_hm_complex_cryptic_b)
