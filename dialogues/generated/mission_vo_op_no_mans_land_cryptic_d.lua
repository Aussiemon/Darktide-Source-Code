-- chunkname: @dialogues/generated/mission_vo_op_no_mans_land_cryptic_d.lua

local mission_vo_op_no_mans_land_cryptic_d = {
...
return settings("mission_vo_op_no_mans_land_cryptic_d", mission_vo_op_no_mans_land_cryptic_d)
