local mission_vo_cm_habs_veteran_male_a = {
	hab_block_void_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_veteran_male_a__region_habculum_01",
			[2.0] = "loc_veteran_male_a__region_habculum_02"
		},
...
return settings("mission_vo_cm_habs_veteran_male_a", mission_vo_cm_habs_veteran_male_a)
