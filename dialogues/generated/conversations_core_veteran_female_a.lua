-- chunkname: @dialogues/generated/conversations_core_veteran_female_a.lua
...
local conversations_core_veteran_female_a = {
	...
	graffiti_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__graffiti_response_01",
			[2] = "loc_veteran_female_a__graffiti_response_02",
		},
		sound_events_duration = {
			[1] = 4.691938,
			[2] = 3.801042,
	...
	info_extraction_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__info_extraction_response_01",
			[2] = "loc_veteran_female_a__info_extraction_response_02",
		},
		sound_events_duration = {
			[1] = 1.113063,
			[2] = 1.792146,
	...
	mission_deception = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__mission_deception_01",
			[2] = "loc_veteran_female_a__mission_deception_02",
		},
		sound_events_duration = {
			[1] = 5.295792,
			[2] = 3.992063,
	...
	mission_retrieve = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__mission_retrieve_01",
			[2] = "loc_veteran_female_a__mission_retrieve_02",
		},
		sound_events_duration = {
			[1] = 5.17275,
			[2] = 6.15225,
	...
	mission_scan = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__mission_scan_01",
			[2] = "loc_veteran_female_a__mission_scan_02",
		},
		sound_events_duration = {
			[1] = 7.592542,
			[2] = 7.433292,
