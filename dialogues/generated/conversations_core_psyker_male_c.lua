-- chunkname: @dialogues/generated/conversations_core_psyker_male_c.lua
...
local conversations_core_psyker_male_c = {
	...
	graffiti_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__graffiti_response_01",
			[2] = "loc_psyker_male_c__graffiti_response_02",
		},
		sound_events_duration = {
			[1] = 3.443635,
			[2] = 5.724573,
	...
	mission_deception = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__mission_deception_01",
			[2] = "loc_psyker_male_c__mission_deception_02",
		},
		sound_events_duration = {
			[1] = 4.739156,
			[2] = 4.037438,
	...
	mission_hack = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__mission_hack_01",
			[2] = "loc_psyker_male_c__mission_hack_02",
		},
		sound_events_duration = {
			[1] = 6.167656,
			[2] = 4.997042,
	...
	mission_retrieve = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__mission_retrieve_01",
			[2] = "loc_psyker_male_c__mission_retrieve_02",
		},
		sound_events_duration = {
			[1] = 2.952854,
			[2] = 3.719729,
	...
	mission_scan = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__mission_scan_01",
			[2] = "loc_psyker_male_c__mission_scan_02",
		},
		sound_events_duration = {
			[1] = 4.850208,
			[2] = 4.655771,
