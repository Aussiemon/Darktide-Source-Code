...
local gameplay_vo_psyker_female_b = {
	...
	seen_enemy_executor = {
		...
		sound_events = {
			...
			"loc_psyker_female_b__seen_enemy_executor_02",
			"loc_psyker_female_b__seen_enemy_executor_03",
			"loc_psyker_female_b__seen_enemy_executor_04",
			"loc_psyker_female_b__seen_enemy_executor_05",
