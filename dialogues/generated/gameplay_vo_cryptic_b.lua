...
local gameplay_vo_cryptic_b = {
	...
	enemy_kill_berserker_quick_agnostic = {
		...
		sound_events_n = 8,
		sound_events = {
			"loc_cryptic_b__quick_agnostic_enemy_kill_a_01",
			"loc_cryptic_b__quick_agnostic_enemy_kill_a_02",
			"loc_cryptic_b__quick_agnostic_enemy_kill_a_03",
			"loc_cryptic_b__quick_agnostic_enemy_kill_a_04",
	...
	enemy_kill_houndmaster = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_cryptic_b__enemy_kill_houndmaster_a_01",
	...
	seen_enemy_houndmaster = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_cryptic_b__seen_enemy_houndmaster_a_01",
	...
	seen_enemy_scab_flamer = {
		...
		sound_events_n = 5,
		sound_events = {
			"loc_cryptic_b__seen_enemy_scab_flamer_a_01",
