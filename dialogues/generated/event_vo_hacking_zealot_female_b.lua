-- chunkname: @dialogues/generated/event_vo_hacking_zealot_female_b.lua
...
local event_vo_hacking_zealot_female_b = {
	...
	response_to_hacking_fix_decode = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_female_b__response_to_hacking_fix_decode_01",
			[2] = "loc_zealot_female_b__response_to_hacking_fix_decode_02",
		},
		sound_events_duration = {
			[1] = 2.100708,
			[2] = 2.543104,
