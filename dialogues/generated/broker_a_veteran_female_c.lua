-- chunkname: @dialogues/generated/broker_a_veteran_female_c.lua

local broker_a_veteran_female_c = {
...
return settings("broker_a_veteran_female_c", broker_a_veteran_female_c)
