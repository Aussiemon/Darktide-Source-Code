-- chunkname: @dialogues/generated/veteran_c.lua

return function ()
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_01_a",
		response = "combat_pause_limited_bolt_on_a_veteran_c_01_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_01_b",
		response = "combat_pause_limited_bolt_on_a_veteran_c_01_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_02_a",
		response = "combat_pause_limited_bolt_on_a_veteran_c_02_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_02_b",
		response = "combat_pause_limited_bolt_on_a_veteran_c_02_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_03_a",
		response = "combat_pause_limited_bolt_on_a_veteran_c_03_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_03_b",
		response = "combat_pause_limited_bolt_on_a_veteran_c_03_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_04_a",
		response = "combat_pause_limited_bolt_on_a_veteran_c_04_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_c",
		name = "combat_pause_limited_bolt_on_a_veteran_c_04_b",
		response = "combat_pause_limited_bolt_on_a_veteran_c_04_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
