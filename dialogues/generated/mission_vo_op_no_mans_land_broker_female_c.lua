-- chunkname: @dialogues/generated/mission_vo_op_no_mans_land_broker_female_c.lua

local mission_vo_op_no_mans_land_broker_female_c = {
...
return settings("mission_vo_op_no_mans_land_broker_female_c", mission_vo_op_no_mans_land_broker_female_c)
