-- chunkname: @dialogues/generated/mission_vo_dm_propaganda_broker_male_a.lua

local mission_vo_dm_propaganda_broker_male_a = {
...
return settings("mission_vo_dm_propaganda_broker_male_a", mission_vo_dm_propaganda_broker_male_a)
