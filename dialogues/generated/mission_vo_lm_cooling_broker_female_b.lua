-- chunkname: @dialogues/generated/mission_vo_lm_cooling_broker_female_b.lua

local mission_vo_lm_cooling_broker_female_b = {
...
return settings("mission_vo_lm_cooling_broker_female_b", mission_vo_lm_cooling_broker_female_b)
