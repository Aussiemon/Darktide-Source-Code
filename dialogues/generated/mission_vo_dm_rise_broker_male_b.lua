-- chunkname: @dialogues/generated/mission_vo_dm_rise_broker_male_b.lua

local mission_vo_dm_rise_broker_male_b = {
...
return settings("mission_vo_dm_rise_broker_male_b", mission_vo_dm_rise_broker_male_b)
