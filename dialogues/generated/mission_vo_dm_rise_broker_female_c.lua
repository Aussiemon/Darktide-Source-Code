-- chunkname: @dialogues/generated/mission_vo_dm_rise_broker_female_c.lua

local mission_vo_dm_rise_broker_female_c = {
...
return settings("mission_vo_dm_rise_broker_female_c", mission_vo_dm_rise_broker_female_c)
