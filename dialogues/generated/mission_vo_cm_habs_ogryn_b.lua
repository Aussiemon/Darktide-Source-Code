local mission_vo_cm_habs_ogryn_b = {
	hab_block_void_response_b = {
		randomize_indexes_n = 0,
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__region_habculum_01",
			[2.0] = "loc_ogryn_b__region_habculum_02"
		},
	...
	level_hab_block_atrium = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_atrium_01",
			[2.0] = "loc_ogryn_b__level_hab_block_atrium_02"
		},
		sound_events_duration = {
			[1.0] = 2.272979,
			[2.0] = 2.579135
	...
	level_hab_block_b_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_b_response_b_01",
			[2.0] = "loc_ogryn_b__level_hab_block_b_response_b_02"
		},
		sound_events_duration = {
			[1.0] = 3.409188,
			[2.0] = 3.276302
	...
	level_hab_block_market_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_market_response_01",
			[2.0] = "loc_ogryn_b__level_hab_block_market_response_02"
		},
		sound_events_duration = {
			[1.0] = 4.506083,
			[2.0] = 2.757052
	...
	level_hab_block_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_void_01",
			[2.0] = "loc_ogryn_b__level_hab_block_void_02"
		},
		sound_events_duration = {
			[1.0] = 3.571948,
			[2.0] = 3.655
	...
	level_hab_block_temple = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_temple_01",
			[2.0] = "loc_ogryn_b__level_hab_block_temple_02"
		},
		sound_events_duration = {
			[1.0] = 1.996521,
			[2.0] = 1.531125
	...
	level_hab_block_vista = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_b__level_hab_block_vista_01",
			[2.0] = "loc_ogryn_b__level_hab_block_vista_02"
		},
		sound_events_duration = {
			[1.0] = 4.203073,
			[2.0] = 1.718802
...
return settings("mission_vo_cm_habs_ogryn_b", mission_vo_cm_habs_ogryn_b)
