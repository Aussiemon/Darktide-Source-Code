-- chunkname: @dialogues/generated/mission_vo_dm_forge_ogryn_c.lua
...
local mission_vo_dm_forge_ogryn_c = {
	mission_forge_alive = {
		...
		sound_events = {
			...
			[2] = "loc_ogryn_c__mission_forge_alive_02",
		},
	...
	mission_forge_elevator_conversation_one_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_elevator_conversation_one_a_01",
			[2] = "loc_ogryn_c__mission_forge_elevator_conversation_one_a_02",
		},
		sound_events_duration = {
			[1] = 2.010438,
			[2] = 2.339708,
	...
	mission_forge_elevator_conversation_one_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_elevator_conversation_one_c_01",
			[2] = "loc_ogryn_c__mission_forge_elevator_conversation_one_c_02",
		},
		sound_events_duration = {
			[1] = 6.838646,
			[2] = 5.720385,
	...
	mission_forge_elevator_conversation_three_c = {
		...
		sound_events = {
			...
			[2] = "loc_ogryn_c__mission_forge_elevator_conversation_three_c_02",
		},
		sound_events_duration = {
			[1] = 6.454844,
			[2] = 2.646333,
	...
	mission_forge_elevator_conversation_two_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_elevator_conversation_two_a_01",
			[2] = "loc_ogryn_c__mission_forge_elevator_conversation_two_a_02",
		},
		sound_events_duration = {
			[1] = 4.213469,
			[2] = 4.746448,
	...
	mission_forge_elevator_conversation_two_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_elevator_conversation_two_c_01",
			[2] = "loc_ogryn_c__mission_forge_elevator_conversation_two_c_02",
		},
		sound_events_duration = {
			[1] = 4.086021,
			[2] = 3.815146,
	...
	mission_forge_find_smelter = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_find_smelter_01",
			[2] = "loc_ogryn_c__mission_forge_find_smelter_02",
		},
		sound_events_duration = {
			[1] = 2.923333,
			[2] = 2.938594,
	...
	mission_forge_hellhole = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_hellhole_01",
			[2] = "loc_ogryn_c__mission_forge_hellhole_02",
		},
		sound_events_duration = {
			[1] = 4.240708,
			[2] = 4.4395,
	...
	mission_forge_lifeless = {
		...
		sound_events = {
			...
			[2] = "loc_ogryn_c__mission_forge_lifeless_02",
		},
		sound_events_duration = {
			[1] = 3.998885,
			[2] = 4.365667,
	...
	mission_forge_main_entrance = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_main_entrance_01",
			[2] = "loc_ogryn_c__mission_forge_main_entrance_02",
		},
		sound_events_duration = {
			[1] = 1.491781,
			[2] = 3.254917,
	...
	mission_forge_propaganda = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_propaganda_01",
			[2] = "loc_ogryn_c__mission_forge_propaganda_02",
		},
		sound_events_duration = {
			[1] = 4.708469,
			[2] = 5.907875,
	...
	mission_forge_stand_ground = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_stand_ground_01",
			[2] = "loc_ogryn_c__mission_forge_stand_ground_02",
		},
		sound_events_duration = {
			[1] = 2.925823,
			[2] = 3.536375,
	...
	mission_forge_strategic_asset = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_forge_strategic_asset_01",
			[2] = "loc_ogryn_c__mission_forge_strategic_asset_02",
		},
		sound_events_duration = {
			[1] = 4.876396,
			[2] = 5.453906,
