-- chunkname: @dialogues/generated/event_vo_hacking_zealot_male_b.lua
...
local event_vo_hacking_zealot_male_b = {
	...
	response_to_hacking_fix_decode = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_b__response_to_hacking_fix_decode_01",
			[2] = "loc_zealot_male_b__response_to_hacking_fix_decode_02",
		},
		sound_events_duration = {
			[1] = 2.297333,
			[2] = 2.911167,
