-- chunkname: @dialogues/generated/mission_vo_dm_rise_cryptic_d.lua

local mission_vo_dm_rise_cryptic_d = {
...
return settings("mission_vo_dm_rise_cryptic_d", mission_vo_dm_rise_cryptic_d)
