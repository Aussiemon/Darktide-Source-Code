local mission_vo_cm_habs_ogryn_a = {
	...
	level_hab_block_atrium = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_atrium_01",
			[2.0] = "loc_ogryn_a__level_hab_block_atrium_02"
		},
		sound_events_duration = {
			[1.0] = 2.535469,
			[2.0] = 3.450552
	...
	level_hab_block_b_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_b_response_b_01",
			[2.0] = "loc_ogryn_a__level_hab_block_b_response_b_02"
		},
		sound_events_duration = {
			[1.0] = 0.822313,
			[2.0] = 0.874896
	...
	level_hab_block_market_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_market_response_01",
			[2.0] = "loc_ogryn_a__level_hab_block_market_response_02"
		},
		sound_events_duration = {
			[1.0] = 2.694375,
			[2.0] = 0.80875
	...
	level_hab_block_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_void_01",
			[2.0] = "loc_ogryn_a__level_hab_block_void_02"
		},
		sound_events_duration = {
			[1.0] = 1.939688,
			[2.0] = 1.983729
	...
	level_hab_block_temple = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_temple_01",
			[2.0] = "loc_ogryn_a__level_hab_block_temple_02"
		},
		sound_events_duration = {
			[1.0] = 0.640521,
			[2.0] = 1.997646
	...
	level_hab_block_vista = {
		...
		sound_events_n = 2,
		sound_events = {
			[1.0] = "loc_ogryn_a__level_hab_block_vista_01",
			[2.0] = "loc_ogryn_a__level_hab_block_vista_02"
		},
		sound_events_duration = {
			[1.0] = 1.267167,
			[2.0] = 1.845604
