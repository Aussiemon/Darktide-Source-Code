-- chunkname: @dialogues/generated/psyker_female_a_veteran_male_c.lua

local psyker_female_a_veteran_male_c = {
	bonding_conversation_round_three_serious_b = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_veteran_male_c__bonding_conversation_round_three_serious_b_01",
		},
	...
	bonding_conversation_round_three_serious_d = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_veteran_male_c__bonding_conversation_round_three_serious_d_01",
		},
		sound_events_duration = {
			[1] = 2.844594,
		},
