-- chunkname: @dialogues/generated/mission_vo_lm_rails_cryptic_a.lua

local mission_vo_lm_rails_cryptic_a = {
	mission_rails_disable_skyfire_a = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_cryptic_a__mission_rails_disable_skyfire_a_01",
		},
...
return settings("mission_vo_lm_rails_cryptic_a", mission_vo_lm_rails_cryptic_a)
