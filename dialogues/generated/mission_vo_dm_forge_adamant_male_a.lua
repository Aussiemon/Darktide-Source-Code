-- chunkname: @dialogues/generated/mission_vo_dm_forge_adamant_male_a.lua
...
local mission_vo_dm_forge_adamant_male_a = {
	...
	mission_forge_start_banter_a = {
		...
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_adamant_male_a__mission_forge_start_banter_a_01",
		},
		sound_events_duration = {
			[1] = 4.409115,
		},
	...
	mission_forge_strategic_asset = {
		...
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_adamant_male_a__mission_forge_strategic_asset_01",
		},
		sound_events_duration = {
			[1] = 5.405615,
		},
