-- chunkname: @dialogues/generated/mission_vo_cm_habs_veteran_female_b.lua
...
local mission_vo_cm_habs_veteran_female_b = {
	...
	level_hab_block_atrium = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_atrium_01",
			[2] = "loc_veteran_female_b__level_hab_block_atrium_02",
		},
		sound_events_duration = {
			[1] = 2.437396,
			[2] = 3.847646,
	...
	level_hab_block_b_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_b_response_b_01",
			[2] = "loc_veteran_female_b__level_hab_block_b_response_b_02",
		},
		sound_events_duration = {
			[1] = 1.380333,
			[2] = 3.036708,
	...
	level_hab_block_market_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_market_response_01",
			[2] = "loc_veteran_female_b__level_hab_block_market_response_02",
		},
		sound_events_duration = {
			[1] = 3.021771,
			[2] = 2.808729,
	...
	level_hab_block_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_void_01",
			[2] = "loc_veteran_female_b__level_hab_block_void_02",
		},
		sound_events_duration = {
			[1] = 1.816938,
			[2] = 3.7595,
	...
	level_hab_block_temple = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_temple_01",
			[2] = "loc_veteran_female_b__level_hab_block_temple_02",
		},
		sound_events_duration = {
			[1] = 3.167958,
			[2] = 1.559188,
	...
	level_hab_block_vista = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_b__level_hab_block_vista_01",
			[2] = "loc_veteran_female_b__level_hab_block_vista_02",
		},
		sound_events_duration = {
			[1] = 2.502125,
			[2] = 3.117229,
