-- chunkname: @dialogues/generated/event_vo_hacking_veteran_female_c.lua
...
local event_vo_hacking_veteran_female_c = {
	...
	response_to_hacking_fix_decode = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_c__response_to_hacking_fix_decode_01",
			[2] = "loc_veteran_female_c__response_to_hacking_fix_decode_02",
		},
		sound_events_duration = {
			[1] = 1.703229,
			[2] = 2.425771,
