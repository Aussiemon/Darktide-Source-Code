-- chunkname: @dialogues/generated/mission_vo_fm_cargo_cryptic_d.lua

local mission_vo_fm_cargo_cryptic_d = {
...
return settings("mission_vo_fm_cargo_cryptic_d", mission_vo_fm_cargo_cryptic_d)
