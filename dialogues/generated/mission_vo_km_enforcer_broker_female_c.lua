-- chunkname: @dialogues/generated/mission_vo_km_enforcer_broker_female_c.lua

local mission_vo_km_enforcer_broker_female_c = {
...
return settings("mission_vo_km_enforcer_broker_female_c", mission_vo_km_enforcer_broker_female_c)
