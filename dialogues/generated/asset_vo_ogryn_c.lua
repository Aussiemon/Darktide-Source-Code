-- chunkname: @dialogues/generated/asset_vo_ogryn_c.lua
...
local asset_vo_ogryn_c = {
	...
	asset_cartel_insignia = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_cartel_insignia_01",
			[2] = "loc_ogryn_c__mission_cartel_insignia_02",
		},
		sound_events_duration = {
			[1] = 2.526604,
			[2] = 3.30751,
	...
	asset_goo = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__level_hab_block_goo_01",
			[2] = "loc_ogryn_c__level_hab_block_goo_02",
		},
		sound_events_duration = {
			[1] = 3.954031,
			[2] = 4.947542,
	...
	asset_grease_pit = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__asset_grease_pit_01",
			[2] = "loc_ogryn_c__asset_grease_pit_02",
		},
		sound_events_duration = {
			[1] = 3.335875,
			[2] = 3.323125,
	...
	asset_sigil = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__asset_sigil_01",
			[2] = "loc_ogryn_c__asset_sigil_02",
		},
		sound_events_duration = {
			[1] = 3.096677,
			[2] = 2.026708,
	...
	asset_water_course = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_c__mission_cartel_water_course_01",
			[2] = "loc_ogryn_c__mission_cartel_water_course_02",
		},
		sound_events_duration = {
			[1] = 6.651708,
			[2] = 4.269167,
