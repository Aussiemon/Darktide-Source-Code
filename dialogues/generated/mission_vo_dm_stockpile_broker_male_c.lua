-- chunkname: @dialogues/generated/mission_vo_dm_stockpile_broker_male_c.lua

local mission_vo_dm_stockpile_broker_male_c = {
...
return settings("mission_vo_dm_stockpile_broker_male_c", mission_vo_dm_stockpile_broker_male_c)
