-- chunkname: @dialogues/generated/mission_vo_cm_habs_remake_ogryn_a.lua
...
local mission_vo_cm_habs_remake_ogryn_a = {
	...
	level_hab_block_apartments = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_a__level_hab_block_apartments_01",
	...
	level_hab_block_apartments_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_a__level_hab_block_apartments_response_01",
	...
	level_hab_block_collapse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_a__level_hab_block_collapse_01",
	...
	level_hab_block_corpse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_a__level_hab_block_corpse_01",
	...
	level_hab_block_security = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_ogryn_a__level_hab_block_security_01",
