-- chunkname: @dialogues/generated/mission_vo_cm_raid_zealot_female_b.lua
...
local mission_vo_cm_raid_zealot_female_b = {
	...
	mission_raid_trapped_c = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_female_b__mission_raid_trapped_c_03",
			[2] = "loc_zealot_female_b__mission_raid_trapped_c_04",
		},
		sound_events_duration = {
			[1] = 1.453667,
			[2] = 2.421438,
