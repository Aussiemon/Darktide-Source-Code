-- chunkname: @dialogues/generated/mission_vo_cm_habs_remake_psyker_male_c.lua
...
local mission_vo_cm_habs_remake_psyker_male_c = {
	info_extraction_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__info_extraction_response_01",
			[2] = "loc_psyker_male_c__info_extraction_response_02",
		},
	...
	level_hab_block_apartments = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__level_hab_block_apartments_01",
			[2] = "loc_psyker_male_c__level_hab_block_apartments_02",
		},
		sound_events_duration = {
			[1] = 5.342698,
			[2] = 5.80724,
	...
	level_hab_block_apartments_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__level_hab_block_apartments_response_01",
			[2] = "loc_psyker_male_c__level_hab_block_apartments_response_02",
		},
		sound_events_duration = {
			[1] = 3.491479,
			[2] = 4.550177,
	...
	level_hab_block_collapse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__level_hab_block_collapse_01",
			[2] = "loc_psyker_male_c__level_hab_block_collapse_02",
		},
		sound_events_duration = {
			[1] = 1.829115,
			[2] = 1.970417,
	...
	level_hab_block_corpse = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__level_hab_block_corpse_01",
			[2] = "loc_psyker_male_c__level_hab_block_corpse_02",
		},
		sound_events_duration = {
			[1] = 4.499469,
			[2] = 3.896583,
	...
	level_hab_block_security = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_psyker_male_c__level_hab_block_security_01",
			[2] = "loc_psyker_male_c__level_hab_block_security_02",
		},
		sound_events_duration = {
			[1] = 4.356469,
			[2] = 4.729146,
