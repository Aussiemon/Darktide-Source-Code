-- chunkname: @dialogues/generated/mission_vo_hm_cartel_cryptic_d.lua

local mission_vo_hm_cartel_cryptic_d = {
...
return settings("mission_vo_hm_cartel_cryptic_d", mission_vo_hm_cartel_cryptic_d)
