-- chunkname: @dialogues/generated/mission_vo_dm_rise_cryptic_a.lua

local mission_vo_dm_rise_cryptic_a = {
...
return settings("mission_vo_dm_rise_cryptic_a", mission_vo_dm_rise_cryptic_a)
