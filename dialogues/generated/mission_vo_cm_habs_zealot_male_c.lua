-- chunkname: @dialogues/generated/mission_vo_cm_habs_zealot_male_c.lua

local mission_vo_cm_habs_zealot_male_c = {
	...
	level_hab_block_atrium = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_atrium_01",
			[2] = "loc_zealot_male_c__level_hab_block_atrium_02"
		},
		sound_events_duration = {
			[1] = 3.329406,
			[2] = 4.267604
	...
	level_hab_block_b_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_b_response_b_01",
			[2] = "loc_zealot_male_c__level_hab_block_b_response_b_02"
		},
		sound_events_duration = {
			[1] = 3.187104,
			[2] = 2.808792
	...
	level_hab_block_market_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_market_response_01",
			[2] = "loc_zealot_male_c__level_hab_block_market_response_02"
		},
		sound_events_duration = {
			[1] = 3.27749,
			[2] = 5.497146
	...
	level_hab_block_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_void_01",
			[2] = "loc_zealot_male_c__level_hab_block_void_02"
		},
		sound_events_duration = {
			[1] = 4.342219,
			[2] = 4.237219
	...
	level_hab_block_temple = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_temple_01",
			[2] = "loc_zealot_male_c__level_hab_block_temple_02"
		},
		sound_events_duration = {
			[1] = 5.248938,
			[2] = 3.120292
	...
	level_hab_block_temple_response = {
		...
		sound_events = {
			...
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_01",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_02",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_03",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_04",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_05",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_06",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_07",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_08",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_09",
			"loc_zealot_male_c__nurgle_circumstance_prop_growth_a_10"
		},
		sound_events_duration = {
			1.467917,
			2.287448,
	...
	level_hab_block_vista = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_c__level_hab_block_vista_01",
			[2] = "loc_zealot_male_c__level_hab_block_vista_02"
		},
		sound_events_duration = {
			[1] = 3.318802,
			[2] = 4.914688
...
return settings("mission_vo_cm_habs_zealot_male_c", mission_vo_cm_habs_zealot_male_c)
