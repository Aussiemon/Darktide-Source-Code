-- chunkname: @dialogues/generated/event_vo_hacking_zealot_male_a.lua
...
local event_vo_hacking_zealot_male_a = {
	...
	response_to_hacking_fix_decode = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_zealot_male_a__response_to_hacking_fix_decode_01",
			[2] = "loc_zealot_male_a__response_to_hacking_fix_decode_02",
		},
		sound_events_duration = {
			[1] = 2.318854,
			[2] = 2.068375,
