...
return function ()
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "crafting_complete_dislikes_character",
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "crafting_complete_likes_character",
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "hub_idle_crafting_dislikes_character",
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "hub_idle_crafting_likes_character",
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "tech_priest_distance_dislikes_character",
	...
	define_rule({
		category = "npc_prio_0",
		database = "conversations_hub",
		name = "tech_priest_distance_likes_character",
	...
	define_rule({
		...
		concurrent_wwise_event = "play_vox_static_loop",
		database = "conversations_hub",
		name = "tech_priest_goodbye_dislikes_character",
		response = "tech_priest_goodbye_dislikes_character",
		wwise_route = 1,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		...
		concurrent_wwise_event = "play_vox_static_loop",
		database = "conversations_hub",
		name = "tech_priest_goodbye_likes_character",
		response = "tech_priest_goodbye_likes_character",
		wwise_route = 1,
		criterias = {
			{
				"query_context",
