-- chunkname: @dialogues/generated/mission_vo_lm_rails_broker_female_c.lua

local mission_vo_lm_rails_broker_female_c = {
	mission_rails_disable_skyfire_a = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
			[1] = "loc_broker_female_c__mission_rails_disable_skyfire_a_01",
		},
...
return settings("mission_vo_lm_rails_broker_female_c", mission_vo_lm_rails_broker_female_c)
