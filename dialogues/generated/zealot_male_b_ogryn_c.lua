local zealot_male_b_ogryn_c = {
	...
	bonding_conversation_metropolitan_best_way_d = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
	...
	bonding_conversation_metropolitan_heavier_d = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
	...
	bonding_conversation_metropolitan_ogryn_beside_d = {
		randomize_indexes_n = 0,
		sound_events_n = 1,
		sound_events = {
...
return settings("zealot_male_b_ogryn_c", zealot_male_b_ogryn_c)
