-- chunkname: @dialogues/generated/mission_vo_cm_habs_veteran_female_a.lua

local mission_vo_cm_habs_veteran_female_a = {
	...
	level_hab_block_atrium = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_atrium_01",
			[2] = "loc_veteran_female_a__level_hab_block_atrium_02"
		},
		sound_events_duration = {
			[1] = 3.806708,
			[2] = 2.435813
	...
	level_hab_block_b_response_b = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_b_response_b_01",
			[2] = "loc_veteran_female_a__level_hab_block_b_response_b_02"
		},
		sound_events_duration = {
			[1] = 1.457813,
			[2] = 0.947688
	...
	level_hab_block_market_response = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_market_response_01",
			[2] = "loc_veteran_female_a__level_hab_block_market_response_02"
		},
		sound_events_duration = {
			[1] = 3.420313,
			[2] = 1.814479
	...
	level_hab_block_start_banter_a = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_void_01",
			[2] = "loc_veteran_female_a__level_hab_block_void_02"
		},
		sound_events_duration = {
			[1] = 3.541063,
			[2] = 2.923729
	...
	level_hab_block_temple = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_temple_01",
			[2] = "loc_veteran_female_a__level_hab_block_temple_02"
		},
		sound_events_duration = {
			[1] = 2.339708,
			[2] = 2.900042
	...
	level_hab_block_vista = {
		...
		sound_events_n = 2,
		sound_events = {
			[1] = "loc_veteran_female_a__level_hab_block_vista_01",
			[2] = "loc_veteran_female_a__level_hab_block_vista_02"
		},
		sound_events_duration = {
			[1] = 3.937833,
			[2] = 4.316042
...
return settings("mission_vo_cm_habs_veteran_female_a", mission_vo_cm_habs_veteran_female_a)
