-- chunkname: @dialogues/generated/mission_vo_lm_cooling_cryptic_c.lua

local mission_vo_lm_cooling_cryptic_c = {
...
return settings("mission_vo_lm_cooling_cryptic_c", mission_vo_lm_cooling_cryptic_c)
