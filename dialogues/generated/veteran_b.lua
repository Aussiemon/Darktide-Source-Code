...
return function ()
	define_rule({
		...
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_01_a",
		response = "combat_pause_limited_bolt_on_a_veteran_b_01_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_01_b",
		response = "combat_pause_limited_bolt_on_a_veteran_b_01_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_02_a",
		response = "combat_pause_limited_bolt_on_a_veteran_b_02_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_02_b",
		response = "combat_pause_limited_bolt_on_a_veteran_b_02_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_03_a",
		response = "combat_pause_limited_bolt_on_a_veteran_b_03_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_03_b",
		response = "combat_pause_limited_bolt_on_a_veteran_b_03_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_04_a",
		response = "combat_pause_limited_bolt_on_a_veteran_b_04_a",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
	...
	define_rule({
		category = "conversations_prio_1",
		database = "veteran_b",
		name = "combat_pause_limited_bolt_on_a_veteran_b_04_b",
		response = "combat_pause_limited_bolt_on_a_veteran_b_04_b",
		wwise_route = 0,
		criterias = {
			{
				"query_context",
