-- chunkname: @core/scripts/common/light_controller_utilities.lua

local LightControllerUtilities = {}

LightControllerUtilities.set_enabled = function (unit, is_enabled, fake_light)
...
LightControllerUtilities.set_intensity = function (unit)
	local num_lights = Unit.num_lights(unit)
...
LightControllerUtilities.set_flicker = function (unit, is_enabled, flicker_name)
...
LightControllerUtilities.register_flicker_configurations = function (configurations)
