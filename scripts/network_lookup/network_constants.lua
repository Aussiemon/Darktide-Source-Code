...
_check_network_lookup_boundaries("line_effect_id", "line_effects")
...
_check_network_lookup_boundaries("lookup_4bit", "projectile_template_effects")
_check_network_lookup_boundaries("lookup_3bit", "force_field_unit_names")
