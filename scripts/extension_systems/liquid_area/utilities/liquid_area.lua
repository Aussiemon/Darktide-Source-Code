...
LiquidArea.try_create = function (position, flow_direction, nav_world, liquid_area_template, optional_source_unit, optional_max_liquid, optional_not_on_other_liquids, optional_source_item)
	...
	local liquid_unit = Managers.state.unit_spawner:spawn_network_unit(nil, UNIT_TEMPLATE_NAME, nav_mesh_position, nil, nil, liquid_area_template, flow_direction, optional_source_unit, optional_max_liquid, nil, optional_source_item)
...
LiquidArea.paint = function (liquid_paint_id, max_liquid_paint_distance, position, nav_world, liquid_area_template, allow_liquid_unit_creation, optional_brush_size, optional_not_on_other_liquids, optional_source_unit, optional_source_item)
	...
	if not liquid_unit and allow_liquid_unit_creation then
		...
		liquid_unit = Managers.state.unit_spawner:spawn_network_unit(nil, UNIT_TEMPLATE_NAME, nav_mesh_position, nil, nil, liquid_area_template, flow_direction, optional_source_unit, max_liquid, liquid_paint_id, optional_source_item)
	end
