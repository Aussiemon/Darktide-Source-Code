...
LiquidAreaExtension.init = function (self, extension_init_context, unit, extension_init_data, game_object_data)
	...
	if additional_unit_vfx then
		self._additional_unit_particle_id = World.create_particles(self._world, additional_unit_vfx, unit_position, nil, nil, self._liquid_particle_group)
	end
...
LiquidAreaExtension._create_liquid = function (self, real_index, angle)
	...
	if vfx_name_rim then
		particle_id = World.create_particles(self._world, vfx_name_rim, from, rotation, nil, self._liquid_particle_group)
	end
...
LiquidAreaExtension._set_filled = function (self, real_index)
	...
	if vfx_name_filled then
		...
		if self._drawer then
			...
			liquid.particle_id = World.create_particles(world, vfx_name_filled, position, rotation, nil, self._liquid_particle_group)
		end
	else
