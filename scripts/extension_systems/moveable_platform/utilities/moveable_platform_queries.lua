local MoveablePlatformQueries = {
	interaction_hud_description = function (moveable_platform_extension, interactable_actor_node_index)
	...
	activate_platform = function (moveable_platform_extension, interactable_actor_node_index)
		local interactables = moveable_platform_extension:get_interactables()
	...
	interaction_offset = function (platform_unit, moveable_platform_extension, interactable_actor_node_index)
		local interactables = moveable_platform_extension:get_interactables()
