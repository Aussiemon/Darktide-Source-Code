...
local CoverSlots = {
	...
	create = function (physics_world, nav_world, unit, cover_type, node_positions)
		...
		for i = 1, num_node_positions, 1 do
			repeat
				...
				if slot_width <= distance_to_node_rounded then
					...
					elseif cover_type == cover_types.low then
						...
						for j = 1, num_fitting_slots, 1 do
	...
	_add_slot = function (physics_world, unit, navmesh_position, slot_position, left, cover_type, nav_world, cover_slots)
		local above = 1
		local below = 1
	...
	_generate_slot_peek_types = function (physics_world, cover_slot, cover_type, position_on_navmesh)
	...
	_navmesh_los_check = function (physics_world, position, position_on_navmesh, z_offset)
	...
	_double_raycast_los_check = function (physics_world, offset_z_position, los_from_position, los_to_position)
