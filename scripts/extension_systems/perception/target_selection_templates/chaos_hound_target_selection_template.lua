-- chunkname: @scripts/extension_systems/perception/target_selection_templates/chaos_hound_target_selection_template.lua
...
target_selection_template.chaos_hound = function (unit, side, perception_component, buff_extension, breed, target_units, line_of_sight_lookup, t, threat_units, force_new_target_attempt, force_new_target_attempt_config_or_nil, debug_target_weighting_or_nil)
