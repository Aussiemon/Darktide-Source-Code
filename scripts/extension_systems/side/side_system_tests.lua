...
local function init_and_run_tests(side_system_object)
	...
	side_system:_remove_unit_from_tag_units("player_unit_2", unit_extension_data.player_unit_2)
	...
	side_system:_remove_unit_from_tag_units("player_unit_1", unit_extension_data.player_unit_1)
	side_system:_remove_unit_from_side("player_unit_1")
	side_system:_remove_unit_from_tag_units("player_unit_3", unit_extension_data.player_unit_3)
	...
	side_system:_remove_unit_from_tag_units("minion_1", unit_extension_data.minion_1)
	side_system:_remove_unit_from_tag_units("minion_2", unit_extension_data.minion_2)
	side_system:_remove_unit_from_tag_units("minion_3", unit_extension_data.minion_3)
	side_system:_remove_unit_from_tag_units("minion_4", unit_extension_data.minion_4)
	side_system:_remove_unit_from_tag_units("minion_5", unit_extension_data.minion_5)
