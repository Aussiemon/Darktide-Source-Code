...
CommunicationWheelPlayerOrientation.pre_update = function (self, main_t, main_dt, input, sensitivity_modifier, rotation_contraints)
	...
	local yaw, pitch = AimAssist.apply_aim_assist(main_t, main_dt, input, targeting_data, aim_assist_ramp_component, combat_ability_action_component, weapon_action_component, orientation.yaw, orientation.pitch, position)
