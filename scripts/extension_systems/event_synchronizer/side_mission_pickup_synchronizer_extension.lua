-- chunkname: @scripts/extension_systems/event_synchronizer/side_mission_pickup_synchronizer_extension.lua
...
SideMissionPickupSynchronizerExtension.start_event = function (self)
	...
	SideMissionPickupSynchronizerExtension.super.start_event(self)
end
