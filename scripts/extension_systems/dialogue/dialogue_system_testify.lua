...
local DialogueSystemTestify = {
	...
	trigger_mission_giver_conversation_starter = function (dialogue_system, mission_giver_conversation_starter_data)
	...
	trigger_vo_on_demand = function (dialogue_system, vo_on_demand_starter_data)
	...
	trigger_vo_query_faction_look_at = function (dialogue_system, look_at_data)
	...
	trigger_vo_query_mission_brief = function (_, mission_brief_data)
	...
	trigger_vo_query_mission_giver_mission_info = function (_, mission_giver_data)
	...
	trigger_vo_query_player_environmental_story_vo = function (dialogue_system, environmental_story_data)
	...
	trigger_vo_query_player_generic_vo = function (dialogue_system, player_generic_mission_vo_data)
	...
	trigger_vo_query_player_look_at = function (dialogue_system, look_at_data)
		local look_at_tag = look_at_data.look_at_tag
		local distance = look_at_data.distance
		local unit = dialogue_system:random_player()
		local dialogue_extension = ScriptUnit.has_extension(unit, "dialogue_system")
	...
	wait_for_dialogue_played = function (dialogue_system)
		if dialogue_system:is_dialogue_playing() then
			return Testify.RETRY
		end
	end,
	wait_for_dialogue_playing = function (dialogue_system, start_time)
