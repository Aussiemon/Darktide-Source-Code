...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/chaos/chaos_armored_hound_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/chaos/chaos_hound_mutator_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/chaos/chaos_ogryn_houndmaster_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/cultist/cultist_vanguard_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/renegade/renegade_plasma_gunner_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/renegade/renegade_vanguard_behavior_tree")
...
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/companion/companion_servo_skull_behavior_tree")
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/sand_vortex/sand_vortex_behavior_tree")
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/nurgle_flies/nurgle_flies_behavior_tree")
_create_behavior_tree_entry("scripts/extension_systems/behavior/trees/valkyrie/attack_valkyrie_behavior_tree")
