...
local conditions = {
	...
	can_activate_ability = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
	...
	is_disabled = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local unit_data_extension = ScriptUnit.extension(unit, "unit_data_system")
	...
	_is_there_threat_to_aid = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
	...
	_has_reached_ally_aid_destination = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
	...
	_has_reached_level_unit_destination = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local navigation_extension = ScriptUnit.extension(unit, "navigation_system")
		local destination = navigation_extension:destination()
		local behavior_component = blackboard.behavior
	...
	can_revive = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local behavior_component = blackboard.behavior
	...
	can_remove_net = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local behavior_component = blackboard.behavior
		local target_ally = perception_component.target_ally
	...
	can_rescue_hogtied = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local behavior_component = blackboard.behavior
		local target_ally = perception_component.target_ally
	...
	can_use_health_station = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local behavior_component = blackboard.behavior
	...
	can_rescue_ledge_hanging = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local behavior_component = blackboard.behavior
		local target_ally = perception_component.target_ally
	...
	can_loot = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
	...
	is_slot_not_wielded = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local unit_data_extension = ScriptUnit.extension(unit, "unit_data_system")
	...
	wrong_slot_for_target_type = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
	...
	has_priority_or_urgent_target = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
	...
	bot_in_melee_range = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local target_enemy = perception_component.target_enemy
	...
	has_target = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local target_enemy = perception_component.target_enemy

		return target_enemy ~= nil
	end,
	has_target_and_ammo_greater_than = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local target_enemy = perception_component.target_enemy
	...
	should_reload = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local target_enemy_type = perception_component.target_enemy_type
	...
	should_vent_overheat = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local perception_component = blackboard.perception
		local target_enemy_type = perception_component.target_enemy_type
	...
	cant_reach_ally = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
	...
	is_too_far_from_ally = function (unit, blackboard, scratchpad, condition_args, action_data, is_running)
		local group_extension = ScriptUnit.extension(unit, "group_system")
		local bot_group_data = group_extension:bot_group_data()
		local follow_unit = bot_group_data.follow_unit
		local follow_component = blackboard.follow
