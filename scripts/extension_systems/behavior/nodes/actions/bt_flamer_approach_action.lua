...
BtFlamerApproachAction.leave = function (self, unit, breed, blackboard, scratchpad, action_data, t, reason, destroy)
...
BtFlamerApproachAction.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t)
...
BtFlamerApproachAction._start_move_anim = function (self, unit, t, behavior_component, scratchpad, action_data)
...
BtFlamerApproachAction._rotate_towards_target_unit = function (self, unit, scratchpad, target_unit)
