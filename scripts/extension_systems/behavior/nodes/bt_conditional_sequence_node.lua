-- chunkname: @scripts/extension_systems/behavior/nodes/bt_conditional_sequence_node.lua
...
local BtConditionalSequenceNode = class("BtConditionalSequenceNode", "BtNode")
...
BtConditionalSequenceNode.init_values = function (self, blackboard, action_data, node_data)
	BtConditionalSequenceNode.super.init_values(self, blackboard, action_data, node_data)
...
BtConditionalSequenceNode.leave = function (self, unit, breed, blackboard, scratchpad, action_data, t, reason, destroy, node_data)
	local node_identifier = self.identifier

	_reset_child_to_run_index(node_data, node_identifier)
end

BtConditionalSequenceNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtConditionalSequenceNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
...
return BtConditionalSequenceNode
