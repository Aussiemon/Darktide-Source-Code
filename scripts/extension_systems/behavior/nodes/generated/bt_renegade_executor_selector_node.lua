-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_executor_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local BtRenegadeExecutorSelectorNode = class("BtRenegadeExecutorSelectorNode", "BtNode")

BtRenegadeExecutorSelectorNode.init = function (self, ...)
	BtRenegadeExecutorSelectorNode.super.init(self, ...)

	self._children = {}
end

BtRenegadeExecutorSelectorNode.init_values = function (self, blackboard, action_data, node_data)
...
BtRenegadeExecutorSelectorNode.add_child = function (self, node)
	self._children[#self._children + 1] = node
end

BtRenegadeExecutorSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtRenegadeExecutorSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
