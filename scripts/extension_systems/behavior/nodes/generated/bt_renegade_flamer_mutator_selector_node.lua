-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_flamer_mutator_selector_node.lua
...
BtRenegadeFlamerMutatorSelectorNode.init = function (self, ...)
	BtRenegadeFlamerMutatorSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtRenegadeFlamerMutatorSelectorNode.add_child = function (self, node)
	BtRenegadeFlamerMutatorSelectorNode.super.add_child(self, node)
...
BtRenegadeFlamerMutatorSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_weapon_malfunction = children[3]
	...
	do
		local node_melee_attack = children[4]
	...
	do
		local node_aggroed_patrol = children[7]
...
BtRenegadeFlamerMutatorSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
