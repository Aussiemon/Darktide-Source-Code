-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_sniper_selector_node.lua
...
BtRenegadeSniperSelectorNode.init = function (self, ...)
	BtRenegadeSniperSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtRenegadeSniperSelectorNode.add_child = function (self, node)
	BtRenegadeSniperSelectorNode.super.add_child(self, node)
...
BtRenegadeSniperSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
