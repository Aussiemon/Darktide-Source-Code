-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_daemonhost_selector_node.lua
...
BtChaosDaemonhostSelectorNode.add_child = function (self, node)
	BtChaosDaemonhostSelectorNode.super.add_child(self, node)
