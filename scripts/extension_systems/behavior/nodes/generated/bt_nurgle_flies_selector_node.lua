...
BtNurgleFliesSelectorNode.init_values = function (self, blackboard, action_data, node_data)
	BtNurgleFliesSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
BtNurgleFliesSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_nurgle_flies_chase_target = children[2]
