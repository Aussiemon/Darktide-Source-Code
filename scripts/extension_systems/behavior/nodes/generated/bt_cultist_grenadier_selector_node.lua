-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_cultist_grenadier_selector_node.lua
...
BtCultistGrenadierSelectorNode.init = function (self, ...)
	BtCultistGrenadierSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtCultistGrenadierSelectorNode.add_child = function (self, node)
	BtCultistGrenadierSelectorNode.super.add_child(self, node)
...
BtCultistGrenadierSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtCultistGrenadierSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
