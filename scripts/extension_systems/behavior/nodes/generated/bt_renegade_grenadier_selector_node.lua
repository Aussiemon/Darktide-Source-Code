-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_grenadier_selector_node.lua
...
BtRenegadeGrenadierSelectorNode.init = function (self, ...)
	BtRenegadeGrenadierSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtRenegadeGrenadierSelectorNode.add_child = function (self, node)
	BtRenegadeGrenadierSelectorNode.super.add_child(self, node)
...
BtRenegadeGrenadierSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_close_combat = children[4]
	...
	do
		local node_far_combat = children[5]
...
BtRenegadeGrenadierSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
