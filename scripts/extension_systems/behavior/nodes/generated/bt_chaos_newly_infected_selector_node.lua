-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_newly_infected_selector_node.lua
...
BtChaosNewlyInfectedSelectorNode.init = function (self, ...)
	BtChaosNewlyInfectedSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtChaosNewlyInfectedSelectorNode.add_child = function (self, node)
	BtChaosNewlyInfectedSelectorNode.super.add_child(self, node)
...
BtChaosNewlyInfectedSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtChaosNewlyInfectedSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
