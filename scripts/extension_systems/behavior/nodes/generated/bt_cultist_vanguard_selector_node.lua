-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_cultist_vanguard_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local Profiler_start = Profiler.start
local Profiler_stop = Profiler.stop
local BtCultistVanguardSelectorNode = class("BtCultistVanguardSelectorNode", "BtNode")

BtCultistVanguardSelectorNode.init = function (self, ...)
	BtCultistVanguardSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtCultistVanguardSelectorNode.add_child = function (self, node)
	BtCultistVanguardSelectorNode.super.add_child(self, node)
...
BtCultistVanguardSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtCultistVanguardSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtCultistVanguardSelectorNode
