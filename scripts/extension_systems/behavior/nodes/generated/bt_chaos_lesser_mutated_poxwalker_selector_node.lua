-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_lesser_mutated_poxwalker_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local BtChaosLesserMutatedPoxwalkerSelectorNode = class("BtChaosLesserMutatedPoxwalkerSelectorNode", "BtNode")

BtChaosLesserMutatedPoxwalkerSelectorNode.init = function (self, ...)
	BtChaosLesserMutatedPoxwalkerSelectorNode.super.init(self, ...)

	self._children = {}
end

BtChaosLesserMutatedPoxwalkerSelectorNode.init_values = function (self, blackboard, action_data, node_data)
...
BtChaosLesserMutatedPoxwalkerSelectorNode.add_child = function (self, node)
	self._children[#self._children + 1] = node
end

BtChaosLesserMutatedPoxwalkerSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtChaosLesserMutatedPoxwalkerSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
