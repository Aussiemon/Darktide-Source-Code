-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_vanguard_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local Profiler_start = Profiler.start
local Profiler_stop = Profiler.stop
local BtRenegadeVanguardSelectorNode = class("BtRenegadeVanguardSelectorNode", "BtNode")

BtRenegadeVanguardSelectorNode.init = function (self, ...)
	BtRenegadeVanguardSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtRenegadeVanguardSelectorNode.add_child = function (self, node)
	BtRenegadeVanguardSelectorNode.super.add_child(self, node)
...
BtRenegadeVanguardSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_use_special_action = children[2]
		local condition_result
	...
	do
		local node_assault_follow = children[6]
...
BtRenegadeVanguardSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtRenegadeVanguardSelectorNode
