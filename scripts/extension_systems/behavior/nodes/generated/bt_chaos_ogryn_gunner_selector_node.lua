-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_ogryn_gunner_selector_node.lua
...
BtChaosOgrynGunnerSelectorNode.init = function (self, ...)
	BtChaosOgrynGunnerSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtChaosOgrynGunnerSelectorNode.add_child = function (self, node)
	BtChaosOgrynGunnerSelectorNode.super.add_child(self, node)
...
BtChaosOgrynGunnerSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_weapon_malfunction = children[7]
...
BtChaosOgrynGunnerSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
