-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_ogryn_houndmaster_selector_node.lua
...
BtChaosOgrynHoundmasterSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
