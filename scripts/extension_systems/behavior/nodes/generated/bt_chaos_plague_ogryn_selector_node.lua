-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_plague_ogryn_selector_node.lua
...
BtChaosPlagueOgrynSelectorNode.init = function (self, ...)
	BtChaosPlagueOgrynSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtChaosPlagueOgrynSelectorNode.add_child = function (self, node)
	BtChaosPlagueOgrynSelectorNode.super.add_child(self, node)
...
BtChaosPlagueOgrynSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_change_target = children[3]
	...
	do
		local node_melee_combat = children[4]
...
BtChaosPlagueOgrynSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
