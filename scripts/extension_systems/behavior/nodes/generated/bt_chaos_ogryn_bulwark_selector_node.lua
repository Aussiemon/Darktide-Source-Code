-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_ogryn_bulwark_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local BtChaosOgrynBulwarkSelectorNode = class("BtChaosOgrynBulwarkSelectorNode", "BtNode")

BtChaosOgrynBulwarkSelectorNode.init = function (self, ...)
	BtChaosOgrynBulwarkSelectorNode.super.init(self, ...)

	self._children = {}
end

BtChaosOgrynBulwarkSelectorNode.init_values = function (self, blackboard, action_data, node_data)
...
BtChaosOgrynBulwarkSelectorNode.add_child = function (self, node)
	self._children[#self._children + 1] = node
end

BtChaosOgrynBulwarkSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtChaosOgrynBulwarkSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
