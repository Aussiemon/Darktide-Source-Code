-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_hound_mutator_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local BtChaosHoundMutatorSelectorNode = class("BtChaosHoundMutatorSelectorNode", "BtNode")

BtChaosHoundMutatorSelectorNode.init = function (self, ...)
	BtChaosHoundMutatorSelectorNode.super.init(self, ...)

	self._children = {}
end

BtChaosHoundMutatorSelectorNode.init_values = function (self, blackboard, action_data, node_data)
	BtChaosHoundMutatorSelectorNode.super.init_values(self, blackboard, action_data, node_data)
...
BtChaosHoundMutatorSelectorNode.add_child = function (self, node)
	self._children[#self._children + 1] = node
end

BtChaosHoundMutatorSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtChaosHoundMutatorSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
...
return BtChaosHoundMutatorSelectorNode
