-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_mutator_daemonhost_selector_node.lua

require("scripts/extension_systems/behavior/nodes/bt_node")

local BtChaosMutatorDaemonhostSelectorNode = class("BtChaosMutatorDaemonhostSelectorNode", "BtNode")

BtChaosMutatorDaemonhostSelectorNode.init = function (self, ...)
	BtChaosMutatorDaemonhostSelectorNode.super.init(self, ...)

	self._children = {}
end

BtChaosMutatorDaemonhostSelectorNode.init_values = function (self, blackboard, action_data, node_data)
...
BtChaosMutatorDaemonhostSelectorNode.add_child = function (self, node)
	self._children[#self._children + 1] = node
end

BtChaosMutatorDaemonhostSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
...
BtChaosMutatorDaemonhostSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
