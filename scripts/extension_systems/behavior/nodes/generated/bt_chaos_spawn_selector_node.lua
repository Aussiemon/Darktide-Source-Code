...
BtChaosSpawnSelectorNode.init = function (self, ...)
	BtChaosSpawnSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtChaosSpawnSelectorNode.add_child = function (self, node)
	BtChaosSpawnSelectorNode.super.add_child(self, node)
...
BtChaosSpawnSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_target_change = children[3]
...
BtChaosSpawnSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
