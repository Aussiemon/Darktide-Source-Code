-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_chaos_armored_infected_selector_node.lua
...
BtChaosArmoredInfectedSelectorNode.init = function (self, ...)
	BtChaosArmoredInfectedSelectorNode.super.init(self, ...)

	self._selector_children = {}
end

BtChaosArmoredInfectedSelectorNode.add_child = function (self, node)
	BtChaosArmoredInfectedSelectorNode.super.add_child(self, node)
...
BtChaosArmoredInfectedSelectorNode.evaluate = function (self, unit, blackboard, scratchpad, dt, t, evaluate_utility, node_data, old_running_child_nodes, new_running_child_nodes, last_leaf_node_running)
	...
	do
		local node_suppressed = children[4]
	...
	do
		local node_far_and_close_combat = children[6]
...
BtChaosArmoredInfectedSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
