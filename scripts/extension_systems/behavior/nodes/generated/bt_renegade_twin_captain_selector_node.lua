-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_renegade_twin_captain_selector_node.lua
...
BtRenegadeTwinCaptainSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
