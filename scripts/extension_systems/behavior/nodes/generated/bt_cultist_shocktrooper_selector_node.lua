-- chunkname: @scripts/extension_systems/behavior/nodes/generated/bt_cultist_shocktrooper_selector_node.lua
...
BtCultistShocktrooperSelectorNode.run = function (self, unit, breed, blackboard, scratchpad, action_data, dt, t, node_data, running_child_nodes)
	local node_identifier = self.identifier
