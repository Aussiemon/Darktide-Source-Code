...
Dodge.check = function (t, unit_data_extension, base_dodge_template, input_source)
...
Dodge.is_dodging = function (unit, attack_type)
	...
	local dodge_linger_time_modifier = dodge_linger_time_modifier_base
