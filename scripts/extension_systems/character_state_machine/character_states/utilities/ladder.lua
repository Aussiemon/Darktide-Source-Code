local Ladder = {
	started_climbing = function (ladder_character_state_component, ladder_unit, is_server, game_session, player_unit_game_object_id, player, player_unit)
	...
	stopped_climbing = function (ladder_character_state_component, ladder_cooldown, is_server, game_session, player_unit_game_object_id, player, player_unit)
	...
	time_in_ladder_anim = function (unit, ladder_unit, breed)
