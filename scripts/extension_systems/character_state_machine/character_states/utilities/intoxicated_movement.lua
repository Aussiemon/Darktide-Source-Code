-- chunkname: @scripts/extension_systems/character_state_machine/character_states/utilities/intoxicated_movement.lua

local HALF_PI = math.pi * 0.5
local _start_stagger
local IntoxicatedMovement = {}

IntoxicatedMovement.update = function (intoxicated_movement_component, character_state_random_component, intoxication_level, dt, t, move_direction, move_speed)
...
function _start_stagger(movement_direction, intoxicated_movement_component, intoxication_level, t, move_speed, seed)
	...
	if do_stagger then
		...
		local random_value_2, random_value_3, random_value_4
