...
local Netted = {
	enter = function (unit, animation_extension, fx_extension, breed, attacker_breed, locomotion_steering_component, movement_state_component, t)
	...
	try_exit = function (unit, inventory_component, visual_loadout_extension, unit_data_extension, t)
	...
	exit = function (unit, unit_data_extension, t)
	...
	calculate_drag_position = function (locomotion_component, navigation_extension, netting_unit, nav_world)
