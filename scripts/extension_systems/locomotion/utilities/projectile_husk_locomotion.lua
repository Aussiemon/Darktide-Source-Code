-- chunkname: @scripts/extension_systems/locomotion/utilities/projectile_husk_locomotion.lua
...
ProjectileHuskLocomotion.snapshot_is_outdated = function (snapshot, t, fixed_time_step)
