local ProjectileIntegrationData = {
	allocate_integration_data = function ()
	...
	fill_integration_data = function (integration_data, owner_unit, projectile_unit, locomotion_template, radius, mass, position, rotation, direction, speed, momentum, target_unit, target_position)
	...
	mass_radius = function (locomotion_template, optional_locomotion_extension)
