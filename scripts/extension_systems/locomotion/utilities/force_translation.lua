local ForceTranslation = {
	start = function (locomotion_force_translation_component, locomotion_steering_component, force_translation, start_translation, start_time, duration)
	...
	get_translation = function (locomotion_force_translation_component, locomotion_steering_component, t)
	...
	stop = function (locomotion_force_translation_component)
