local ForceRotation = {
	start = function (locomotion_force_rotation_component, locomotion_steering_component, force_rotation, start_rotation, start_time, duration)
	...
	get_rotation = function (locomotion_force_rotation_component, locomotion_steering_component, t)
	...
	stop = function (locomotion_force_rotation_component)
