...
local ProjectileLocomotion = {
	integrate_position = function (physics_world, integration_data, dt, t, time_step_multiplier)
		...
		if min_distance < travel_distance then
			...
			local hits = collisions_enabled and PhysicsWorld.linear_sphere_sweep(physics_world, position, new_position, radius, max_hit, "types", collision_types, "collision_filter", collision_filter, "report_initial_overlap", true)
...
ProjectileLocomotion.integrate = function (physics_world, integration_data, dt, t, is_server, time_step_multiplier)
	if integration_data.integrate then
		local previus_position = integration_data.position
		local new_position = ProjectileLocomotion.integrate_position(physics_world, integration_data, dt, t, time_step_multiplier)
