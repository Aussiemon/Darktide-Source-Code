-- chunkname: @scripts/extension_systems/locomotion/player_husk_locomotion_extension.lua
...
PlayerHuskLocomotionExtension.post_update = function (self, unit, dt, t)
	...
	local lerp_speed = PlayerCharacterConstants.husk_rotation_lerp_speed_3p
	...
	local lerp_rotation = PlayerMovement.calculate_final_unit_rotation(unit, old_rotation, new_rotation, aim_rotation, lerp_t, true)
