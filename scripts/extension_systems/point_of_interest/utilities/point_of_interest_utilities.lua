-- chunkname: @scripts/extension_systems/point_of_interest/utilities/point_of_interest_utilities.lua

local PointOfInterestUtilities = {}

PointOfInterestUtilities.can_raycast = function (physics_world, unit, target, ray_position, ray_direction, ray_length, ray_collision_filter)
...
PointOfInterestUtilities.is_in_range = function (observer_position, target_position, observer_forward, view_distance_sq, view_half_angle)
