-- chunkname: @scripts/extension_systems/weapon/actions/action_overload_charge_target_finder.lua
...
ActionOverloadChargeTargetFinder.init = function (self, action_context, action_params, action_settings)
	...
	self._targeting_module = ActionModules[target_finder_module_class_name]:new(is_server, self._physics_world, player_unit, action_module_target_finder_component, action_settings)
end
...
ActionOverloadChargeTargetFinder.fixed_update = function (self, dt, t, time_in_action, frame)
