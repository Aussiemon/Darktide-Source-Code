...
ActionChargeAim.init = function (self, action_context, action_params, action_settings)
...
ActionChargeAim.start = function (self, action_settings, t, time_scale, action_start_params)
...
ActionChargeAim.fixed_update = function (self, dt, t, time_in_action)
