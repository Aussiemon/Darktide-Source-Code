-- chunkname: @scripts/extension_systems/weapon/actions/action_position_finder.lua
...
ActionPositionFinder.init = function (self, action_context, action_params, action_settings)
...
ActionPositionFinder.start = function (self, action_settings, t, time_scale, action_start_params)
...
ActionPositionFinder.fixed_update = function (self, dt, t, time_in_action)
	self._position_finder_module:fixed_update(dt, t)
end

ActionPositionFinder.finish = function (self, reason, data, t, time_in_action)
