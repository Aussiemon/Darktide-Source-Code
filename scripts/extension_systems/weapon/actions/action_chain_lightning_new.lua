-- chunkname: @scripts/extension_systems/weapon/actions/action_chain_lightning_new.lua
...
ActionChainLightning.init = function (self, action_context, action_params, action_settings)
	...
	self:_action_specific_init(action_context, action_params, action_settings)
	self:_common_init(action_context, action_params, action_settings)
end

ActionChainLightning._common_init = function (self, action_context, action_params, action_settings)
...
ActionChainLightning._action_specific_init = function (self, action_context, action_params, action_settings)
...
ActionChainLightning.start = function (self, action_settings, t, time_scale, action_start_params)
	...
	self:_action_specific_start(action_settings, t, time_scale, action_start_params)
	self:_common_start(action_settings, t, time_scale, action_start_params)
end

ActionChainLightning._common_start = function (self, action_settings, t, time_scale, action_start_params)
...
ActionChainLightning._action_specific_start = function (self, action_settings, t, time_scale, action_start_params)
...
ActionChainLightning.fixed_update = function (self, dt, t, time_in_action)
	self:_common_fixed_update(dt, t, time_in_action)
	self:_action_specific_fixed_update(dt, t, time_in_action)
end

ActionChainLightning._common_fixed_update = function (self, dt, t, time_in_action)
...
ActionChainLightning._action_specific_fixed_update = function (self, dt, t, time_in_action)
...
ActionChainLightning.finish = function (self, reason, data, t, time_in_action, action_settings, next_action_params)
	local chaining_to_same_action_kind = reason == "new_interrupting_action" and data.new_action_kind == "chain_lightning_powerup" and action_settings.keep_chain_data_to_next_action
	local no_damage_on_cleanup_on_chaing_action_kind = action_settings.no_damage_on_cleanup_on_chaing_action_kind
	local no_damage_on_cleanup_on_chaing_action = no_damage_on_cleanup_on_chaing_action_kind and reason == "new_interrupting_action" and data.new_action_kind == no_damage_on_cleanup_on_chaing_action_kind
	local no_damage_on_cleanup = no_damage_on_cleanup_on_chaing_action or action_settings.no_damage_on_cleanup

	self:_stop_looping_shoot_sound()
	self:_action_specific_cleanup_chain_targets(t, time_in_action, next_action_params, chaining_to_same_action_kind, no_damage_on_cleanup)

	if not chaining_to_same_action_kind then
...
ActionChainLightning._action_specific_cleanup_chain_targets = function (self, t, time_in_action, next_action_params, chaining_to_same_action_kind, no_damage_on_cleanup)
	if not self._is_server then
		return
	end
	...
	if chaining_to_same_action_kind and next_action_params then
		next_action_params.chain_root_node = self._chain_root_node
	else
		if not no_damage_on_cleanup then
