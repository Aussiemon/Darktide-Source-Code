-- chunkname: @scripts/extension_systems/weapon/actions/action_throw_luggable.lua
...
ActionThrowLuggable.init = function (self, action_context, ...)
...
ActionThrowLuggable.start = function (self, action_settings, t, time_scale, action_start_params)
...
ActionThrowLuggable.finish = function (self, ...)
...
ActionThrowLuggable.fixed_update = function (self, dt, t, time_in_action)
	local action_throw_luggable_component = self._action_throw_luggable_component
