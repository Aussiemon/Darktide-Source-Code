-- chunkname: @scripts/extension_systems/weapon/actions/utilities/aim_place_util.lua

local AimPlaceUtil = {}

AimPlaceUtil.aim_placement = function (physics_world, place_configuration, first_person_component)
