local SweepSplineVisualizer = {
	draw_splines = function (sweep_spline, drawer, time, combined_spline, control_splines, color)
	...
	draw_point_on_spline = function (sweep_spline, drawer, t, show_rotation, color)
