-- chunkname: @scripts/extension_systems/weapon/actions/action_block_windup.lua
...
ActionBlockWindup.start = function (self, action_settings, t, time_scale, params)
...
ActionBlockWindup.fixed_update = function (self, dt, t, time_in_action, frame)
...
ActionBlockWindup._latest_chain_time = function (self, action_settings)
...
ActionBlockWindup.server_correction_occurred = function (self)
