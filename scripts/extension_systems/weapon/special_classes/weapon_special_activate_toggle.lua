-- chunkname: @scripts/extension_systems/weapon/special_classes/weapon_special_activate_toggle.lua
...
local WeaponSpecialActivateToggle = class("WeaponSpecialActivateToggle")

WeaponSpecialActivateToggle.init = function (self, context, init_data)
...
WeaponSpecialActivateToggle.on_wieldable_slot_equipped = function (self)
	return
end

WeaponSpecialActivateToggle.fixed_update = function (self, dt, t)
...
WeaponSpecialActivateToggle.on_special_activation = function (self, t)
	return
end

WeaponSpecialActivateToggle.on_special_deactivation = function (self, t)
	return
end

WeaponSpecialActivateToggle.on_sweep_action_start = function (self, t)
	return
end

WeaponSpecialActivateToggle.on_sweep_action_finish = function (self, t, num_hit_enemies)
	return
end

WeaponSpecialActivateToggle.process_hit = function (self, t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, damage, result, damage_efficiency, stagger_result, hit_position, attack_direction, abort_attack, optional_origin_slot)
	local special_active = self._inventory_slot_component.special_active
...
WeaponSpecialActivateToggle.blocked_attack = function (self, attacking_unit, block_cost, block_broken, is_perfect_block)
	return
end

WeaponSpecialActivateToggle.on_exit_damage_window = function (self, t, num_hit_enemies, aborted)
	return
end
...
implements(WeaponSpecialActivateToggle, WeaponSpecialInterface)

return WeaponSpecialActivateToggle
