-- chunkname: @scripts/extension_systems/weapon/special_classes/weapon_special_explode_on_impact_cooldown.lua
...
local WeaponSpecialExplodeOnImpactCooldown = class("WeaponSpecialExplodeOnImpactCooldown")

WeaponSpecialExplodeOnImpactCooldown.UPDATE_WHEN_UNWIELDED = true

local DEFAULT_POWER_LEVEL = PowerLevelSettings.default_power_level

WeaponSpecialExplodeOnImpactCooldown.init = function (self, context, init_data)
...
WeaponSpecialExplodeOnImpactCooldown.on_wieldable_slot_equipped = function (self)
	return
end

WeaponSpecialExplodeOnImpactCooldown.fixed_update = function (self, dt, t)
	local inventory_slot_component = self._inventory_slot_component
	local tweak_data = self._tweak_data

	if self._num_hit_enemies <= 0 then
		WeaponSpecial.update_active(t, tweak_data, inventory_slot_component, self._buff_extension, self._input_extension, self._weapon_extension)
	end
...
WeaponSpecialExplodeOnImpactCooldown.process_hit = function (self, t, weapon, action_settings, num_hit_enemies, target_is_alive, target_unit, damage, result, damage_efficiency, stagger_result, hit_position, attack_direction, abort_attack, optional_origin_slot)
...
WeaponSpecialExplodeOnImpactCooldown.blocked_attack = function (self, attacking_unit, block_cost, block_broken, is_perfect_block)
	return
end

WeaponSpecialExplodeOnImpactCooldown.on_special_activation = function (self, t, num_hit_enemies)
	self._num_hit_enemies = 0
...
WeaponSpecialExplodeOnImpactCooldown.on_special_deactivation = function (self, t)
	return
end

WeaponSpecialExplodeOnImpactCooldown.on_sweep_action_start = function (self, t)
	return
end

WeaponSpecialExplodeOnImpactCooldown.on_sweep_action_finish = function (self, t, num_hit_enemies)
...
WeaponSpecialExplodeOnImpactCooldown.on_exit_damage_window = function (self, t, num_hit_enemies)
	if num_hit_enemies and num_hit_enemies > 0 then
		self._weapon_extension:set_wielded_weapon_weapon_special_active(t, false, "max_activations")
	end
...
return WeaponSpecialExplodeOnImpactCooldown
