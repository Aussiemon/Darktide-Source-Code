...
WeaponSpecialShovels.on_wieldable_slot_equipped = function (self)
	return
end
...
WeaponSpecialShovels.blocked_attack = function (self, attacking_unit, block_cost, block_broken, is_perfect_block)
	return
end
