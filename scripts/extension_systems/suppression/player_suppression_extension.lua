-- chunkname: @scripts/extension_systems/suppression/player_suppression_extension.lua
...
PlayerSuppressionExtension.add_suppression = function (self, suppression_hit_cost, hit_position)
	...
	local suppression_hit_clear_timer
	...
	if is_server and mood_extension then
		local passed_low = previous_num_suppression_hits < NUM_HITS_FOR_LOW_SUPPRESSION and num_suppression_hits >= NUM_HITS_FOR_LOW_SUPPRESSION
		local passed_high = previous_num_suppression_hits < NUM_HITS_FOR_HIGH_SUPPRESSION and num_suppression_hits >= NUM_HITS_FOR_HIGH_SUPPRESSION
...
PlayerSuppressionExtension.has_low_suppression = function (self)
	return self._num_suppression_hits >= NUM_HITS_FOR_LOW_SUPPRESSION
end

PlayerSuppressionExtension.has_high_suppression = function (self)
	return self._num_suppression_hits >= NUM_HITS_FOR_HIGH_SUPPRESSION
end
