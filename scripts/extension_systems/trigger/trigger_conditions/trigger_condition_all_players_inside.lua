-- chunkname: @scripts/extension_systems/trigger/trigger_conditions/trigger_condition_all_players_inside.lua
...
TriggerConditionAllPlayersInside.init = function (self, engine_volume_event_system, is_server, volume_unit, only_once, condition_name, evaluates_bots)
...
TriggerConditionAllPlayersInside.filter_passed = function (self, filter_unit, volume_id)
