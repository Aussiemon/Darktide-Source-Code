...
local VeteranAbilityStanceBuff = class("VeteranAbilityStanceBuff", "Buff")

VeteranAbilityStanceBuff.init = function (self, context, template, start_time, instance_id, ...)
	VeteranAbilityStanceBuff.super.init(self, context, template, start_time, instance_id, ...)
end

VeteranAbilityStanceBuff.update_proc_events = function (self, t, proc_events, num_proc_events, portable_random, local_portable_random)
...
VeteranAbilityStanceBuff.duration = function (self)
	local template_data = self._template_data
...
VeteranAbilityStanceBuff.duration_progress = function (self)
	local template_data = self._template_data
...
return VeteranAbilityStanceBuff
