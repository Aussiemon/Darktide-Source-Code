...
scenarios.attack_chains = {
	steps = {
		...
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.powermaul_p3_m1),
...
scenarios.weapon_special = {
	steps = {
		...
		TrainingGroundsSteps.condition_elseif.archetype_is("broker"),
		TrainingGroundsSteps.weapon_special_prompt_dual_shivs,
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.dual_shivs_p1_m1),
		TrainingGroundsSteps.dynamic.scenario_data_set("grenade_objective", "broker_blitz"),
		TrainingGroundsSteps.condition_elseif.archetype_is("cryptic"),
		TrainingGroundsSteps.weapon_special_prompt_powermaul_p3,
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.powermaul_p3_m1),
		TrainingGroundsSteps.condition_else,
		...
		TrainingGroundsSteps.condition_elseif.archetype_is("broker"),
		TrainingGroundsSteps.use_dual_shivs_special_attack,
		TrainingGroundsSteps.condition_else,
...
scenarios.ranged_grenade = {
	steps = {
		...
		TrainingGroundsSteps.condition_elseif.archetype_is("broker"),
		TrainingGroundsSteps.dynamic.scenario_data_set("grenade_objective", "broker_blitz"),
		TrainingGroundsSteps.broker_blitz_prompt,
		TrainingGroundsSteps.stagger_enemies_grenade_loop,
		TrainingGroundsSteps.condition_else,
...
scenarios.cryptic_cooldown_regen = {
	steps = {
		...
		TrainingGroundsSteps.dynamic.equip_item("slot_secondary", TrainingGroundsItemNames.unarmed_training_grounds),
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.powermaul_p3_m1),
		TrainingGroundsSteps.cryptic_cooldown_regen_prompt,
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.dynamic.set_ability_enabled("combat_ability", true, true),
		TrainingGroundsSteps.cryptic_cooldown_regen_loop,
		TrainingGroundsSteps.dynamic.set_ability_enabled("combat_ability", false, false),
		TrainingGroundsSteps.dynamic.delay(2),
		TrainingGroundsSteps.hide_prompt,
		TrainingGroundsSteps.dynamic.delay(post_ui_removed_transition_start_delay),
		TrainingGroundsSteps.dynamic.swap_scenario("training_grounds", "combat_ability"),
...
scenarios.combat_ability = {
	steps = {
		TrainingGroundsSteps.ensure_player_healthy,
		TrainingGroundsSteps.dynamic.teleport_player("player_reset"),
		TrainingGroundsSteps.condition_if.archetype_is("cryptic"),
		TrainingGroundsSteps.dynamic.set_ability_enabled("combat_ability", true, false),
		TrainingGroundsSteps.condition_else,
		TrainingGroundsSteps.dynamic.set_ability_enabled("combat_ability", true, true),
		TrainingGroundsSteps.condition_end,
		TrainingGroundsSteps.dynamic.add_scenario_buff("tg_player_unperceivable"),
		...
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.unarmed_training_grounds),
		TrainingGroundsSteps.dynamic.equip_item("slot_secondary", TrainingGroundsItemNames.unarmed_training_grounds),
		TrainingGroundsSteps.combat_ability_use_prompt_cryptic,
		TrainingGroundsSteps.combat_ability_use_loop_cryptic,
		TrainingGroundsSteps.hide_prompt,
		TrainingGroundsSteps.dynamic.delay(2.5),
		TrainingGroundsSteps.combat_ability_prompt_cryptic,
		TrainingGroundsSteps.combat_ability_loop_cryptic,
		TrainingGroundsSteps.dynamic.set_ability_enabled("combat_ability", false, false),
		TrainingGroundsSteps.dynamic.remove_unique_buff("tg_on_combat_ability_hook"),
		TrainingGroundsSteps.condition_end,
		TrainingGroundsSteps.dynamic.delay(post_scenario_complete_ui_remove_delay),
...
scenarios.cryptic_servo_skull_blitz = {
	steps = {
		...
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.unarmed_training_grounds),
		TrainingGroundsSteps.dynamic.add_scenario_buff("tg_player_unperceivable"),
		TrainingGroundsSteps.cryptic_servo_skull_order_kill_prompt,
		TrainingGroundsSteps.adamant_companion_spawn,
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.cryptic_servo_skull_order_kill_loop,
		TrainingGroundsSteps.dynamic.delay(0.5),
		TrainingGroundsSteps.hide_prompt,
		TrainingGroundsSteps.dynamic.delay(post_ui_removed_transition_start_delay),
		TrainingGroundsSteps.dynamic.teleport_player("player_reset"),
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.cryptic_servo_skull_hacking_prompt,
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.cryptic_servo_skull_hacking_loop,
		TrainingGroundsSteps.dynamic.delay(0.5),
		TrainingGroundsSteps.hide_prompt,
		TrainingGroundsSteps.dynamic.delay(post_ui_removed_transition_start_delay),
		TrainingGroundsSteps.dynamic.teleport_player("player_reset"),
		TrainingGroundsSteps.dynamic.set_ability_enabled("grenade_ability", true, true),
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.cryptic_servo_skull_empower_prompt,
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.cryptic_servo_skull_empower_loop,
		TrainingGroundsSteps.dynamic.delay(1),
		TrainingGroundsSteps.hide_prompt,
		TrainingGroundsSteps.dynamic.delay(post_ui_removed_transition_start_delay),
		TrainingGroundsSteps.dynamic.set_ability_enabled("grenade_ability", false, false),
...
scenarios.healing_self_and_others = {
	steps = {
		...
		TrainingGroundsSteps.dynamic.equip_item("slot_primary", TrainingGroundsItemNames.dual_shivs_p1_m1),
		TrainingGroundsSteps.condition_elseif.archetype_is("cryptic"),
		TrainingGroundsSteps.dynamic.equip_item("slot_secondary", TrainingGroundsItemNames.galvanic_rifle_p1_m1),
		TrainingGroundsSteps.condition_else,
		TrainingGroundsSteps.dynamic.equip_item("slot_secondary", TrainingGroundsItemNames.lasgun_p1_m1),
		TrainingGroundsSteps.condition_end,
		...
		TrainingGroundsSteps.condition_if.archetype_is("broker"),
		TrainingGroundsSteps.dynamic.equip_item("slot_secondary", TrainingGroundsItemNames.dual_autopistols_p1_m1),
		TrainingGroundsSteps.condition_end,
