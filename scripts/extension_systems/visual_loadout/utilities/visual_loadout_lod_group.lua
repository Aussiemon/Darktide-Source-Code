-- chunkname: @scripts/extension_systems/visual_loadout/utilities/visual_loadout_lod_group.lua

local VisualLoadoutLodGroup = {}

VisualLoadoutLodGroup.try_init_and_fetch_lod_group = function (unit, lod_group_name)
