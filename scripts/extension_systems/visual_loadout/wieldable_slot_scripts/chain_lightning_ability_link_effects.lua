...
ChainLightningAbilityLinkEffects._create_chain_root_node = function (self)
...
ChainLightningAbilityLinkEffects._clear_initial_targets = function (self)
...
ChainLightningAbilityLinkEffects.destroy = function (self)
	self:_reset()
end

ChainLightningAbilityLinkEffects.wield = function (self)
	self:_reset()
end

ChainLightningAbilityLinkEffects.unwield = function (self)
	self:_reset()
end

ChainLightningAbilityLinkEffects.update_unit_position = function (self, unit, dt, t)
...
ChainLightningAbilityLinkEffects._find_no_target = function (self, t)
...
ChainLightningAbilityLinkEffects._find_no_target_pos = function (self, t)
...
ChainLightningAbilityLinkEffects._clear_no_target = function (self)
...
ChainLightningAbilityLinkEffects._validate_targets = function (self, t)
	local chain_root_node = self._chain_root_node
...
ChainLightningAbilityLinkEffects._find_new_targets = function (self, t)
...
ChainLightningAbilityLinkEffects._find_new_chain_targets = function (self, t, broadphase, enemy_side_names, max_angle, close_max_angle, vertical_max_angle, max_z_diff, max_jumps, radius, root_target, initial_travel_direction)
	local func_context = self._func_context
	local hit_units = self._hit_units
	local temp_targets = self._temp_targets
...
ChainLightningAbilityLinkEffects._update_fx = function (self, t)
	local temp_targets = self._temp_targets
...
ChainLightningAbilityLinkEffects.update_first_person_mode = function (self, first_person_mode)
	return
end

ChainLightningAbilityLinkEffects._reset = function (self)
	self._next_jump_time = 0
	self._next_no_target_jump_time = 0
