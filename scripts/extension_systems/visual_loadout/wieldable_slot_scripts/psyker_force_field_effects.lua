local PsykerForceFieldEffects = class("PsykerForceFieldEffects")

PsykerForceFieldEffects.init = function (self, context, slot, weapon_template, fx_sources)
...
PsykerForceFieldEffects.fixed_update = function (self, unit, dt, t, frame)
	return
end

PsykerForceFieldEffects.update = function (self, unit, dt, t)
...
PsykerForceFieldEffects.update_first_person_mode = function (self, first_person_mode)
	return
end

PsykerForceFieldEffects.wield = function (self)
	return
end

PsykerForceFieldEffects.unwield = function (self)
	self:_destroy_effects()
end

PsykerForceFieldEffects.destroy = function (self)
	self:_destroy_effects()
end

PsykerForceFieldEffects._update_effects = function (self, dt, t)
...
PsykerForceFieldEffects._destroy_effects = function (self)
	local shield_unit = self._shield_unit
...
return PsykerForceFieldEffects
