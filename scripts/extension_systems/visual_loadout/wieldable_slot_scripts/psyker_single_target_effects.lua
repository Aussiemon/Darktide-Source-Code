...
PsykerSingleTargetEffects._update_targeting_effects = function (self)
	...
	if wwise_event and not old_playing_id then
		wwise_event = not (self._is_local_unit and (not self._is_husk or not has_husk_events)) and wwise_event .. "_husk" or wwise_event
		...
		self._wwise_event_stop = not (self._is_local_unit and (not self._is_husk or not has_husk_events)) and stop_event .. "_husk" or stop_event
