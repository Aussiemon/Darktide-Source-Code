...
WieldedIdlingEffects.init = function (self, context, slot, weapon_template, fx_sources, item, unit_1p, unit_3p)
	...
	local fx_source_name = fx_sources._wielded_idling
...
WieldedIdlingEffects._start_sfx_loop = function (self)
...
WieldedIdlingEffects._stop_sfx_loop = function (self, force_stop)
...
WieldedIdlingEffects._start_vfx_loop = function (self)
	...
	if resolved then
		...
		local vfx_link_unit, vfx_link_node = fx_extension:vfx_spawner_unit_and_node(self._fx_source_name)
...
WieldedIdlingEffects._stop_vfx_loop = function (self, force_stop)
