...
PsykerChainLightningTargetEffects.init = function (self, context, slot, weapon_template, fx_sources)
...
PsykerChainLightningTargetEffects.fixed_update = function (self, unit, dt, t, frame)
	return
end

PsykerChainLightningTargetEffects.update = function (self, unit, dt, t)
...
PsykerChainLightningTargetEffects.update_first_person_mode = function (self, first_person_mode)
	return
end

PsykerChainLightningTargetEffects.wield = function (self)
	return
end

PsykerChainLightningTargetEffects.unwield = function (self)
	self:_destroy_effects()
end

PsykerChainLightningTargetEffects.destroy = function (self)
	self:_destroy_effects()
end

PsykerChainLightningTargetEffects._create_effect = function (self, unit, targeting_fx)
	local targeting_effects = self._targeting_effects
...
PsykerChainLightningTargetEffects._destroy_effect = function (self, unit)
	local world = self._world
	local targeting_effects = self._targeting_effects
...
PsykerChainLightningTargetEffects._destroy_effects = function (self)
	local world = self._world
	local targeting_effects = self._targeting_effects
