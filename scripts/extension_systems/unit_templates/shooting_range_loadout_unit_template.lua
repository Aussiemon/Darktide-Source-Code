-- chunkname: @scripts/extension_systems/unit_templates/shooting_range_loadout_unit_template.lua

local PlayerCharacterConstants = require("scripts/settings/player_character/player_character_constants")
local UnitTemplate = require("scripts/extension_systems/unit_templates/utilities/unit_template")
local GAME_OBJECT_TYPE = "shooting_range_loadout"
local shooting_range_loadout_unit_template = {
