...
Dialogue._initialize_dialogue_extension = function (self)
...
Dialogue.extensions_ready = function (self, world, unit)
...
Dialogue.component_data = {
	...
	dialogue_profile = {
		...
		options_keys = {
			...
			"Broker, Male, The Outlaw",
			"Broker, Male, The Bounty Hunter",
			"Broker, Male, The Anarchist",
			"Broker, Female, The Outlaw",
			"Broker, Female, The Bounty Hunter",
			"Broker, Female, The Anarchist",
