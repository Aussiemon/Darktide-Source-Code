local ImguiWidgetUtilities = {
	...
	wrap_array = function (array, index, step)
		local size = #array
	...
	calculate_max_text_size = function (texts)
		local max_width = 0
		local max_height = 0
	...
	dropdown_value_to_string = function (value, number_format)
	...
	filter_array = function (source_table, result_table, filter_string, filter_function)
	...
	create_unique_label = function (optional_name)
