...
CinematicManagerTestify.deactivate_testify_camera = function (cinematic_manager)
	cinematic_manager:deactivate_testify_camera()
end

CinematicManagerTestify.set_active_testify_camera = function (cinematic_manager, camera)
	cinematic_manager:set_active_testify_camera(camera)
end

CinematicManagerTestify.wait_for_mission_intro = function (cinematic_manager)
