			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/left_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/right_upper_arm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/right_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/left_fullleg_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/right_fullleg_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
	...
	lower_left_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/left_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_right_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/right_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_left_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/left_lower_leg_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_right_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/right_lower_leg_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_hair",
					"slot_face",
					"slot_decal"
		...
		ballistic = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/upper_torso_gib",
