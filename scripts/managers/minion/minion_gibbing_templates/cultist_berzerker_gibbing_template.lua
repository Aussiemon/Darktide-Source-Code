	...
	head = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/head_gib",
				vfx = {
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/head_gib_cap",
				vfx = {
		...
		crushing = {
			...
			stump_settings = {
				stump_attach_node = "j_spine1",
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/head_gib_cap_crushed",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
		...
		sawing = {
			...
			stump_settings = {
				stump_attach_node = "j_spine1",
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/head_gib_cap_sawed",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_left_upper_arm_gib",
						gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_upper_arm_gib",
					...
					stump_settings = {
						stump_attach_node = "j_spine1",
						stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_spawn_node = "j_leftarm",
						gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_left_fullarm_gib",
						gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_right_upper_arm_gib",
						gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_upper_arm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
					...
					stump_settings = {
						stump_attach_node = "j_spine1",
						stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_spawn_node = "j_rightarm",
						gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_right_fullarm_gib",
						gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				{
					...
					stump_settings = {
						...
						stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_upper_leg_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
			...
			conditional = {
				{
					...
					stump_settings = {
						stump_attach_node = "j_hips",
						stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_upper_leg_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
	...
	lower_left_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_left_lower_arm_gib",
				gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/left_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	lower_right_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_right_lower_arm_gib",
				gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/right_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_upper_torso_gib_full",
				gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_head"
				},
				vfx = {
				...
				sfx = {
					node_name = "g_upper_body_gib_full",
					sound_event = "wwise/events/weapon/play_combat_dismember_head_off"
				}
			},
			stump_settings = {
				stump_attach_node = "j_hips",
				stump_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/upper_torso_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
		...
		ballistic = {
			...
			gib_settings = {
				...
				gib_flesh_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/flesh_upper_torso_gib",
				gib_unit = "content/characters/enemy/chaos_cultist_melee_elite/gibbing/upper_torso_gib",
