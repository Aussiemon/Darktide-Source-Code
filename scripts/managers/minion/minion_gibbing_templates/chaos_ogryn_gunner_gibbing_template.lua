	...
	head = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/head_gib",
				vfx = {
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_upper_arm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
					...
					stump_settings = {
						...
						stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_fullarm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_upper_arm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
					...
					stump_settings = {
						stump_attach_node = "j_spine2",
						stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_fullarm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_fullleg_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_fullleg_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
	...
	lower_left_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_lower_arm_gib",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
				},
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	lower_right_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_lower_arm_gib",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
				},
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	lower_left_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/left_lower_leg_gib",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
				},
	...
	lower_right_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/right_lower_leg_gib",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
				},
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/upper_torso_gib_full",
			...
			stump_settings = {
				stump_attach_node = "j_hips",
				stump_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/upper_torso_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
		...
		explosion = {
			...
			},
			{
				...
				gib_settings = {
					...
					gib_unit = "content/characters/enemy/chaos_ogryn/gibbing/ranged_a/upper_torso_gib",
					vfx = {
						particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
						linked = true
					},
