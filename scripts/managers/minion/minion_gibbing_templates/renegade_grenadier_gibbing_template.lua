...
local gibbing_template = {
	name = "renegade_grenadier_gibbing",
	head = {
		default = {
			scale_node = "j_neck",
			gib_settings = {
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/left_upper_arm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/left_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/right_upper_arm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/right_fullarm_gib",
						attach_inventory_slots_to_gib = {},
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
	...
	lower_left_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/left_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_right_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/right_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_face"
				},
				vfx = {
		...
		ballistic = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/grenadier/upper_torso_gib",
