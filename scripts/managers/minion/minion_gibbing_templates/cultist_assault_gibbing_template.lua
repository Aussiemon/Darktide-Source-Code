	...
	head = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_a/head_gib",
				vfx = {
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/head_gib_cap",
				vfx = {
		...
		crushing = {
			...
			stump_settings = {
				stump_attach_node = "j_spine1",
				stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/head_gib_cap_crushed",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
		...
		sawing = {
			...
			stump_settings = {
				stump_attach_node = "j_spine1",
				stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/head_gib_cap_sawed",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/left_upper_arm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
					...
					stump_settings = {
						...
						stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/left_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/left_fullarm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
			...
			conditional = {
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/right_upper_arm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
					...
					stump_settings = {
						stump_attach_node = "j_spine",
						stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/right_upper_arm_gib_cap",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
							linked = true,
							node_name = "fx_blood"
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/right_fullarm_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
	...
	lower_left_arm = {
		default = {
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/left_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	lower_right_arm = {
		default = {
			...
			stump_settings = {
				...
				stump_unit = "content/characters/enemy/chaos_cultists/gibbing/base_a/right_lower_arm_gib_cap",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_fountain_head_01",
					linked = true,
					node_name = "fx_blood"
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_a/upper_torso_gib_full",
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
				},
		...
		ballistic = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_a/upper_torso_gib",
