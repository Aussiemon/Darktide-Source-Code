...
local gibbing_template = {
	name = "cultist_shocktrooper_gibbing",
	head = {
		default = {
			scale_node = "j_neck",
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/head_gib",
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/left_fullleg_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
			...
			conditional = {
				...
				},
				{
					...
					gib_settings = {
						...
						gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/right_fullleg_gib",
						vfx = {
							particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
							linked = true
						},
	...
	lower_left_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/left_lower_leg_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_right_leg = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/right_lower_leg_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_head",
					"slot_face"
				},
		...
		explosion = {
			...
			},
			{
				...
				gib_settings = {
					...
					gib_unit = "content/characters/enemy/chaos_cultists/gibbing/midrange_elite_a/upper_torso_gib",
					vfx = {
						particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
						linked = true
					},
