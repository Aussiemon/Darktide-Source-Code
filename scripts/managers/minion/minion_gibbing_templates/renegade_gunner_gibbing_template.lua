...
local gibbing_template = {
	...
	head = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/longrange_elite_a/head_gib",
	...
	lower_left_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/longrange_elite_a/left_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	lower_right_arm = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/longrange_elite_a/right_lower_arm_gib",
				attach_inventory_slots_to_gib = {},
				vfx = {
					particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
					linked = true
	...
	torso = {
		default = {
			unequip_inventory_slot = " slot_gear_attachment",
			scale_node = "j_spine1",
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/longrange_elite_a/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_decal",
					"slot_head"
				},
		...
		explosion = {
			...
			},
			{
				...
				gib_settings = {
					...
					gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/longrange_elite_a/upper_torso_gib",
					vfx = {
						particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
						linked = true
					},
