...
local gibbing_template = {
	name = "renegade_shocktrooper_gibbing",
	head = {
		default = {
			scale_node = "j_neck",
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/melee_a/face_01_b/head_gib",
	...
	torso = {
		default = {
			...
			gib_settings = {
				...
				gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/midrange_elite_a/upper_torso_gib_full",
				attach_inventory_slots_to_gib = {
					"slot_decal",
					"slot_head",
					"slot_face",
		...
		explosion = {
			...
			},
			{
				...
				gib_settings = {
					...
					gib_unit = "content/characters/enemy/chaos_traitor_guard/gibbing/midrange_elite_a/upper_torso_gib",
					vfx = {
						particle_effect = "content/fx/particles/impacts/flesh/blood_gushing_01",
						linked = true
					},
