-- chunkname: @scripts/managers/party_immaterium/join_permission/steam_join_permission.lua

local Promise = require("scripts/foundation/utilities/promise")
local SteamJoinPermission = {}

SteamJoinPermission.test_play_mutliplayer_permission = function (account_id, platform, platform_user_id, context)
