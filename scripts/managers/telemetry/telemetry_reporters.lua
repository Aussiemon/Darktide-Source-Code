...
local PlayerQuickSwappedReporter = require("scripts/managers/telemetry/reporters/player_quick_swapped_reporter")
...
local REPORTER_CLASS_MAP = {
	...
	player_quick_swapped = PlayerQuickSwappedReporter,
