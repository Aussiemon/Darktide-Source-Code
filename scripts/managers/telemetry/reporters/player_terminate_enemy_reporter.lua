-- chunkname: @scripts/managers/telemetry/reporters/player_terminate_enemy_reporter.lua
...
PlayerTerminateEnemyReporter.init = function (self)
	self._reports = {}
end
...
PlayerTerminateEnemyReporter.register_event = function (self, player, data)
...
PlayerTerminateEnemyReporter.destroy = function (self)
	return
end
