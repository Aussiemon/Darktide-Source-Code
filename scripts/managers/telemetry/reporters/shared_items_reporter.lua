-- chunkname: @scripts/managers/telemetry/reporters/shared_items_reporter.lua
...
SharedItemsReporter.init = function (self)
	self._reports = {}
end
...
SharedItemsReporter.register_event = function (self, player, item_name)
...
SharedItemsReporter.destroy = function (self)
	return
end
