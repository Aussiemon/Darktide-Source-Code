local ValueFunctions = {
	...
	stat = function (triggering_stat, stat_to_read, piped_parameters, fixed_parameters)
		...
		return function (stat_table, _, _, ...)
			for read_index = 1, param_count, 1 do
	...
	param = function (triggering_stat, param_name)
