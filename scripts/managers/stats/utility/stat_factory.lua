...
local StatFactory = {
	...
	add_to_group = function (group, stat_definition, ...)
	...
	create_hook = function (id, params, optional_flags)
		return StatDefinition:new({}, NoSave:new(id, params), optional_flags)
	end,
	create_dynamic_reducer = function (id, stat_to_reduce, in_parameters, activation_function, optional_out_parameters, optional_flags, optional_default_value)
	...
	create_smart_reducer = function (id, stat_to_reduce, in_parameters, transformers, out_parameters, activation_function, optional_flags, optional_default_value)
		return StatDefinition:new({
	...
	create_flag = function (id, listens_to, optional_condition, optional_flags)
	...
	create_flag_checker = function (id, flags, optional_flags, optional_max_amount)
	...
	create_simple = function (id, stat_to_reduce, activation_function, optional_flags, optional_default_value)
		return StatDefinition:new({
			[stat_to_reduce:get_id()] = StatTrigger:new(activation_function)
		}, SingleValue:new(id, optional_default_value), optional_flags)
	end,
	create_transformer = function (id, stat_to_reduce, activation_function, optional_parameter_function, optional_out_params)
		return StatDefinition:new({
			[stat_to_reduce:get_id()] = StatTrigger:new(activation_function, optional_parameter_function)
		}, NoSave:new(id, optional_out_params))
	end,
	create_echo = function (id, stat_to_echo, optional_condition, optional_delay, optional_flags)
	...
	create_in_a_row = function (id, increase_on_stat, reset_on_stat)
		return StatDefinition:new({
	...
	create_sum_over_time = function (id, input_stat, time, optional_condition, optional_flags)
		local condition = optional_condition or Conditions.always_true
