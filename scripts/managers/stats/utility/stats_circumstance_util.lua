...
_create_circumstance_entry("scripts/settings/circumstance/templates/live_event_barrel_grounds_circumstance_template")
...
_create_circumstance_entry("scripts/settings/circumstance/templates/live_event_rotten_armor_circumstance_template")
