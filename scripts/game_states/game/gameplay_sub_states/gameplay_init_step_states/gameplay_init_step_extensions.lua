...
GameplayInitStepExtensions._init_extensions = function (self, world, physics_world, is_server, mission_name, level_name, level_seed, circumstance_name, havoc_data, nav_world, has_navmesh, soft_cap_out_of_bounds_units, vo_sources_cache, fixed_time_step, network_event_delegate)
