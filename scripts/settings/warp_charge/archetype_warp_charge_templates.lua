...
local archetype_warp_charge_templates = {
	default = {
		...
		high_threshold_decay_rate = 0.25,
		high_threshold = 0.8,
		low_threshold = 0.5,
		auto_vent_duration = 120,
		vent_duration = 30,
	...
	psyker = {
		critical_threshold_decay_rate = 0.25,
		low_threshold_decay_rate = 1.5,
		ramping_interval_modifier = 0.925,
		explode_action = "action_warp_charge_explode",
		high_threshold = 0.7,
		auto_vent_duration = 30,
		extreme_threshold = 0.97,
		critical_threshold = 0.9,
		vent_interval = 0.33,
		auto_vent_delay = 5,
		high_threshold_decay_rate = 0.5,
		low_threshold = 0.4,
		vent_duration = 9,
		vent_power_level = {
			0,
