...
gibbing_settings.gibbing_types = table.enum("arc", "ballistic", "boltshell", "crushing", "default", "explosion", "fire", "implosion", "laser", "phosphor", "plasma", "sawing", "toxin", "warp_lightning", "warp_shard", "warp_wind_slash_high", "warp")
