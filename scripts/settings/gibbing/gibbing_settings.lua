...
local gibbing_settings = {
	...
	gibbing_power = gibbing_settings.gibbing_thresholds,
	gibbing_types = table.enum("default", "ballistic", "explosion", "plasma", "crushing", "sawing", "boltshell", "laser", "warp", "fire"),
	gib_push_force_multipliers = {
