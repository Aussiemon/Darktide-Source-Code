-- chunkname: @scripts/settings/weapon_unlock/weapon_unlock_settings_veteran.lua

local veteran_weapon_unlock_settings = {
	{
		level = 1,
		items = {
	...
	},
	{
		level = 23,
		items = {
			"content/items/weapons/player/melee/powersword_p2_m1",
		},
	},
	{
		level = 24,
...
return veteran_weapon_unlock_settings
