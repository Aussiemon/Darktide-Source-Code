-- chunkname: @scripts/settings/expeditions/expedition_names.lua

local expedition_names = {
	{
		display_name = "loc_expeditions_map_alpha",
		material_atlas_index = 1,
	},
	{
		display_name = "loc_expeditions_map_beta",
		material_atlas_index = 2,
	},
	{
		display_name = "loc_expeditions_map_gamma",
		material_atlas_index = 3,
	},
	{
		display_name = "loc_expeditions_map_delta",
		material_atlas_index = 4,
	},
	{
		display_name = "loc_expeditions_map_epsilon",
		material_atlas_index = 5,
	},
	{
		display_name = "loc_expeditions_map_zeta",
...
return settings("ExpeditionNames", expedition_names)
