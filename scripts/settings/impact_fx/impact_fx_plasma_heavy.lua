-- chunkname: @scripts/settings/impact_fx/impact_fx_plasma_heavy.lua
		...
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_bullet_hits_plasmagun_big_gen",
			},
			{
	...
	snow = {
		[hit_types.stop] = {
			sfx = {
				{
					append_husk_to_event_name = true,
					event = "wwise/events/weapon/play_bullet_hits_plasmagun_surface_big_impact_gen",
