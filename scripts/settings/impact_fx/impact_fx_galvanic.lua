-- chunkname: @scripts/settings/impact_fx/impact_fx_galvanic.lua
...
local unarmored = {
		...
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_bullet_hits_galvanic",
			},
			{
	...
	vfx = {
		...
		weakspot_died = {
			...
			{
				effects = {
					"content/fx/particles/impacts/weapons/galvanic_rifle/galvanic_rifle_impact",
				},
			},
			{
				effects = {
		...
		weakspot_damage = {
			...
			{
				effects = {
					"content/fx/particles/impacts/weapons/galvanic_rifle/galvanic_rifle_impact_small",
				},
			},
			{
				effects = {
		...
		vfx = {
			{
				normal_rotation = true,
				effects = {
					"content/fx/particles/impacts/weapons/galvanic_rifle/galvanic_rifle_impact_surface",
				},
			},
		},
	},
