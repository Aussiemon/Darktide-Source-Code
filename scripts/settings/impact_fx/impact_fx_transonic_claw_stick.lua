-- chunkname: @scripts/settings/impact_fx/impact_fx_transonic_claw_stick.lua
		...
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_chord_claw_hit_flesh",
			},
			{
...
local armored = {
	sfx = {
		weakspot_died = {
			{
				append_husk_to_event_name = true,
				event = "wwise/events/weapon/play_chord_claw_hit_armour",
			},
			{
				append_husk_to_event_name = true,
