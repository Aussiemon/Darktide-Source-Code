-- chunkname: @scripts/settings/impact_fx/impact_fx_minion_laser_yellow.lua
...
local unarmored = {
	...
	vfx = {
		...
		weakspot_died = {
			{
				effects = {
					"content/fx/particles/impacts/weapons/lasgun/lasgun_impact_enemy_yellow",
				},
			},
			{
				effects = {
...
local armored = {
	...
	vfx = {
		...
		weakspot_died = {
			...
			{
				effects = {
					"content/fx/particles/impacts/weapons/lasgun/lasgun_sparks_armor_enemy_yellow",
				},
			},
		},
		died = {
