-- chunkname: @scripts/settings/impact_fx/impact_fx_transonic_claw_rip.lua
		...
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_chord_claw_hit_rip_flesh",
			},
			{
...
local armored = {
	sfx = {
		weakspot_died = {
			{
				append_husk_to_event_name = true,
				event = "wwise/events/weapon/play_chord_claw_hit_rip_armour",
			},
			{
				append_husk_to_event_name = true,
