-- chunkname: @scripts/settings/impact_fx/impact_fx_punch.lua
...
local unarmored = {
	sfx = {
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_melee_hits_human_punch_heavy",
			},
		},
		died = {
			{
		...
		damage = {
			{
				append_husk_to_event_name = true,
				event = "wwise/events/weapon/play_melee_hits_human_punch_light",
			},
		},
		damage_reduced = {
			{
