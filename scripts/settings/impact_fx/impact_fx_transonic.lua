-- chunkname: @scripts/settings/impact_fx/impact_fx_transonic.lua
...
local unarmored = {
	sfx = {
		...
		weakspot_died = {
			{
				...
				event = "wwise/events/weapon/play_transonic_blades_impact_hit",
			},
			{
				append_husk_to_event_name = true,
		...
		damage_negated = {
			...
			{
				append_husk_to_event_name = true,
				event = "wwise/events/weapon/play_transonic_blades_impact_hit_shield",
			},
		},
		shield_blocked = {
			{
	...
	vfx = {
		weakspot_died = {
			...
			{
				effects = {
					"content/fx/particles/impacts/weapons/transonic/transonic_impact",
				},
			},
		},
		died = {
