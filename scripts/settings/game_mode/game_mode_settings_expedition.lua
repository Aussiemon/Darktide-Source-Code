-- chunkname: @scripts/settings/game_mode/game_mode_settings_expedition.lua

local settings = {
	bot_backfilling_allowed = true,
	class_file_name = "scripts/managers/game_mode/game_modes/game_mode_expedition",
	default_player_side_name = "heroes",
	dynamic_mesh_spawning = true,
