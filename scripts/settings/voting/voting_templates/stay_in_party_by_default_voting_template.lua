-- chunkname: @scripts/settings/voting/voting_templates/stay_in_party_by_default_voting_template.lua
...
local voting_template = {
	...
	on_completed = function (voting_id, template, params, result)
		...
		Managers.event:trigger("event_stay_in_party_voting_completed", result, Managers.voting:votes(voting_id))
	end,
	on_aborted = function (voting_id, template, params, abort_reason, votes)
		...
		Managers.event:trigger("event_stay_in_party_voting_aborted", votes)
	end,
