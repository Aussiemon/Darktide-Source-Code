...
local material_overrides = {
	...
	face_makeup_01 = {
		texture_overrides = {
			makeup_bca = {
				resource = "content/characters/player/human/attachments_base/makeup/textures/face_makeup_01/face_makeup_01_bca",
			},
			makeup_rmss = {
				resource = "content/characters/player/human/attachments_base/makeup/textures/face_makeup_01/face_makeup_01_rmss",
			},
		},
	},
}
