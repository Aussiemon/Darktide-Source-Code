...
local weapon_traits_ranged_warp_charge = {
	weapon_trait_ranged_warp_charge_wield_increased_vent_speed = {
		weapon_trait_ranged_warp_charge_wield_increased_vent_speed = {
			...
			{
				stat_buffs = {
					[buff_stat_buffs.vent_warp_charge_speed] = 0.82
				}
			},
			{
				stat_buffs = {
					[buff_stat_buffs.vent_warp_charge_speed] = 0.8
				}
			}
		}
	},
	weapon_trait_ranged_warp_charge_wield_reduced_vent_damage_taken = {
		weapon_trait_ranged_warp_charge_wield_reduced_vent_damage_taken = {
			...
			{
				stat_buffs = {
					[buff_stat_buffs.vent_warp_charge_damage_multiplier] = 0.82
				}
			},
			{
				stat_buffs = {
					[buff_stat_buffs.vent_warp_charge_damage_multiplier] = 0.8
				}
			}
		}
	},
	weapon_trait_ranged_warp_charge_wield_reduced_warp_charge_generation_firing = {
		weapon_trait_ranged_warp_charge_wield_reduced_warp_charge_generation_firing = {
			...
			{
				stat_buffs = {
					[buff_stat_buffs.warp_charge_immediate_amount] = 0.82
				}
			},
			{
				stat_buffs = {
					[buff_stat_buffs.warp_charge_immediate_amount] = 0.8
				}
			}
		}
	},
	weapon_trait_ranged_warp_charge_wield_reduced_warp_charge_generation_charging = {
		weapon_trait_ranged_warp_charge_wield_reduced_warp_charge_generation_charging = {
			...
			{
				stat_buffs = {
					[buff_stat_buffs.warp_charge_over_time_amount] = 0.82
				}
			},
			{
				stat_buffs = {
					[buff_stat_buffs.warp_charge_over_time_amount] = 0.8
				}
			}
		}
	},
