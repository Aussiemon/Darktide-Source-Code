-- chunkname: @scripts/settings/equipment/weapon_templates/pocketables/settings_templates/pockatables_template_settings.lua
...
pockatables_template_settings.action_inputs = {
	push = {
		buffer_time = 0.4,
		input_sequence = {
			{
