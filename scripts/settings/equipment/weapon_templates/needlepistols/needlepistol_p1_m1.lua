-- chunkname: @scripts/settings/equipment/weapon_templates/needlepistols/needlepistol_p1_m1.lua
...
weapon_template.displayed_attacks = {
	...
	special = {
		desc = "loc_stats_special_action_chem_swap_needlepistol_p1_m2_desc",
