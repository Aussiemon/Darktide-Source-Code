...
weapon_template.actions = {
	...
	action_wield = {
		...
		allowed_chain_actions = {
			...
			special_action = {
				action_name = "action_shoot_hip_special",
				chain_time = 0.275
			},
			zoom = {
	...
	action_shoot_hip_special = {
		sprint_requires_press_to_interrupt = true,
		kind = "shoot_pellets",
		start_input = "special_action",
		minimum_hold_time = 0.6,
		weapon_handling_template = "shotgun_double_shot",
		sprint_ready_up_time = 0.3,
		allowed_during_sprint = false,
		ammunition_usage = 1,
...
weapon_template.crosshair_type_special_active = "shotgun_wide"
