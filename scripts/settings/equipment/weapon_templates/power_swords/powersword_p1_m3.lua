...
weapon_template.actions = {
	...
	action_right_light_pushfollow = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/power_sword/swing_down",
			anchor_point_offset = {
				-0.03,
				0,
				-0.05
...
weapon_template.base_stats = {
	...
	powersword_p1_m3_cleave_damage_stat = {
	...
	powersword_p1_m3_cleave_targets_stat = {
	...
	powersword_p1_m3_mobility_stat = {
