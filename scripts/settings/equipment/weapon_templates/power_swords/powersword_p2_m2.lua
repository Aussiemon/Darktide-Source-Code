...
weapon_template.actions = {
	...
	action_light_4 = {
		...
		damage_window_start = 0.2791666666666667,
	...
	action_melee_start_push_combo = {
		...
		allowed_chain_actions = {
			...
			light_attack = {
				action_name = "action_light_push_combo",
			},
			heavy_attack = {
				action_name = "action_heavy_2",
				chain_time = 0.5,
...
weapon_template.anim_state_machine_3p = "content/characters/player/human/third_person/animations/power_falchion"
...
weapon_template.special_charge_template = "powersword_p2_m2_weapon_special"
