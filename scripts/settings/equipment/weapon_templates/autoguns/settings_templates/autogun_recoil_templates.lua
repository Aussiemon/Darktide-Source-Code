...
local burst_offset_range = generate_offset_range(40, 0.02, 0, 0.95, create_scale(burst_scale))
local burst_random_range = generate_offset_range(40, 0.01, 0.02, 0.95, create_scale(burst_random_scale))
local singleshot_offset_range = generate_offset_range(6, 0.0325, 0, 0.8, create_scale(singleshot_scale))
