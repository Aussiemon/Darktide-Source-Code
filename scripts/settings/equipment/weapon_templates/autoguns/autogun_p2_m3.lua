...
weapon_template.base_stats = {
	autogun_p2_m3_dps_stat = {
		description = "loc_trait_description_autogun_p2_m3_dps_stat",
	...
	autogun_p2_m3_ammo_stat = {
		description = "loc_trait_description_autogun_p2_m3_ammo_stat",
	...
	autogun_p2_m3_stability_stat = {
		description = "loc_trait_description_autogun_p2_m3_stability_stat",
	...
	autogun_p2_m3_power_stat = {
		description = "loc_trait_description_autogun_p2_m3_power_stat",
	...
	autogun_p2_m3_mobility_stat = {
		description = "loc_trait_description_autogun_p2_m3_mobility_stat",
