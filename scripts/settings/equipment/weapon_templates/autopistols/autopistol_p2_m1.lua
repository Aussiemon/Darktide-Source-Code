...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		kind = "shoot_hit_scan",
		spread_template = "autopistol",
		start_input = "shoot",
		recoil_template = "autopistol",
	...
	action_shoot_zoomed = {
		...
		recoil_template = "autogun_brace",
		kind = "shoot_hit_scan",
		sprint_ready_up_time = 0,
		spread_template = "lasgun_brace",
		weapon_handling_template = "autogun_full_auto_fast",
		crosshair_type = "none",
		ammunition_usage = 1,
		stop_input = "shoot_release",
...
weapon_template.spread_template = "autogun_assault"
weapon_template.recoil_template = "autopistol"
...
weapon_template.ammo_template = "autopistol_p1_m2"
...
weapon_template.alternate_fire_settings = {
	...
	spread_template = "lasgun_brace",
	start_anim_event_3p = "to_reflex",
	crosshair_type = "none",
	stop_anim_event_3p = "to_unaim_reflex",
