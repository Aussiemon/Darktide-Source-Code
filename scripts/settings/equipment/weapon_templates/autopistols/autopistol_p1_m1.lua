...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		suppression_template = "autopistol_p1_m1_suppression_assault",
	...
	action_shoot_zoomed = {
		...
		stop_input = "shoot_release",
		suppression_template = "autopistol_p1_m1_suppression_spraynpray",
		weapon_handling_template = "autogun_full_auto_fast",
		total_time = math.huge,
		action_movement_curve = {
			{
...
weapon_template.suppression_template = "autopistol_p1_m1_suppression_assault"
