-- chunkname: @scripts/settings/equipment/weapon_templates/arc_rifle/settings_templates/arc_rifle_sway_templates.lua
...
local function arc_rifle_sway(dt, t, sway_settings, yaw, pitch)
...
local function arc_rifle_sway_pattern_crouch_sway(dt, t, sway_settings, yaw, pitch)
	local horizontal_speed = sway_settings.horizontal_speed
	local rotation_speed = sway_settings.rotation_speed
	local sin_angle = t * PI * horizontal_speed
	local sin_wave = math.sin(sin_angle)
