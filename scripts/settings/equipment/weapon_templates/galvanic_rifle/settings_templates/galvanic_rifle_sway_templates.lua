-- chunkname: @scripts/settings/equipment/weapon_templates/galvanic_rifle/settings_templates/galvanic_rifle_sway_templates.lua
...
sway_templates.default_galvanic_killshot = {
	still = {
...
sway_templates.fullauto_galvanic_killshot = {
	still = {
