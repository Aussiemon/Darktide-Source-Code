...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.default_stub_pistol_killshot,
	...
	action_shoot_zoomed = {
		...
		spread_template = "default_stub_pistol_assault",
		weapon_handling_template = "stubrevolver_single_shot",
...
weapon_template.recoil_template = "default_stub_pistol_killshot"
...
weapon_template.alternate_fire_settings = {
	...
	recoil_template = "default_stub_pistol_assault",
