...
suppression_templates.stub_pistol_p1_m1_suppression_killshot = {
	still = {
		decay_time = 0.6,
		delay = 0.2,
		immediate_sway = {
	...
	moving = {
		inherits = {
			"stub_pistol_p1_m1_suppression_killshot",
			"still",
		},
	},
	crouch_still = {
...
suppression_templates.stub_pistol_p1_m1_suppression_assault = {
	still = {
		decay_time = 0.6,
		delay = 0.2,
		immediate_spread = {
	...
	moving = {
		inherits = {
			"stub_pistol_p1_m1_suppression_assault",
			"still",
		},
	},
	crouch_still = {
