...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fire_configuration = {
			...
			hit_scan_template = HitScanTemplates.heavy_stub_pistol_bfg,
	...
	action_shoot_zoomed = {
		...
		recoil_template = "default_stub_pistol_bfg",
		kind = "shoot_hit_scan",
...
weapon_template.recoil_template = "default_stub_pistol_bfg_p1_m3"
