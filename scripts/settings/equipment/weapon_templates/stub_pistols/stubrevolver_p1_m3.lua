...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fx = {
			...
			muzzle_flash_effect = "content/fx/particles/weapons/pistols/stubrevolver/stubrevolver_heavy_muzzle",
			shoot_sfx_alias = "ranged_single_shot",
			muzzle_flash_crit_effect = "content/fx/particles/weapons/pistols/stubrevolver/stubrevolver_heavy_crit_muzzle",
			out_of_ammo_sfx_alias = "ranged_out_of_ammo",
			no_ammo_shoot_sfx_alias = "ranged_no_ammo",
			line_effect = LineEffects.heavy_stubpistol_bullet
		},
		fire_configuration = {
			anim_event = "attack_shoot",
			same_side_suppression_enabled = false,
			hit_scan_template = HitScanTemplates.stub_revolver_p1_m3,
	...
	action_shoot_zoomed = {
		recoil_template = "stub_pistol_p1_m3_ads",
		start_input = "zoom_shoot",
		kind = "shoot_hit_scan",
		sprint_ready_up_time = 0,
		weapon_handling_template = "stubrevolver_single_shot",
		spread_template = "stub_pistol_p1_m3_ads",
		ammunition_usage = 1,
		allowed_during_sprint = true,
		total_time = 0.9,
		crosshair = {
...
weapon_template.spread_template = "stub_pistol_p1_m3_hip"
weapon_template.recoil_template = "stub_pistol_p1_m3_hip"
