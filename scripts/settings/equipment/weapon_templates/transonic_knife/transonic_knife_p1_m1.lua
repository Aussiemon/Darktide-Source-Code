-- chunkname: @scripts/settings/equipment/weapon_templates/transonic_knife/transonic_knife_p1_m1.lua
...
local WeaponTraitsBespokeTransonicKnifeP1 = require("scripts/settings/equipment/weapon_traits/weapon_traits_bespoke_transonic_knife_p1")
...
local weapon_traits_bespoke_transonic_knife_p1_traits = table.ukeys(WeaponTraitsBespokeTransonicKnifeP1)

table.append(weapon_template.traits, weapon_traits_bespoke_transonic_knife_p1_traits)
