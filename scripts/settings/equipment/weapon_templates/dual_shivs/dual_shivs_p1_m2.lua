-- chunkname: @scripts/settings/equipment/weapon_templates/dual_shivs/dual_shivs_p1_m2.lua
...
weapon_template.action_inputs.light_attack.input_sequence[1].time_window = 0.265
weapon_template.action_inputs.heavy_attack.input_sequence[1].duration = 0.265
...
weapon_template.actions = {
	...
	action_start_1 = {
		...
		chain_anim_event = "heavy_charge_right_pose",
		chain_anim_event_3p = "heavy_charge_right",
	...
	action_light_1 = {
		...
		damage_profile = DamageProfileTemplates.dual_shivs_light_linesman,
	...
	action_heavy_1 = {
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/dual_shivs/heavy_attack_swing_right_offhand_sweep",
				reference_attachment_id = "left",
				anchor_point_offset = {
					0,
					0,
		...
		damage_profile = DamageProfileTemplates.dual_shivs_heavy_linesman,
	...
	action_heavy_2 = {
		...
		damage_window_start = 0.30833333333333335,
		first_person_hit_stop_anim = "hit_stop",
		hit_armor_anim = "attack_hit_shield",
		kind = "sweep",
		range_mod = 1.05,
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/dual_shivs/heavy_attack_swing_left",
				reference_attachment_id = "right",
				anchor_point_offset = {
					0,
					0,
