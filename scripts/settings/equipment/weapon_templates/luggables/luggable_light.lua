-- chunkname: @scripts/settings/equipment/weapon_templates/luggables/luggable_light.lua
...
weapon_template.retain_luggable_when_damaged = true
...
weapon_template.static_speed_reduction_mod = 1
