-- chunkname: @scripts/settings/equipment/weapon_templates/plasma_rifles/plasmagun_p1_m2.lua
...
weapon_template.actions = {
	...
	action_shoot = {
		...
		fire_configuration = {
			...
			use_charge = true,
			hit_scan_template = HitScanTemplates.plasma_p1_m2_hitscan_light,
	...
	action_shoot_charged = {
		...
		fire_configuration = {
			...
			use_charge = true,
			hit_scan_template = HitScanTemplates.plasma_p1_m2_hitscan_charged,
			damage_type = damage_types.plasma_heavy,
		},
		allowed_chain_actions = {
			combat_ability = {
