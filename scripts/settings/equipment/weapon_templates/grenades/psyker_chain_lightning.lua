...
local chain_settings_fast_targeting = table.clone(chain_settings_fast)
chain_settings_fast_targeting.radius = 20
chain_settings_fast_targeting.close_max_angle = math.pi * 0.25
...
chain_settings_charged_targeting.close_max_angle = math.pi * 0.4
...
weapon_template.actions = {
	...
	action_charge_fast = {
		...
		chain_settings_targeting = chain_settings_fast_targeting
	},
	action_shoot_fast = {
		...
		chain_settings = chain_settings_fast,
		chain_settings_targeting = chain_settings_fast_targeting
	},
	action_charge = {
		allowed_during_sprint = true,
...
weapon_template.anim_state_machine_3p = "content/characters/player/human/third_person/animations/chain_lightning"
