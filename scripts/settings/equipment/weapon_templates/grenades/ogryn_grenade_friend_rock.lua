...
weapon_template.actions.action_wield.allowed_chain_actions.aim_hold.chain_time = 0.4
weapon_template.actions.action_wield.allowed_chain_actions.short_hand_aim_hold.chain_time = 0.4
