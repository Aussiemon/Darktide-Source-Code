-- chunkname: @scripts/settings/equipment/weapon_templates/grenades/ogryn_grenade_box_cluster.lua
...
weapon_template.projectile_template = ProjectileTemplates.ogryn_grenade_box_cluster
