...
weapon_template.actions = {
	...
	action_right_heavy = {
		...
		weapon_box = chain_sword_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/2h_chain_sword/heavy_attack_right",
			anchor_point_offset = {
				0,
				0,
				0
	...
	action_right_light_pushfollow = {
		...
		hit_stickyness_settings = {
			...
			damage = {
				instances = 3,
				damage_profile = DamageProfileTemplates.default_light_chainsword_stab_sticky_2h,
				damage_type = damage_types.sawing_stuck,
				last_damage_profile = DamageProfileTemplates.default_light_chainsword_stab_sticky_last_2h
			},
			disallowed_hit_zones = melee_sticky_disallowed_hit_zones,
			disallow_dodging = {},
			movement_curve = {
	...
	action_start_special = {
		kind = "toogle_special",
		anim_event = "rev_start",
		start_input = "special_action",
		allowed_during_sprint = true,
		activation_time = 0.3,
		anim_end_event = "rev_end",
		skip_3p_anims = true,
		total_time = 0.6
	},
	action_inspect = {
