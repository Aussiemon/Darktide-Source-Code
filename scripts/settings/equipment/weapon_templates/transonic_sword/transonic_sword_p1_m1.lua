-- chunkname: @scripts/settings/equipment/weapon_templates/transonic_sword/transonic_sword_p1_m1.lua
...
local WeaponTraitsBespokeTransonicSwordP1 = require("scripts/settings/equipment/weapon_traits/weapon_traits_bespoke_transonic_sword_p1")
...
local weapon_traits_bespoke_transonic_sword_p1_traits = table.ukeys(WeaponTraitsBespokeTransonicSwordP1)

table.append(weapon_template.traits, weapon_traits_bespoke_transonic_sword_p1_traits)
