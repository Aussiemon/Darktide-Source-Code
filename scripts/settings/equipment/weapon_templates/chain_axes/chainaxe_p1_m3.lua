...
weapon_template.actions = {
	...
	action_left_heavy = {
		...
		weapon_box = chain_axe_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/chain_axe/heavy_attack_left",
			anchor_point_offset = {
				0,
				0,
				-0.2
	...
	action_right_down_light = {
		...
		weapon_box = chain_axe_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/chain_axe/attack_down",
			anchor_point_offset = {
				0,
				0,
				0
