...
local hit_stickyness_settings_heavy = {
	...
	damage = {
		...
		last_damage_profile = DamageProfileTemplates.heavy_chainaxe_sticky_last
	},
...
local hit_stickyness_settings_light_special = {
	...
	damage = {
		...
		damage_profile = DamageProfileTemplates.light_chainaxe_sticky,
		damage_type = damage_types.sawing_stuck,
		last_damage_profile = DamageProfileTemplates.light_chainaxe_sticky_last
	},
	disallowed_hit_zones = melee_sticky_disallowed_hit_zones,
	disallow_dodging = {},
	movement_curve = {
...
weapon_template.actions = {
	...
	action_right_diagonal_light = {
		...
		first_person_hit_anim = "hit_left_shake",
		hit_armor_anim = "attack_hit_shield",
		damage_window_start = 0.495,
		damage_window_end = 0.58,
		anim_end_event = "attack_finished",
		...
		weapon_box = chain_sword_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/chain_axe/attack_right",
			anchor_point_offset = {
				0,
				0,
				-0.15
	...
	action_right_light_pushfollow = {
		...
		weapon_box = chain_sword_sweep_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/chain_axe/attack_right_up",
			anchor_point_offset = {
				0.2,
				0,
				-0.125
