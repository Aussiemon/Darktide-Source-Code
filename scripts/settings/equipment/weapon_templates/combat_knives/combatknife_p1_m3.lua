...
weapon_template.actions = {
	...
	action_left_light = {
		...
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/combat_knife/swing_stab_02",
			anchor_point_offset = {
				0.1,
				-0.5,
				-0.3
	...
	action_right_light = {
		...
		weapon_box = default_weapon_box,
		spline_settings = {
			matrices_data_location = "content/characters/player/human/first_person/animations/combat_knife/swing_stab_03",
			anchor_point_offset = {
				0,
				0,
				-0.2
	...
	action_special_jab = {
		...
		first_person_hit_stop_anim = "hit_right_up_shake",
		range_mod = 1.25,
		allowed_during_sprint = true,
		damage_window_end = 0.28,
		anim_end_event = "attack_finished",
...
weapon_template.base_stats = {
	...
	combatknife_p1_m3_armor_pierce_stat = {
	...
	combatknife_p1_m3_finesse_stat = {
	...
	combatknife_p1_m3_first_target_stat = {
	...
	combatknife_p1_m3_mobility_stat = {
