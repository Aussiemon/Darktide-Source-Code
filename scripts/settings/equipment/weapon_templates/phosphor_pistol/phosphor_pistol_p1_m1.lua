-- chunkname: @scripts/settings/equipment/weapon_templates/phosphor_pistol/phosphor_pistol_p1_m1.lua
...
local WeaponTraitsBespokePhosphorPistolP1 = require("scripts/settings/equipment/weapon_traits/weapon_traits_bespoke_phosphor_pistol_p1")
...
local RELOAD_TEMPLATE = ReloadTemplates.phosphor_pistol
...
weapon_template.actions = {
	...
	action_shoot_hip = {
		...
		fx = {
			...
			muzzle_flash_crit_effect = "content/fx/particles/weapons/pistols/phosphorpistol/phosphor_pistol_muzzle",
			muzzle_flash_effect = "content/fx/particles/weapons/pistols/phosphorpistol/phosphor_pistol_muzzle",
	...
	action_shoot_zoomed = {
		...
		anim_event = nil,
		kind = "shoot_hit_scan",
		recoil_template = "phosphor_pistol_p1_m1_recoil_ads",
		spread_template = "phosphor_pistol_p1_m1_spread_ads",
	...
	action_pistol_whip = {
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/phosphor_pistol/pistol_whip",
				anchor_point_offset = {
					0.15,
					0.8,
					0,
		...
		action_condition_func = function (action_settings, condition_func_params, used_input, t, time_in_action)
			...
			local current_action_name = condition_func_params.weapon_action_component.current_action_name
			...
			local highest_completed_transition = ReloadStates.calculate_next_state_transition(RELOAD_TEMPLATE, condition_func_params.inventory_slot_component, time_in_action, time_scale)
			local valid_state = highest_completed_transition == "eject_mag"
	...
	action_pistol_whip_followup = {
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/phosphor_pistol/pistol_whip_02",
				anchor_point_offset = {
					0.2,
					0.8,
					-0.15,
	...
	action_pistol_whip_from_reload = {
		...
		action_priority = 2,
		allowed_during_sprint = true,
		anim_event = "attack_stab_01_from_reload",
		anim_event_3p = "attack_stab_01_from_reload",
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/phosphor_pistol/pistol_whip_cracked_offhand_sweep",
	...
	action_pistol_whip_from_reload_followup = {
		abort_sprint = true,
		allowed_during_sprint = true,
		anim_event = "attack_stab_02_from_reload",
		anim_event_3p = "attack_stab_02_from_reload",
		...
		sweeps = {
			{
				matrices_data_location = "content/characters/player/human/first_person/animations/phosphor_pistol/pistol_whip_02_cracked_offhand_sweep",
				reference_attachment_id = "left",
				anchor_point_offset = {
					0,
					0,
...
weapon_template.anim_state_machine_3p = "content/characters/player/human/third_person/animations/phosphor_pistol"
weapon_template.anim_state_machine_1p = "content/characters/player/human/first_person/animations/phosphor_pistol"
weapon_template.reload_template = RELOAD_TEMPLATE
weapon_template.spread_template = "phosphor_pistol_p1_m1_spread_hip"
weapon_template.recoil_template = "phosphor_pistol_p1_m1_recoil_hip"
weapon_template.suppression_template = "phosphor_pistol_p1_m1_suppression_hip"
...
weapon_template.base_stats = {
	phosphor_pistol_p1_m1_dps_stat = {
...
local weapon_traits_bespoke_phosphor_pistol_p1_traits = table.ukeys(WeaponTraitsBespokePhosphorPistolP1)

table.append(weapon_template.traits, weapon_traits_bespoke_phosphor_pistol_p1_traits)
