-- chunkname: @scripts/settings/equipment/weapon_templates/phosphor_pistol/settings_templates/phosphor_pistol_sway_templates.lua
...
local function phosphor_pistol_p1_m1_sway(dt, t, sway_settings, yaw, pitch)
...
local function phosphor_pistol_p1_m1_crouch_sway(dt, t, sway_settings, yaw, pitch)
	local horizontal_speed = sway_settings.horizontal_speed
	local rotation_speed = sway_settings.rotation_speed
	local sin_angle = t * PI * horizontal_speed
	local sin_wave = math.sin(sin_angle)
...
sway_templates.phosphor_pistol_p1_m1_sway = {
	still = {
		horizontal_speed = 1,
		intensity = 1.2,
		rotation_speed = 0.75,
