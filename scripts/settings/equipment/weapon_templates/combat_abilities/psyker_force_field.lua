...
local functional_unit = "content/characters/player/human/attachments_combat/psyker_shield/shield_wall_functional"
local visual_unit = "content/characters/player/human/attachments_combat/psyker_shield/shield_wall_visual"
