...
_create_effect_template_entry("scripts/settings/fx/effect_templates/chaos_ogryn_houndmaster_electric")
...
_create_effect_template_entry("scripts/settings/fx/effect_templates/renegade_plasma_gunner_charge_up")
_create_effect_template_entry("scripts/settings/fx/effect_templates/renegade_plasma_gunner_laser")
...
_create_effect_template_entry("scripts/settings/fx/effect_templates/arc_chain_to_position")
_create_effect_template_entry("scripts/settings/fx/effect_templates/arc_chain_lightning_source/arc_grenade_chain_lightning_source")
_create_effect_template_entry("scripts/settings/fx/effect_templates/arc_chain_lightning_source/discharge_ability_arc_chain_lightning_source")
_create_effect_template_entry("scripts/settings/fx/effect_templates/arc_chain_lightning_source/force_field_arc_chain_lightning_source")
...
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_aim_on_ground_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_charged_shooting_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_empowered_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_flamer")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_hacking_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_heal_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_move_action_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_moving_effect")
_create_effect_template_entry("scripts/settings/fx/effect_templates/companion_servo_skull_shooting_effect")
...
_create_effect_template_entry("scripts/settings/fx/effect_templates/minion_stim_effect")
