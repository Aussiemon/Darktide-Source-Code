-- chunkname: @scripts/settings/fx/effect_templates/renegade_captain_hellgun.lua

local Effect = require("scripts/extension_systems/fx/utilities/effect")
local MinionDifficultySettings = require("scripts/settings/difficulty/minion_difficulty_settings")
local MinionPerception = require("scripts/utilities/minion_perception")
local MinionVisualLoadout = require("scripts/utilities/minion_visual_loadout")
local shooting_difficulty_settings = MinionDifficultySettings.shooting.renegade_captain_burst
...
local effect_template = {
	...
	start = function (template_data, template_context)
		...
		local muzzle_particle_id = World.create_particles(world, SHOOT_VFX, position, nil, nil, template_data.particle_group)
