-- chunkname: @scripts/settings/fx/effect_templates/arc_chain_lightning_source/force_field_arc_chain_lightning_source.lua
...
local effect_template = {
	name = "force_field_arc_chain_lightning_source",
	resources = resources,
