-- chunkname: @scripts/settings/fx/effect_templates/companion_servo_skull_move_action_effect.lua

local CompanionVisualLoadout = require("scripts/utilities/companion_visual_loadout")
local SOURCE_NAME = "base"
local SOUND_ALIAS = "companion_servo_skull_move_action"
local PROFILE_PROPERTIES_SWITCH = ""
local resources = {}
local effect_template = {
	name = "companion_servo_skull_move_action_effect",
	resources = resources,
