-- chunkname: @scripts/settings/fx/effect_templates/yellow_stimmed.lua
...
local effect_template = {
	...
	start = function (template_data, template_context)
		...
		if node_1 then
			...
			World.set_particles_surface_effect(world, particle_1_id, unit, nil, nil, true)
		end
		...
		if node_2 then
			...
			World.set_particles_material_vector3(world, particle_2_id, "eye_flash_init", EYE_MATERIAL_VARIABLE_NAME, color)
		...
		if node_3 then
			...
			World.set_particles_material_vector3(world, particle_3_id, "eye_flash_init", EYE_MATERIAL_VARIABLE_NAME, color)
