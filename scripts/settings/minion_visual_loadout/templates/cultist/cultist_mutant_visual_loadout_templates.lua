-- chunkname: @scripts/settings/minion_visual_loadout/templates/cultist/cultist_mutant_visual_loadout_templates.lua
...
templates.cultist_mutant[zone_ids.void] = {
	void_1,
}
...
templates.cultist_mutant[zone_ids.horde] = {
	horde_1,
}
