-- chunkname: @scripts/settings/minion_visual_loadout/templates/cultist/cultist_shocktrooper_visual_loadout_templates.lua
...
templates.cultist_shocktrooper[zone_ids.void] = {
	void_1,
}
...
templates.cultist_shocktrooper[zone_ids.horde] = {
	horde_1,
}
