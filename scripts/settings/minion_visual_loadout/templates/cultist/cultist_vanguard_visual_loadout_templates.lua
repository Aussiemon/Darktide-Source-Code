-- chunkname: @scripts/settings/minion_visual_loadout/templates/cultist/cultist_vanguard_visual_loadout_templates.lua
...
local base_visual_loadout_template = {
	...
	slots = {
		...
		slot_head = {
			use_outline = true,
			items = {
				"content/items/characters/minions/chaos_cultists/attachments_gear/cultist_vanguard_headgear_01",
			},
		},
		slot_shield = {
			is_weapon = true,
			...
			items = {
				"content/items/weapons/minions/shields/traitor_guard_shield_05",
			},
		},
		slot_melee_weapon = {
			drop_on_death = true,
...
templates.cultist_vanguard.default = {
	default_1,
	default_2,
	default_3,
	default_4,
...
templates.cultist_vanguard[zone_ids.tank_foundry] = tank_foundry_variations
...
templates.cultist_vanguard[zone_ids.dust] = dust_variations
...
templates.cultist_vanguard[zone_ids.watertown] = watertown_variations
...
templates.cultist_vanguard[zone_ids.horde] = horde_variations
