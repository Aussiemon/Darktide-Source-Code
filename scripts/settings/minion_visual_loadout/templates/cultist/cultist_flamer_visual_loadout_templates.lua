-- chunkname: @scripts/settings/minion_visual_loadout/templates/cultist/cultist_flamer_visual_loadout_templates.lua
...
templates.cultist_flamer[zone_ids.void] = {
	void_1,
}
...
templates.cultist_flamer[zone_ids.horde] = {
	horde_1,
}
