-- chunkname: @scripts/settings/minion_visual_loadout/templates/chaos/chaos_daemonhost_visual_loadout_templates.lua
...
templates.chaos_daemonhost[zone_ids.dust] = {
	dust_1,
}
...
templates.chaos_daemonhost[zone_ids.void] = {
	void_1,
}
...
templates.chaos_daemonhost[zone_ids.horde] = {
	horde_1,
}
