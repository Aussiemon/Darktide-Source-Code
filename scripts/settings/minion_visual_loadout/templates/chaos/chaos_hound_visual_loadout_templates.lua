-- chunkname: @scripts/settings/minion_visual_loadout/templates/chaos/chaos_hound_visual_loadout_templates.lua
...
templates.chaos_hound[zone_ids.void] = {
	void_1,
}
...
templates.chaos_hound[zone_ids.horde] = {
	horde_1,
}
