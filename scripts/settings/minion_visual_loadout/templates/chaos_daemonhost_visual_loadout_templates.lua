-- chunkname: @scripts/settings/minion_visual_loadout/templates/chaos_daemonhost_visual_loadout_templates.lua
...
local dust_1 = table.clone(basic_chaos_daemonhost_template)
