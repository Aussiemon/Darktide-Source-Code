-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_rifleman_visual_loadout_templates.lua
...
templates.renegade_rifleman[zone_ids.void] = {
	void_1,
}
...
templates.renegade_rifleman[zone_ids.horde] = {
	horde_1,
}
