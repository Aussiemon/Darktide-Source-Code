-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_flamer_visual_loadout_templates.lua
...
templates.renegade_flamer[zone_ids.void] = {
	void_1,
}
...
templates.renegade_flamer[zone_ids.horde] = {
	horde_1,
}
