-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_sniper_visual_loadout_templates.lua
...
templates.renegade_sniper[zone_ids.void] = {
	void_1,
}
...
templates.renegade_sniper[zone_ids.horde] = {
	horde_1,
}
