-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_vanguard_visual_loadout_templates.lua
...
local basic_renegade_vanguard_template = {
	gib_variations = nil,
	slots = {
		slot_upperbody = {
			use_outline = true,
		...
		slot_melee_weapon = {
			...
			use_outline = true,
			items = {
				"content/items/weapons/minions/melee/chaos_traitor_guard_melee_weapon_02_vanguard",
			},
		},
		slot_shield = {
			drop_on_death = true,
			is_weapon = true,
			multi_actor_drop_function = true,
			use_outline = true,
			shield_settings = {
				current_state = 0,
				unit_states = {
				...
				override_drop_function_settings = {
					index_required = 3,
					name = "shield_multi_actor",
				},
				update_material_scalar = {
					variable_name = "chip_dirt",
					scalar_values = {
						0.4,
						0.6,
						0.8,
			...
			items = {
				"content/items/weapons/minions/shields/traitor_guard_shield_02",
				"content/items/weapons/minions/shields/traitor_guard_shield_03",
				"content/items/weapons/minions/shields/traitor_guard_shield_04",
			},
		},
		slot_decal = {
			use_outline = true,
...
local default_1 = table.clone(basic_renegade_vanguard_template)
local default_2 = table.clone(basic_renegade_vanguard_template)
...
local default_3 = table.clone(basic_renegade_vanguard_template)
...
local default_4 = table.clone(basic_renegade_vanguard_template)
...
local default_5 = table.clone(basic_renegade_vanguard_template)
...
local default_6 = table.clone(basic_renegade_vanguard_template)
...
local default_7 = table.clone(basic_renegade_vanguard_template)
...
local default_8 = table.clone(basic_renegade_vanguard_template)
...
local default_9 = table.clone(basic_renegade_vanguard_template)
...
local default_10 = table.clone(basic_renegade_vanguard_template)
...
local default_11 = table.clone(basic_renegade_vanguard_template)
...
local default_12 = table.clone(basic_renegade_vanguard_template)
...
local default_13 = table.clone(basic_renegade_vanguard_template)
...
local default_14 = table.clone(basic_renegade_vanguard_template)
...
local default_15 = table.clone(basic_renegade_vanguard_template)
...
local default_16 = table.clone(basic_renegade_vanguard_template)
...
local default_17 = table.clone(basic_renegade_vanguard_template)
...
local default_18 = table.clone(basic_renegade_vanguard_template)
...
local default_19 = table.clone(basic_renegade_vanguard_template)
...
local default_20 = table.clone(basic_renegade_vanguard_template)
...
local default_21 = table.clone(basic_renegade_vanguard_template)
...
local default_22 = table.clone(basic_renegade_vanguard_template)
...
local default_23 = table.clone(basic_renegade_vanguard_template)
...
local default_24 = table.clone(basic_renegade_vanguard_template)
...
templates.renegade_vanguard.default = {
	default_1,
	default_2,
	default_3,
	default_4,
...
templates.renegade_vanguard[zone_ids.tank_foundry] = tank_foundry_variations
...
templates.renegade_vanguard[zone_ids.dust] = dust_variations
...
templates.renegade_vanguard[zone_ids.watertown] = watertown_variations
