-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_grenadier_visual_loadout_templates.lua
...
templates.renegade_grenadier[zone_ids.horde] = {
	horde_1,
}
