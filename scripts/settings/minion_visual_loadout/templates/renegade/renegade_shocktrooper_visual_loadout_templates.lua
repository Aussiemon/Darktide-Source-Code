-- chunkname: @scripts/settings/minion_visual_loadout/templates/renegade/renegade_shocktrooper_visual_loadout_templates.lua
...
for _, default_variation in pairs(templates.renegade_shocktrooper.default) do
...
templates.renegade_shocktrooper[zone_ids.tank_foundry] = tank_foundry_variations
...
templates.renegade_shocktrooper[zone_ids.dust] = dust_variations
...
templates.renegade_shocktrooper[zone_ids.watertown] = watertown_variations
...
templates.renegade_shocktrooper[zone_ids.void] = void_variations
...
templates.renegade_shocktrooper[zone_ids.horde] = horde_variations
