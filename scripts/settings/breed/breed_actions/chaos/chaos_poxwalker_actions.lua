...
local action_data = {
	...
	stagger = {
		stagger_duration_mods = {
			...
			run_stagger_5 = 2.5,
			stagger_bwd_6 = 1.5,
			stagger_fwd_heavy_5 = 1.5,
			stagger_left_7 = 0.6,
			stagger_fwd_5 = 0.6,
			stagger_bwd_heavy_8 = 1.7,
			stagger_right_heavy_7 = 1.5,
			stagger_bwd_heavy_7 = 1.5,
			stagger_right_7 = 0.6,
			stagger_right_heavy_6 = 2,
			run_stagger_4 = 2.5,
			stagger_bwd_5 = 1.7,
			run_stagger_7 = 2.4,
			...
			stagger_right_6 = 1.5,
			stagger_left_5 = 1.3,
			stagger_left_heavy_5 = 1.5,
			stagger_fwd_6 = 0.6,
			stagger_right_heavy_5 = 2,
			stagger_left_heavy_6 = 1.5,
			run_stagger_3 = 1.25,
			run_stagger_6 = 2.3,
			stagger_fwd_7 = 1.5,
			stagger_left_6 = 0.6,
			stagger_fwd_heavy_6 = 1.25,
			stagger_left_8 = 1.75
		},
		stagger_anims = {
			light = {
