...
_create_breed_entry("scripts/settings/breed/breeds/cultist/cultist_vanguard_breed")
...
_create_breed_entry("scripts/settings/breed/breeds/renegade/renegade_vanguard_breed")
_create_breed_entry("scripts/settings/breed/breeds/companion/companion_dog_breed")
_create_breed_entry("scripts/settings/breed/breeds/companion/companion_servo_skull_breed")
_create_breed_entry("scripts/settings/breed/breeds/cryptic_breed")
