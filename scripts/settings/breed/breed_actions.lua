...
_create_breed_action_entry("scripts/settings/breed/breed_actions/chaos/chaos_armored_hound_actions")
...
_create_breed_action_entry("scripts/settings/breed/breed_actions/chaos/chaos_hound_mutator_actions")
...
_create_breed_action_entry("scripts/settings/breed/breed_actions/chaos/chaos_ogryn_houndmaster_actions")
...
_create_breed_action_entry("scripts/settings/breed/breed_actions/renegade/renegade_plasma_gunner_actions")
