...
_create_breed_blackboard_component_templates("scripts/settings/breed/breed_blackboard_component_templates/companion_servo_skull_blackboard_component_templates")
_create_breed_blackboard_component_templates("scripts/settings/breed/breed_blackboard_component_templates/sand_vortex_blackboard_component_templates")
_create_breed_blackboard_component_templates("scripts/settings/breed/breed_blackboard_component_templates/nurgle_flies_blackboard_component_templates")
_create_breed_blackboard_component_templates("scripts/settings/breed/breed_blackboard_component_templates/valkyrie_blackboard_component_templates")
