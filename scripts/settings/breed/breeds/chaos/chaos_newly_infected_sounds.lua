local sounds = {
	...
	ground_impact = "wwise/events/minions/play_enemy_poxwalker_body_impact_medium_ground",
	...
	vce_grunt = "wwise/events/minions/play_enemy_chaos_newly_infected_grunt_vce",
