...
local breed_data = {
	...
	hitzone_damage_multiplier = {
		...
		ranged = {
			...
			[hit_zone_names.lower_left_leg] = 0.35,
			[hit_zone_names.lower_right_leg] = 0.35,
			[hit_zone_names.upper_left_arm] = 0.35,
			[hit_zone_names.upper_right_arm] = 0.35,
			[hit_zone_names.upper_left_leg] = 0.35,
			[hit_zone_names.upper_right_leg] = 0.35,
			[hit_zone_names.center_mass] = 0.35,
