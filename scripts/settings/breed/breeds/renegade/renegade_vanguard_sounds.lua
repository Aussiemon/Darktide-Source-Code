-- chunkname: @scripts/settings/breed/breeds/renegade/renegade_vanguard_sounds.lua

local RenegadeCommonSounds = require("scripts/settings/breed/breeds/renegade/renegade_common_sounds")
local sound_data = {
	events = {
		foley_drastic_long = "wwise/events/minions/play_shared_foley_traitor_guard_medium_drastic_long",
		foley_drastic_short_shield = "wwise/events/minions/play_shared_foley_light_shield",
		...
		run_foley_shield = "wwise/events/minions/play_shared_foley_light_shield",
		shield_break = "wwise/events/weapon/play_hit_indicator_vanguard_shield_break",
