-- chunkname: @scripts/settings/breed/breeds/renegade/renegade_vanguard_breed.lua
...
local breed_name = "renegade_vanguard"
local breed_data = {
	...
	spawn_anim_state = "to_melee_shield",
	...
	sounds = require("scripts/settings/breed/breeds/renegade/renegade_vanguard_sounds"),
	vfx = require("scripts/settings/breed/breeds/renegade/renegade_common_vfx"),
	behavior_tree_name = breed_name,
	shield_template = BreedShieldTemplates.renegade_vanguard,
	animation_variables = {
