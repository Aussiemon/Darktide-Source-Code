-- chunkname: @scripts/settings/breed/breeds/renegade/renegade_plasma_gunner_breed.lua
...
local breed_name = "renegade_plasma_gunner"
local breed_data = {
	achievement_breed_group = "renegade_plasma_gunner",
	...
	game_object_type = "minion_renegade_plasma_gunner",
	...
	gib_template = MinionGibbingTemplates.renegade_plasma_gunner_gibbing,
	stagger_durations = {
	...
	inventory = MinionVisualLoadoutTemplates.renegade_plasma_gunner,
	sounds = require("scripts/settings/breed/breeds/renegade/renegade_plasma_gunner_sounds"),
