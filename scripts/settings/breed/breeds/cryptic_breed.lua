-- chunkname: @scripts/settings/breed/breeds/cryptic_breed.lua
...
local CRYPTIC_SIZE_VARIATION_RANGE = {
	0.98,
	1.05,
}
local AVERAGE_CRYPTIC_SIZE = CRYPTIC_SIZE_VARIATION_RANGE[1] + (CRYPTIC_SIZE_VARIATION_RANGE[2] - CRYPTIC_SIZE_VARIATION_RANGE[1]) * 0.5
local breed_data = {
	...
	hologram_units = {
		consumed = "content/characters/player/human/attachments_base/shared/see_through_skeleton/cryptic_see_through_skeleton_bon",
		default = "content/characters/player/human/attachments_base/shared/see_through_skeleton/cryptic_see_through_skeleton",
	},
	testify_flags = {
	...
	heights = {
		default = DEFAULT_HEIGHT / AVERAGE_CRYPTIC_SIZE,
		sprint = 1.55 / AVERAGE_CRYPTIC_SIZE,
		crouch = 1.15 / AVERAGE_CRYPTIC_SIZE,
		slide = 0.95 / AVERAGE_CRYPTIC_SIZE,
		vault = 1.05 / AVERAGE_CRYPTIC_SIZE,
	},
