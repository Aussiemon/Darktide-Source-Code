...
local ui_settings = {
	...
	item_type_localization_lookup = {
		...
		COMPANION_GEAR_FULL = "loc_inventory_title_slot_companion_gear_full_new",
		CRYPTIC_ARMS = "loc_item_type_cryptic_arms",
		CRYPTIC_LEGS = "loc_item_type_cryptic_legs",
		...
		LEGS = "loc_item_type_legs",
		LENS_COLOR = "loc_item_type_lens_color",
		LUGGABLE = "loc_item_type_luggable",
		METAL_COLOR = "loc_item_type_metal_color",
	...
	archetype_badge_texture_by_name = {
		...
		cryptic = "content/ui/textures/icons/class_badges/cryptic_01",
