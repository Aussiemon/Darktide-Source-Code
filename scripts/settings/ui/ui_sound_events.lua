...
local ui_sound_events = {
	...
	havoc_eor_rank_down = "wwise/events/ui/play_ui_npc_interacts_havoc_eor_rank_down",
	havoc_eor_rank_up = "wwise/events/ui/play_ui_npc_interacts_havoc_eor_rank_up",
