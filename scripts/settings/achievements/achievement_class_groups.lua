...
AchievementClassGroups.classes = {
	...
	},
	{
		...
		icon = "content/ui/textures/icons/achievements/class_achievements/broker/achievement_icon_broker_0001",
		local_variable = "loc_class_broker_name",
		name = "broker_meta_numeric_achievement",
		achievements = {
			"rank_broker_2_1",
			"rank_broker_2_2",
			"rank_broker_2_3",
			...
			"missions_broker_2_easy_difficulty_1",
			"missions_broker_2_easy_difficulty_2",
			"missions_broker_2_easy_difficulty_3",
			"missions_broker_2_easy_difficulty_4",
			"missions_broker_2_easy_difficulty_5",
			"missions_broker_2_medium_difficulty_1",
			"missions_broker_2_medium_difficulty_2",
			"missions_broker_2_medium_difficulty_3",
			"missions_broker_2_medium_difficulty_4",
			"missions_broker_2_medium_difficulty_5",
			"broker_gunslinger_aura",
			"broker_ruffian_aura",
			"broker_anarchist_aura",
			"broker_enemies_hit_by_flash_grenade_2",
			"broker_enemies_killed_by_missile_launcher_2",
			"broker_enemies_affected_by_chem_bomb_2",
			"broker_enemies_killed_with_focus_mode",
			"broker_attacks_dodged_in_focus_mode",
			"broker_deal_damage_in_punk_rage",
			"broker_stay_in_punk_rage",
			"broker_deploy_stimm_field",
			"broker_buff_allies_chem_field",
			"broker_gunslinger_keystone_b",
			"broker_ruffian_keystone_b",
			"broker_anarchist_keystone_b",
			"broker_stimm_celerity_potency",
	...
	},
	{
		...
		icon = "content/ui/textures/icons/achievements/class_achievements/cryptic/achievement_icon_cryptic_0001",
		local_variable = "loc_class_cryptic_name",
		name = "cryptic_meta_numeric_achievement",
		achievements = {
			"rank_cryptic_2_1",
			"rank_cryptic_2_2",
			"rank_cryptic_2_3",
			...
			"missions_cryptic_2_4",
			"missions_cryptic_2_5",
			"missions_cryptic_2_objective_1",
			"missions_cryptic_2_objective_2",
			"missions_cryptic_2_objective_3",
			"missions_cryptic_2_easy_difficulty_1",
			"missions_cryptic_2_easy_difficulty_2",
			"missions_cryptic_2_easy_difficulty_3",
			"missions_cryptic_2_easy_difficulty_4",
			"missions_cryptic_2_easy_difficulty_5",
			"missions_cryptic_2_medium_difficulty_1",
			"missions_cryptic_2_medium_difficulty_2",
			"missions_cryptic_2_medium_difficulty_3",
			"missions_cryptic_2_medium_difficulty_4",
			"missions_cryptic_2_medium_difficulty_5",
			"cryptic_medicae_saves",
			"cryptic_hacking_solves",
			"cryptic_flamethrower_kills",
			"cryptic_overload_stacking",
			...
			"cryptic_force_field_ranged_attacks_protection",
			"cryptic_win_in_all_game_modes",
			"cryptic_win_using_overload_keystone_and_abilities_combo",
