...
_add_category("veteran_challenges", "loc_achievement_category_class_feats_label", "veteran_2")
...
_add_category("zealot_challenges", "loc_achievement_category_class_feats_label", "zealot_2")
...
_add_category("psyker_challenges", "loc_achievement_category_class_feats_label", "psyker_2")
...
_add_category("ogryn_challenges", "loc_achievement_category_class_feats_label", "ogryn_2")
...
_add_category("adamant_challenges", "loc_achievement_category_class_feats_label", "adamant")
_add_category("adamant_abilites", "loc_class_abilities_title", "adamant")
_add_category("broker", "loc_class_broker_title")
_add_category("broker_progression", "loc_class_progression_title", "broker")
_add_category("broker_challenges", "loc_achievement_category_class_feats_label", "broker")
_add_category("broker_abilites", "loc_class_abilities_title", "broker")
_add_category("cryptic", "loc_class_cryptic_title")
_add_category("cryptic_progression", "loc_class_progression_title", "cryptic")
_add_category("cryptic_challenges", "loc_achievement_category_class_feats_label", "cryptic")
_add_category("cryptic_abilites", "loc_class_abilities_title", "cryptic")
...
_add_category("bestiary", "loc_achievement_category_bestiary_label", "heretics")
...
_add_category("mission_expeditions", "loc_achievement_subcategory_missions_expeditions_label", "missions")
