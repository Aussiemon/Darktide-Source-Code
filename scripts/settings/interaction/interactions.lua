...
local ExpeditionLootConverterInteraction = require("scripts/extension_systems/interaction/interactions/expedition_loot_converter_interaction")
...
local interactions = {
	...
	expedition_loot_converter = ExpeditionLootConverterInteraction,
