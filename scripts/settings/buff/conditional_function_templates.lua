...
ConditionalFunctionTemplates.is_reloading = function (template_data, template_context)
	local unit = template_context.unit
...
ConditionalFunctionTemplates.is_alternative_fire = function (template_data, template_context)
...
ConditionalFunctionTemplates.melee_weapon_special_active = function (template_data, template_context)
	local player_unit = template_context.unit
...
ConditionalFunctionTemplates.has_high_warp_charge = function (template_data, template_context)
	local player_unit = template_context.unit
	local unit_data_extension = ScriptUnit.extension(player_unit, "unit_data_system")
...
ConditionalFunctionTemplates.has_high_overheat = function (template_data, template_context)
	local player_unit = template_context.unit
	local slot_name = template_context.item_slot_name
	local unit_data_extension = ScriptUnit.extension(player_unit, "unit_data_system")
	local inventory_slot_component = unit_data_extension:read_component(slot_name)
...
ConditionalFunctionTemplates.is_lunging = function (template_data, template_context)
	local unit = template_context.unit
...
ConditionalFunctionTemplates.is_sprinting = function (template_data, template_context)
	local unit = template_context.unit
	local is_player = template_context.is_player
...
return ConditionalFunctionTemplates
