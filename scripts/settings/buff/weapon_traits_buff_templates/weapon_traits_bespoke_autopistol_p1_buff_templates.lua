...
local templates = {
	...
	weapon_trait_bespoke_autopistol_p1_reload_speed_on_slide = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_close_kill),
	weapon_trait_bespoke_autopistol_p1_reload_speed_on_slide_parent = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_melee_kill_parent),
	weapon_trait_bespoke_autopistol_p1_reload_speed_on_slide_child = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_melee_kill_child)
}
