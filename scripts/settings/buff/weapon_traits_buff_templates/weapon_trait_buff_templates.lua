...
local templates = {
	weapon_trait_ranged_first_shot_damage_increase = {
		predicted = false,
		class_name = "buff",
	...
	weapon_trait_ranged_crit_chance_on_max_ammo = {
		predicted = true,
		class_name = "buff",
		lerped_stat_buffs = {
	...
	weapon_trait_ranged_reload_speed_on_kill = {
		predicted = true,
	...
	weapon_trait_bash_refunds_warpcharge = {
		predicted = true,
		class_name = "proc_buff",
		proc_events = {
			[buff_proc_events.on_hit] = 1
	...
	weapon_trait_toughness_regen_near_burning_enemies = {
	...
	weapon_trait_melee_critical_strike_chance_on_weapon_special = {
		predicted = true,
		max_stacks = 1,
		class_name = "proc_buff",
		active_duration = 3,
	...
	weapon_trait_guaranteed_critical_strike_after_non_fatal_weapon_special = {
		max_stacks = 1,
		predicted = true,
		class_name = "proc_buff",
		proc_events = {
	...
	weapon_trait_guaranteed_crit_after_parry = {
		predicted = true,
		max_stacks = 1,
		class_name = "proc_buff",
		active_duration = 2,
	...
	weapon_trait_melee_damage_reduction_on_critical_strike = {
		predicted = false,
		max_stacks = 1,
		class_name = "proc_buff",
		active_duration = 10,
