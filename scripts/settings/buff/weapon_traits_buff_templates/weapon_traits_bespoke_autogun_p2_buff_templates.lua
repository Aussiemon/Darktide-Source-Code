...
templates.weapon_trait_bespoke_autogun_p2_reload_speed_on_slide = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_close_kill)
templates.weapon_trait_bespoke_autogun_p2_reload_speed_on_slide_parent = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_melee_kill_parent)
templates.weapon_trait_bespoke_autogun_p2_reload_speed_on_slide_child = table.clone(BaseWeaponTraitBuffTemplates.reload_speed_on_melee_kill_child)
