...
local templates = {
	...
	weapon_trait_melee_common_wield_on_hit_staggered_power_bonus_buff = {
		...
		conditional_stat_buffs_func = ConditionalFunctionTemplates.is_item_slot_wielded,
		conditional_proc_func = ConditionalFunctionTemplates.is_item_slot_wielded,
		check_proc_func = CheckProcFunctionTemplates.on_meelee_stagger_hit
	},
	...
	weapon_trait_melee_common_wield_on_heavy_hit_damage_bonus_buff = {
		...
		check_proc_func = function (params, template_data, template_context)
			local is_heavy_attack = CheckProcFunctionTemplates.on_heavy_hit(params)
	...
	weapon_trait_melee_common_wield_push_hit_grants_increased_attack_temporary_buff = {
		...
		check_proc_func = CheckProcFunctionTemplates.on_melee_and_check_item_slot,
		conditional_stat_buffs_func = ConditionalFunctionTemplates.is_item_slot_wielded,
		proc_func = function (params, template_data, template_context)
	...
	weapon_trait_melee_common_wield_on_block_break_grant_power_bonus_buff = {
		...
		conditional_proc_func = ConditionalFunctionTemplates.is_item_slot_wielded,
		check_proc_func = CheckProcFunctionTemplates.on_block_broken
	},
	...
	weapon_trait_melee_common_wield_on_weakspot_grant_power_bonus_buff = {
		...
		conditional_proc_func = ConditionalFunctionTemplates.is_item_slot_wielded,
		proc_func = function (params, template_data, template_context)
			if not CheckProcFunctionTemplates.on_weakspot_hit(params) then
				return
			end
