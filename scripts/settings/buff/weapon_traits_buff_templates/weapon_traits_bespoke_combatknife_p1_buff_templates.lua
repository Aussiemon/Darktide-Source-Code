...
templates.weapon_trait_bespoke_combatknife_p1_stacking_rending_on_weakspot_parent = table.clone(BaseWeaponTraitBuffTemplates.targets_receive_rending_debuff_on_weakspot_hit)
