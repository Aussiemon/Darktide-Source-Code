...
templates.weapon_trait_bespoke_combatsword_p2_pass_past_armor_on_crit.buff_data.internal_buff_name = "weapon_trait_bespoke_combatsword_p2_pass_past_armor_on_crit_effect"
templates.weapon_trait_bespoke_combatsword_p2_pass_past_armor_on_crit_effect = table.clone(BaseWeaponTraitBuffTemplates.pass_past_armor_on_crit_effect)
