...
local templates = {
	weapon_trait_bespoke_shotgun_p1_increase_power_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.increase_power_on_close_kill),
	weapon_trait_bespoke_shotgun_p1_count_as_dodge_vs_ranged_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.count_as_dodge_vs_ranged_on_close_kill),
	weapon_trait_bespoke_shotgun_p1_suppression_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.suppression_on_close_kill),
	weapon_trait_bespoke_shotgun_p1_increase_close_damage_on_close_kill = table.clone(BaseWeaponTraitBuffTemplates.increase_close_damage_on_close_kill)
}
