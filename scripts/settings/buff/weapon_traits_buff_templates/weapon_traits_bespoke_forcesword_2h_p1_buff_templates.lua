...
templates.weapon_trait_bespoke_forcesword_2h_p1_warp_burninating_on_crit = table.clone(BaseWeaponTraitBuffTemplates.warp_burninating_on_crits_melee_and_special)
