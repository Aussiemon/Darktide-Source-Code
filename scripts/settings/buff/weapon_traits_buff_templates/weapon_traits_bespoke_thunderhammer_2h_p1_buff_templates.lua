...
templates.weapon_trait_bespoke_thunderhammer_2h_p1_taunt_target_on_hit = table.clone(BaseWeaponTraitBuffTemplates.taunt_target_on_staggered_hit)
templates.weapon_trait_bespoke_thunderhammer_2h_p1_taunt_target_on_hit_child = table.clone(BaseWeaponTraitBuffTemplates.taunt_target_child)
templates.weapon_trait_bespoke_thunderhammer_2h_p1_taunt_target_on_hit.child_buff_template = "weapon_trait_bespoke_thunderhammer_2h_p1_taunt_target_on_hit_child"
