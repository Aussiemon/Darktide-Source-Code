...
_create_entry("scripts/settings/buff/expedition_buff_templates", buff_categories.generic)
...
_create_entry("scripts/settings/buff/hordes_buffs/hordes_legendary_buff_templates/hordes_legendary_cryptic_buff_templates", buff_categories.hordes_buff)
...
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_phosphor_pistol_p1_buff_templates", buff_categories.weapon_traits)
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_arc_rifle_p1_buff_templates", buff_categories.weapon_traits)
...
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_galvanic_rifle_p1_buff_templates", buff_categories.weapon_traits)
...
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_powermaul_p3_buff_templates", buff_categories.weapon_traits)
...
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_powersword_p3_buff_templates", buff_categories.weapon_traits)
...
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_transonic_claw_p1_buff_templates", buff_categories.weapon_traits)
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_transonic_knife_p1_buff_templates", buff_categories.weapon_traits)
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_transonic_sword_p1_buff_templates", buff_categories.weapon_traits)
_create_entry("scripts/settings/buff/weapon_traits_buff_templates/weapon_traits_bespoke_transonic_sword_transonic_knife_p1_buff_templates", buff_categories.weapon_traits)
...
_create_entry("scripts/settings/buff/archetype_buff_templates/cryptic_buff_templates", buff_categories.talents)
...
_create_entry("scripts/settings/buff/live_event_buff_templates/live_event_skulls_guns_buff_templates", buff_categories.live_event)
_create_entry("scripts/settings/buff/live_event_buff_templates/live_event_leftover_buff_templates", buff_categories.live_event)
_create_entry("scripts/settings/buff/live_event_buff_templates/live_event_barren_buff_templates", buff_categories.live_event)
