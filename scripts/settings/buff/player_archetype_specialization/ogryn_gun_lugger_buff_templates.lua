...
templates.ogryn_gun_lugger_no_ammo_consumption_passive = {
	predicted = false,
...
templates.ogryn_gun_lugger_ammo_passive = {
	predicted = false,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_passive_proc_buff = {
	predicted = false,
	class_name = "proc_buff",
	keywords = {
...
templates.ogryn_gun_lugger_passive_improved = {
	predicted = false,
	class_name = "proc_buff",
	proc_events = {
...
templates.ogryn_gun_lugger_vs_suppression_aura = {
	predicted = false,
...
templates.ogryn_gun_lugger_vs_suppression_aura_improved = {
	predicted = false,
...
templates.ogryn_gun_reduced_ranged_damage_aura = {
	predicted = false,
	coherency_priority = 1,
...
templates.ogryn_gun_lugger_increased_damage_vs_hordes = {
	predicted = false,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_toughness_on_ranged_kill = {
	predicted = false,
	class_name = "proc_buff",
	proc_events = {
...
templates.ogryn_gun_lugger_clip_size = {
	predicted = false,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_increased_damage_to_close_enemies = {
	predicted = false,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_crit_on_kills = {
	class_name = "proc_buff",
	predicted = false,
	proc_events = {
		[proc_events.on_hit] = 1
...
templates.ogryn_gun_lugger_crit_on_kill_buff = {
	predicted = false,
	max_stacks_cap = 15,
...
templates.ogryn_gun_lugger_increased_suppression = {
	predicted = false,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_buff_on_suppressing_enemies = {
	predicted = false,
	class_name = "proc_buff",
	proc_events = {
...
templates.ogryn_gun_lugger_suppressing_bonus_buff = {
	predicted = false,
	refresh_duration_on_stack = true,
	max_stacks = 1,
	duration = 5,
...
templates.ogryn_gun_lugger_reload_speed_on_final_shot = {
	predicted = false,
	class_name = "proc_buff",
	proc_events = {
		[proc_events.on_ammo_consumed] = 1
...
templates.ogryn_gun_lugger_reload_speed_buff = {
	predicted = false,
	refresh_duration_on_stack = true,
	max_stacks = 1,
	duration = 3,
...
templates.ogryn_gun_lugger_movement_speed_on_ranged_kill = {
	predicted = true,
	class_name = "proc_buff",
	active_duration = 5,
	proc_events = {
...
templates.ogryn_gun_lugger_suppressing_taunts_ranged_enemies = {
	predicted = false,
	class_name = "proc_buff",
	proc_events = {
		[proc_events.on_suppress] = 1
...
templates.ogryn_gun_lugger_suppressed_minion_debuff = {
	predicted = false,
	max_stacks = 1,
	duration = 15,
	class_name = "buff",
...
templates.ogryn_gun_lugger_increased_movement_on_braced_shooting = {
	predicted = true,
	class_name = "buff",
	conditional_stat_buffs = {
...
templates.ogryn_gun_lugger_regen_toughness_on_braced = {
	class_name = "buff",
	update_func = function (template_data, template_context)
...
templates.ogryn_gun_lugger_damage_taken_contact = {
	predicted = false,
	duration = 3,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_no_movement_penalty_buff = {
	predicted = false,
	duration = 6,
	class_name = "buff",
	stat_buffs = {
...
templates.ogryn_gun_lugger_suppression = {
	predicted = false,
	duration = 6,
	class_name = "buff",
	stat_buffs = {
