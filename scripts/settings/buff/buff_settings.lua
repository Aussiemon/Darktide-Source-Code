...
local buff_settings = {
	keywords = table.enum("allow_backstabbing", "allow_flanking", "allow_hipfire_during_sprint", "armor_penetrating", "beast_of_nurgle_liquid_immunity", "beast_of_nurgle_vomit", "bleeding", "block_gives_warp_charge", "burning", "can_block_ranged", "cluster_explode_on_super_armored", "coherency_with_all_no_chain", "concealed", "count_as_dodge_vs_all", "count_as_dodge_vs_melee", "count_as_dodge_vs_ranged", "critical_hit_infinite_hit_mass", "critical_hit_second_projectile", "cultist_flamer_liquid_immunity", "damage_immune", "despawn_on_death", "deterministic_recoil", "electrocuted", "empowered", "fully_charged_attacks_infinite_cleave", "guaranteed_critical_strike", "guaranteed_melee_critical_strike", "guaranteed_ranged_critical_strike", "guaranteed_smite_critical_strike", "health_segment_breaking_reduce_damage_taken", "hud_nameplates_disabled", "ignore_armor_aborts_attack_critical_strike", "ignore_armor_aborts_attack", "improved_ammo_pickups", "improved_medical_crate", "in_toxic_gas", "invisible", "knock_down_on_slide", "melee_alternate_fire_interrupt_immune", "melee_infinite_cleave_critical_strike", "melee_infinite_cleave", "melee_push_immune", "no_ammo_consumption", "no_coherency_stickiness_limit", "ogryn_improved_lunge", "psychic_fortress", "psyker_empowered_grenade", "ranged_alternate_fire_interrupt_immune", "ranged_push_immune", "reduced_ammo_consumption", "renegade_flamer_liquid_immunity", "renegade_grenadier_liquid_immunity", "resist_death", "shock_grenade_shock", "slowdown_immune", "special_ammo", "sprint_dodge_in_overtime", "sticky_projectiles", "stimmed", "stun_immune", "super_armor_override", "suppression_immune", "taunted", "uninterruptible", "unperceivable", "use_reduced_hit_mass", "veteran_ranger_combat_ability", "warpfire_burning", "weakspot_hit_gains_armor_penetration", "zealot_maniac_empowered_martyrdom", "zealot_toughness", "zero_slide_friction")
}
...
buff_settings.stat_buff_types = {
	...
	psyker_knife_replenishment_multiplier = "multiplicative_multiplier",
