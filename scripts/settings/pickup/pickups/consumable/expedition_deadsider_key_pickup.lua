-- chunkname: @scripts/settings/pickup/pickups/consumable/expedition_deadsider_key_pickup.lua

local ExpeditionCollectibles = require("scripts/settings/expeditions/expedition_collectibles")
local collectible_key = "deadsider_key"
