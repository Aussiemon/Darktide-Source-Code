-- chunkname: @scripts/settings/pickup/pickups/consumable/expedition_max_toughness_pickup.lua

local pickup_data = {
	buff_name = "expedition_max_toughness_buff",
	description = "loc_game_mode_expedition_pickup_buff_max_toughness",
	group = "forge_material",
	interaction_type = "forge_material",
	look_at_tag = "forge_material",
	name = "expedition_max_toughness",
	pickup_sound = "wwise/events/player/play_pick_up_expeditions_store_toughness",
