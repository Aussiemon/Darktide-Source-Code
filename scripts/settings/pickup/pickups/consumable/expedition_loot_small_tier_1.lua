-- chunkname: @scripts/settings/pickup/pickups/consumable/expedition_loot_small_tier_1.lua

local pickup_data = {
	description = "loc_expeditions_pickup_loot_quality_low",
	group = "expeditions_loot",
	interaction_type = "expeditions_loot",
	look_at_tag = "healthstation",
	name = "expedition_loot_small_tier_1",
	pickup_sound = "wwise/events/player/play_pick_up_expeditions_loot_quality_low",
