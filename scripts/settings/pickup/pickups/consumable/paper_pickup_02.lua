-- chunkname: @scripts/settings/pickup/pickups/consumable/paper_pickup_02.lua

local pickup_data = {
	description = "loc_paper_pickup",
	group = "objective",
	interaction_type = "objective_pickup_hidden_hold",
	name = "paper_pickup_02",
	pickup_sound = "wwise/events/player/play_pick_up_paper",
	smart_tag_target_type = "pickup",
	unit_name = "content/pickups/consumables/objective/intel_prop_02",
