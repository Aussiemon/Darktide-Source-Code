-- chunkname: @scripts/settings/pickup/pickups/pocketable/expedition_loot_crate_tier_3_pickup.lua
...
local pickup_data = {
	...
	inventory_item = "content/items/pocketable/expedition_loot_crate_tier_3_pocketable",
	inventory_slot_name = "slot_pocketable",
	is_side_mission_pickup = false,
	look_at_tag = "none",
	name = "expedition_loot_crate_tier_3",
	pickup_sound = "wwise/events/player/play_pick_up_expeditions_loot_crate_quality_high",
	smart_tag_target_type = "pickup",
	unit_name = "content/pickups/pocketables/expedition_loot_crate/expedition_loot_crate_03_pickup",
	loot_data = loot_data,
