-- chunkname: @scripts/settings/pickup/pickups/pocketable/expedition_loot_crate_tier_2_pickup.lua
...
local pickup_data = {
	...
	inventory_item = "content/items/pocketable/expedition_loot_crate_tier_2_pocketable",
	inventory_slot_name = "slot_pocketable",
	is_side_mission_pickup = false,
	look_at_tag = "none",
	name = "expedition_loot_crate_tier_2",
	pickup_sound = "wwise/events/player/play_pick_up_expeditions_loot_crate_quality_medium",
