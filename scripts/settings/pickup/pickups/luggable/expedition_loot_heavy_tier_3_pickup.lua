-- chunkname: @scripts/settings/pickup/pickups/luggable/expedition_loot_heavy_tier_3_pickup.lua
...
local pickup_data = {
	...
	inventory_item = "content/items/luggable/expedition_loot_heavy_tier_3",
	look_at_tag = "luggable",
	name = "expedition_loot_heavy_tier_3",
	pickup_sound = "wwise/events/world/play_int_battery_pick_up",
	smart_tag_target_type = "pickup",
	unit_name = "content/pickups/luggables/expedition_loot_heavy_03/expedition_loot_heavy_03",
	...
	on_pickup_func = function (pickup_unit, interactor_unit, pickup_data)
		...
		Managers.state.pacing:add_heat_by_type("large", pickup_unit, "pickups", interactor_unit)
	end,
