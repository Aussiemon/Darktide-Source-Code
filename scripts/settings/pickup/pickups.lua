...
_create_pickup_entry("scripts/settings/pickup/pickups/reward/live_event_leftover_01_pick_up_large")
_create_pickup_entry("scripts/settings/pickup/pickups/reward/live_event_leftover_01_pick_up_medium")
_create_pickup_entry("scripts/settings/pickup/pickups/reward/live_event_leftover_01_pick_up_small")
