...
minion_difficulty_settings.health = {
	...
	chaos_armored_hound = _special_health_steps(1100),
	...
	chaos_ogryn_houndmaster = _monster_health_steps(22000),
	...
	renegade_vanguard = _roamer_health_steps(850),
	renegade_rifleman = {
		150,
		188,
		225,
	...
	cultist_vanguard = _roamer_health_steps(650),
	...
	sand_vortex = _roamer_health_steps(1000),
	nurgle_flies = _roamer_health_steps(1000),
	attack_valkyrie = _roamer_health_steps(1000),
}
minion_difficulty_settings.hit_mass = {
	chaos_armored_hound = 8,
	...
	chaos_ogryn_houndmaster = 20,
	chaos_plague_ogryn = 20,
	chaos_poxwalker_bomber = 5,
	chaos_spawn = 20,
	cultist_berzerker = 4,
	cultist_captain = 20,
	cultist_flamer = 2,
...
minion_difficulty_settings.cooldowns = {
	...
	chaos_armored_hound_pounce_fail = {
		6,
		6,
		4,
		3,
