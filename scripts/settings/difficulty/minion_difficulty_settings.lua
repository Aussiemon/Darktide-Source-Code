...
function _horde_health_steps(health)
	local health_steps = {
		health * 1,
		health * 1.25,
		health * 1.5,
...
function _roamer_health_steps(health)
	local health_steps = {
		health * 1,
		health * 1.25,
		health * 1.5,
...
function _special_health_steps(health)
	local health_steps = {
		health * 0.85,
		health * 1,
		health * 1.25,
...
function _elite_health_steps(health)
	local health_steps = {
		health * 0.75,
		health * 1,
		health * 1.25,
...
function _monster_health_steps(health)
	local health_steps = {
		health * 1,
		health * 1.25,
		health * 1.5,
...
function _step_dmg_horde_melee(damage)
	local damage_steps = {
		damage * 0.75,
		damage * 1,
		damage * 1.5,
...
function _step_dmg_berzerker_melee(damage)
	local damage_steps = {
		damage * 1,
		damage * 1.5,
		damage * 2,
...
function _step_dmg_melee(damage)
	local damage_steps = {
		damage * 1.25,
		damage * 2,
		damage * 2.5,
...
function _step_dmg_ranged(damage)
	local damage_steps = {
		damage * 0.75,
		damage * 1.25,
		damage * 1.5,
...
function _shoot_steps_asc(from, to, ceil)
	local steps = {
		0.75,
		0.85,
		1,
...
function _shoot_steps_desc(from, to, ceil)
	local steps = {
		1.5,
		1.35,
		1.2,
