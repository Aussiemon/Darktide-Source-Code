...
mission_settings.mission_zone_ids = table.enum("dust", "entertainment", "hub", "placeholder", "prologue", "tank_foundry", "throneside", "training_grounds", "transit", "void", "watertown")
