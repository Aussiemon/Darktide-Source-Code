...
local mission_templates = {
	...
	op_no_mans_land = {
		...
		pickup_pool = "operations_distribution_pool",
		texture_big = "content/ui/textures/missions/op_no_mans_land_big",
		texture_medium = "content/ui/textures/missions/op_no_mans_land_medium",
		texture_small = "content/ui/textures/missions/op_no_mans_land_small",
