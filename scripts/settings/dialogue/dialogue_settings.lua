...
DialogueSettings.default_view_distance = 30
...
DialogueSettings.npc_story_tick_time = 100
DialogueSettings.store_npc_cooldown_time = 5
DialogueSettings.mission_update_tick_time = 15
DialogueSettings.ambush_delay = 4
DialogueSettings.vector_delay = 6
DialogueSettings.sound_event_default_length = 3.4567
DialogueSettings.heavy_combat_inensity_threshold = 80
DialogueSettings.heavy_damage_threshold = 100
...
DialogueSettings.guidance_wrong_way_distance = 30
