-- chunkname: @scripts/settings/dialogue/selected_voice_settings.lua

local selected_voice_settings = {
	adamant_female_a = {
...
return settings("SelectedVoiceSettings", selected_voice_settings)
