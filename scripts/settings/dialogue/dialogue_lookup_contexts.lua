local dialogue_lookup_context_names = {
	...
	circumstance_vo_id = table.enum("circumstance_vo_darkness", "circumstance_vo_hunting_grounds, circumstance_vo_darkness", "circumstance_vo_ventilation_purge", "default", "thischeckisdisabled"),
