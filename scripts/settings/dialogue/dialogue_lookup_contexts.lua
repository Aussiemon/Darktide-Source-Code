local dialogue_lookup_context_names = {
	...
	current_mission = table.enum("cm_habs", "dm_forge", "dm_propaganda", "dm_stockpile", "fm_cargo", "fm_resurgence", "hm_cartel", "hm_strain", "km_enforcer", "km_station", "lm_cooling", "lm_rails", "lm_scavenge", "prologue"),
