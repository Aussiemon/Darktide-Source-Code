local dialogue_lookup_context_names = {
	...
	enemy_tag = table.enum("aggroed", "chaos_beast_of_nurgle", "chaos_daemonhost", "chaos_hound", "chaos_hound_mutator", "chaos_mutant_charger", "chaos_ogryn_bulwark", "chaos_ogryn_executor", "chaos_ogryn_gunner", "chaos_plague_ogryn", "chaos_poxwalker_bomber", "cultist_berzerker", "cultist_flamer", "cultist_grenadier", "cultist_gunner", "cultist_holy_stubber_gunner", "cultist_mutant", "cultist_shocktrooper", "monster", "renegade_berzerker", "renegade_executor", "renegade_flamer", "renegade_grenadier", "renegade_gunner", "renegade_netgunner", "renegade_shocktrooper", "renegade_sniper", "seen_netgunner_flee"),
	...
	killed_type = table.enum("chaos_daemonhost", "chaos_hound", "chaos_poxwalker_bomber", "cultist_berzerker", "cultist_flamer", "cultist_mutant", "monster", "renegade_berzerker", "renegade_flamer", "renegade_grenadier", "renegade_netgunner", "renegade_sniper"),
	...
	trigger_id = table.enum("answer_following", "answer_need", "answer_no", "answer_yes", "com_cheer", "com_need_ammo", "com_need_health", "com_thank_you", "debug_vo", "exploding_barrel", "location_enemy_there", "location_over_here", "location_this_way", "start_rescue", "start_revive"),
