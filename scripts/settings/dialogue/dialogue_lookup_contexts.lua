local dialogue_lookup_context_names = {
	all_context_names = table.enum("ability_name", "active_hordes", "attack_hit", "attack_name", "attack_tag", "attacked_class", "attacking_class", "breed_name", "category", "circumstance_name", "circumstance_vo_id", "class", "class_name", "conversation", "current_amount", "current_mission", "dialogue_name", "died_class", "distance", "enemies_close", "enemies_distant", "enemy_tag", "expression_type", "fail_reason", "friends_close", "friends_distant", "health", "hit_zone", "horde_type", "interactee_class", "interactor_class", "interactor_voice_profile", "is_circumstance", "is_decaying_tension", "is_hogtied", "is_local_player", "is_player", "item", "item_tag", "killed_type", "killer_class", "level_time", "look_at_tag", "mission", "number_of_kills", "objective_type", "pacing_state", "player_class", "player_level", "player_level_string", "player_profile", "player_voice_profiles", "reviving_vo_source", "sequence_no", "sound_event", "source_name", "speaker_class", "speaker_name", "stance_type", "starter_line", "story_name", "story_type", "target_distance", "target_name", "team_lowest_player_level", "team_threat_level", "threat_level", "total_ammo_percentage", "trigger_id", "trigger_type", "vo_event", "vo_line_id", "voice_template", "weapon_slot", "weapon_type"),
	ability_name = table.enum("ability_banisher", "ability_banisher_impact", "ability_biomancer_high", "ability_biomancer_low", "ability_bonebreaker", "ability_buff_stance", "ability_bullgryn", "ability_gun_lugger", "ability_gunslinger", "ability_litany", "ability_maniac", "ability_pious_stabber", "ability_protectorate_start", "ability_protectorate_stop", "ability_ranger", "ability_shock_trooper", "ability_squad_leader", "ability_venting"),
	...
	circumstance_vo_id = table.enum("circumstance_vo_darkness", "circumstance_vo_ember", "circumstance_vo_hunting_grounds, circumstance_vo_darkness", "circumstance_vo_toxic_gas", "circumstance_vo_ventilation_purge", "default", "thischeckisdisabled"),
	...
	dialogue_name = table.enum("critical_health", "debug_player_vo_conversational", "mission_twins_arrival_05_a", "mission_twins_arrival_05_b", "reload_failed_out_of_ammo"),
	died_class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	enemy_tag = table.enum("aggroed", "chaos_beast_of_nurgle", "chaos_daemonhost", "chaos_hound", "chaos_hound_mutator", "chaos_mutant_charger", "chaos_ogryn_bulwark", "chaos_ogryn_executor", "chaos_ogryn_gunner", "chaos_plague_ogryn", "chaos_poxwalker_bomber", "chaos_spawn", "cultist_berzerker", "cultist_flamer", "cultist_grenadier", "cultist_gunner", "cultist_holy_stubber_gunner", "cultist_mutant", "cultist_shocktrooper", "monster", "renegade_berzerker", "renegade_executor", "renegade_flamer", "renegade_grenadier", "renegade_gunner", "renegade_netgunner", "renegade_shocktrooper", "renegade_sniper", "seen_netgunner_flee"),
	...
	interactee_class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	interactor_class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	...
	weapon_type = table.enum("chainsword_p1_m1, chainsword_2h_p1_m1, chainaxe_p1_m1", "chainsword_p1_m1, combataxe_p1_m1, combataxe_p1_m2, combataxe_p1_m3, combataxe_p2_m1, combataxe_p2_m2, combataxe_p2_m3, combatsword_p1_m1, combatsword_p1_m2, combatsword_p1_m3, combatsword_p3_m1, combatsword_p3_m2, combatsword_p3_m3, combatknife_p1_m1, forcesword_p1_m1, forcesword_p1_m2, forcesword_p1_m3", "flamer_p1_m1", "plasmagun_p1_m1", "thunderhammer_2h_p1_m1, thunderhammer_2h_p1_m2")
}
...
dialogue_lookup_context_names.weapon_type = _create_lookup(dialogue_lookup_context_names.weapon_type)
