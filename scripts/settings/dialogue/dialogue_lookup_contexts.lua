local dialogue_lookup_context_names = {
	all_context_names = table.enum("ability_name", "active_hordes", "attack_hit", "attack_name", "attack_tag", "attacked_class", "attacking_class", "breed_name", "category", "circumstance_name", "circumstance_vo_id", "class", "class_name", "conversation", "current_amount", "current_mission", "dialogue_name", "died_class", "distance", "enemies_close", "enemies_distant", "enemy_tag", "expression_type", "fail_reason", "friends_close", "friends_distant", "health", "hit_zone", "horde_type", "interactee_class", "interactor_class", "interactor_voice_profile", "is_circumstance", "is_decaying_tension", "is_hogtied", "is_knocked_down", "is_ledge_hanging", "is_local_player", "is_player", "is_pounced_down", "item", "item_tag", "killed_type", "killer_class", "level_time", "look_at_tag", "mission", "number_of_kills", "objective_type", "pacing_state", "player_class", "player_level", "player_profile", "player_voice_profiles", "reviving_vo_source", "sequence_no", "source_name", "speaker_class", "speaker_name", "stance_type", "starter_line", "story_name", "story_type", "target_name", "team_lowest_player_level", "team_threat_level", "threat_level", "total_ammo_percentage", "trigger_id", "trigger_type", "vo_event", "vo_line_id", "voice_template", "weapon_slot"),
	ability_name = table.enum("ability_banisher", "ability_banisher_impact", "ability_biomancer_high", "ability_biomancer_low", "ability_bonebreaker", "ability_bullgryn", "ability_dash", "ability_gun_lugger", "ability_gunslinger", "ability_maniac", "ability_pious_stabber", "ability_protectorate_start", "ability_protectorate_stop", "ability_ranger", "ability_shock_trooper", "ability_squad_leader", "ability_squad_leader_shout", "ability_stance", "overcharge_venting"),
	...
	circumstance_vo_id = table.enum("default"),
	class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	class_name = table.enum("mourningstar_servitor", "ogryn", "psyker", "veteran", "zealot"),
	current_mission = table.enum("cm_habs", "dm_forge", "dm_propaganda", "dm_stockpile", "fm_cargo", "hm_strain", "km_enforcer", "km_station", "lm_cooling", "lm_rails", "lm_scavenge", "prologue"),
	dialogue_name = table.enum("cmd_move_fwd", "critical_health", "info_incoming_enemies", "obj_mission_control", "obj_mission_kill", "reload_failed_out_of_ammo", "response_for_obj_mission_control_a", "response_for_obj_mission_kill_a"),
	died_class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	enemy_tag = table.enum("chaos_beast_of_nurgle", "chaos_daemonhost", "chaos_hound", "chaos_mutant_charger", "chaos_ogryn_bulwark", "chaos_ogryn_executor", "chaos_ogryn_gunner", "chaos_plague_ogryn", "chaos_poxwalker_bomber", "cultist_berzerker", "cultist_flamer", "cultist_grenadier", "cultist_gunner", "cultist_holy_stubber_gunner", "cultist_mutant", "cultist_shocktrooper", "monster", "renegade_executor", "renegade_grenadier", "renegade_gunner", "renegade_netgunner", "renegade_shocktrooper", "renegade_sniper"),
	...
	killed_type = table.enum("chaos_daemonhost", "chaos_hound", "chaos_poxwalker_bomber", "cultist_berzerker", "cultist_flamer", "cultist_mutant", "monster", "renegade_executor", "renegade_grenadier", "renegade_gunner", "renegade_netgunner"),
	killer_class = table.enum("ogryn", "psyker", "veteran", "zealot"),
	look_at_tag = table.enum("_conversation_name_", "access_elevator", "almost_there", "ammo", "asset_acid_clouds", "asset_cartel_insignia", "asset_foul_smoke", "asset_goo", "asset_grease_pit", "asset_pneumatic_press", "asset_sigil", "asset_unnatural_dark_a", "asset_water_course", "bomb", "chargeable_health_station", "charged_health_station", "cmd_mission_scavenge_entering_ship_port", "generic_dead_end", "generic_spotting_dead_body", "grenade", "guidance_correct_path_across", "guidance_correct_path_alley", "guidance_correct_path_drop", "guidance_correct_path_ladder_down", "guidance_correct_path_ladder_up", "guidance_correct_path_stairs_down", "guidance_correct_path_stairs_up", "guidance_correct_path_up", "guidance_ladder_sighted", "guidance_stairs_sighted", "hab_block_apartment", "health", "healthstation", "info_asset_cult_breaking_wheel", "info_asset_nurgle_growth", "info_call_abyss", "info_graffiti_one", "info_mission_cooling_maintenance", "info_mission_scavenge_hangar_guidance_one", "info_mission_scavenge_hangar_guidance_two", "level_hab_block_atrium", "level_hab_block_b", "level_hab_block_corpse", "level_hab_block_entrance", "level_hab_block_market", "level_hab_block_quarantine", "level_hab_block_roof", "level_hab_block_security", "level_hab_block_trapped", "level_hab_block_vista", "mission_cargo_coolant_control", "mission_cargo_hab_feed_lines", "mission_cargo_labyrinth", "mission_cargo_production_line", "mission_cargo_something_big", "mission_cargo_worker_cloister", "mission_cartel_checkpoint", "mission_cartel_keep_moving", "mission_cartel_mudlark", "mission_cartel_old_hab", "mission_cartel_pillar", "mission_cartel_sewer", "mission_cartel_shanty", "mission_cartel_town_centre", "mission_cooling_long_way_down", "mission_cooling_overseer_office", "mission_cooling_production_line", "mission_deception", "mission_enforcer_courtroom", "mission_enforcer_enforcer_station", "mission_enforcer_hab_support", "mission_enforcer_infrastructure", "mission_enforcer_through_hab", "mission_enforcer_traders_row", "mission_forge_labour_oversight", "mission_forge_lifeless", "mission_forge_main_entrance", "mission_forge_propaganda", "mission_forge_superstructure", "mission_propaganda_cultist_town", "mission_propaganda_infested_elevator", "mission_propaganda_nearing_transmission_complex", "mission_rails_descend_shaft", "mission_rails_district_gate", "mission_rails_hab_block_dreyko", "mission_rails_refectory", "mission_rails_station_approach", "mission_scavenge_interior", "mission_scavenge_underhalls", "mission_station_approach", "mission_station_contrabrand_lockers", "mission_station_cross_station", "mission_station_interrogation_bay_a", "mission_station_station_hall", "mission_station_the_bridge", "mission_stockpile_bridge", "mission_stockpile_cartel_habs", "mission_stockpile_holo_statue", "mission_stockpile_main_access", "mission_stockpile_ruined_hab", "mission_stockpile_tarp_town", "mission_stockpile_through_to_silo", "mission_strain_atmosphere_shield", "mission_strain_crossroads", "mission_strain_elevator_found", "mission_strain_inert_tanks", "mission_strain_keep_following_pipes", "nurgle_circumstance_prop_alive", "nurgle_circumstance_prop_growth", "nurgle_circumstance_prop_shrine", "potion", "soldiers", "special_item", "this_way", "this_way_bridge", "this_way_correct_path_across", "this_way_correct_path_alley", "this_way_correct_path_ladder_down", "this_way_correct_path_ladder_up", "this_way_door", "this_way_down", "this_way_stairs_down", "this_way_stairs_up", "this_way_street", "this_way_up"),
	...
	vo_event = table.enum("aggroed", "alerted", "combo_attack", "seen_netgunner_flee", "sniper_aiming"),
