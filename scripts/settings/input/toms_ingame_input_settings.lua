...
local toms_ingame_input_settings = {
	service_type = "Ingame",
...
if IS_XBS then
	toms_ingame_input_settings.aliases.voip_push_to_talk = nil
	toms_ingame_input_settings.settings.voip_push_to_talk = nil
end

return settings("TomsIngameInputSettings", toms_ingame_input_settings)
