...
local v2_ingame_input_settings = {
	service_type = "Ingame",
...
if IS_XBS then
	v2_ingame_input_settings.aliases.voip_push_to_talk = nil
	v2_ingame_input_settings.settings.voip_push_to_talk = nil
end

return settings("v2IngameInputSettings", v2_ingame_input_settings)
