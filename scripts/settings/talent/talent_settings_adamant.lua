	...
	adamant = {
		combat_ability = {
			...
			stance = {
				...
				damage = 0.2,
				damage_taken_multiplier = 0.3,
				damage_talent_damage = 0.075,
				damage_talent_duration = 12,
				damage_talent_stacks = 6,
				duration = 10,
				linger_time = 2,
				max_charges = 1,
				movement_speed = 0.15,
		...
		terminus_warrant = {
			...
			ranged_power_level_modifier = 0.1,
			ranged_remove = 1,
			ranged_rending = 0.15,
			ranged_stacks_on_weakspot = 3,
			ranged_swap_stacks = 15,
			reload_per_stack = 0.05,
			reload_speed = 0.2,
			suppression_dealt = 0.5,
			swap_stacks = 1,
			swap_stacks_talent = 30,
			toughness_damage_taken_multiplier = 0.8,
			toughness_replenish = 0.01,
