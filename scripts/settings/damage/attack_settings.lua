...
attack_settings.attack_results = table.enum("damaged", "died", "dodged", "blocked", "toughness_absorbed", "toughness_absorbed_melee", "toughness_broken", "shield_blocked", "shield_absorbed", "knock_down", "friendly_fire")
...
attack_settings.is_damaging_result = {
	...
	[attack_settings.attack_results.shield_absorbed] = true,
	[attack_settings.attack_results.knock_down] = true,
	[attack_settings.attack_results.friendly_fire] = false,
}
attack_settings.attack_types = table.enum("arc", "melee", "ranged", "explosion", "shout", "buff", "push", "door_smash", "companion_dog", "incapacitating_pounce", "incapacitating_net")
...
attack_settings.shield_settings = table.enum("block_all", "absorb_all")
