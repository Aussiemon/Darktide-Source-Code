...
local explosion_templates = {
	...
	primer_gas = {
		...
		radius = 2.2,
		static_power_level = 600,
		damage_profile = DamageProfileTemplates.primer_gas,
		damage_type = damage_types.laser,
		broadphase_explosion_filter = {
			"heroes",
			"villains",
		...
		vfx = {
			"content/fx/particles/weapons/pistols/needlepistol/needlepistol_explosion_primer_m1",
		},
		sfx = {
	...
	primer_explosion = {
		...
		scalable_radius = true,
		static_power_level = 500,
		close_damage_profile = DamageProfileTemplates.primer_explosion_close,
		close_damage_type = damage_types.grenade_frag,
		damage_profile = DamageProfileTemplates.primer_explosion,
		damage_type = damage_types.grenade_frag,
		broadphase_explosion_filter = {
			"heroes",
			"villains",
		...
		vfx = {
			"content/fx/particles/weapons/pistols/needlepistol/needlepistol_explosion_primer_m2",
		},
		sfx = {
	...
	primer_stun = {
		...
		min_close_radius = 1,
		min_radius = 0.5,
		on_hit_buff_template_name = "toxin_special_stun",
		radius = 2,
		scalable_radius = true,
		static_power_level = 100,
		close_damage_profile = DamageProfileTemplates.primer_stun,
		close_damage_type = damage_types.electrocution,
		damage_profile = DamageProfileTemplates.primer_stun,
	...
	broker_stimm_field = {
		...
		scalable_radius = true,
		static_power_level = 500,
		close_damage_profile = DamageProfileTemplates.broker_stimm_field_close,
		close_damage_type = damage_types.grenade_frag,
		damage_profile = DamageProfileTemplates.broker_stimm_field,
		damage_type = damage_types.grenade_frag,
		broadphase_explosion_filter = {
			"villains",
		},
