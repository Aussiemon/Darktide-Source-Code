...
local hit_effect_armor_type_overrides = table.enum("prop_armored", "prop_druglab_tank", "prop_ice_chunk", "prop_train_cogitator", "nurgle_totem", "rotten_armor", "prop_electrical_fusebox_01")
