...
damage_templates.psyker_protectorate_smite = {
...
overrides.psyker_protectorate_smite_fast = {
	parent_template_name = "psyker_protectorate_smite",
	overrides = {
		{
			"power_distribution",
			"attack",
...
damage_templates.psyker_protectorate_smite_interval = {
	chain_lightning = true,
	stagger_category = "sticky",
	armor_damage_modifier = {
		attack = {
