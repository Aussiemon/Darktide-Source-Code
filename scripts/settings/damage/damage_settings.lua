...
damage_settings.damage_types = table.enum("chaos_hound_tearing", "daemonhost_melee", "daemonhost_execute", "minion_mutant_smash", "minion_mutant_smash_ogryn", "minion_ogryn_kick", "minion_ogryn_executor_pommel", "minion_ogryn_punch", "minion_beast_of_nurgle_weakspot_hit", "minion_auto_bullet", "minion_large_caliber", "minion_laser", "minion_plasma", "minion_melee_blunt", "minion_melee_blunt_elite", "minion_melee_sharp", "minion_monster_sharp", "minion_monster_blunt", "minion_monster_eat", "minion_pellet", "minion_pellet_captain", "minion_direct_flamer", "minion_powered_sharp", "minion_powered_blunt", "minion_charge", "minion_vomit", "blunt_thunder", "blunt", "blunt_light", "blunt_heavy", "blunt_shock", "combat_blade", "metal_slashing_heavy", "metal_slashing_light", "metal_slashing_medium", "ogryn_physical", "ogryn_lunge", "ogryn_shovel_fold_special", "physical", "power_sword", "power_sword_2h", "sawing_stuck", "sawing", "sawing_2h", "shield_push", "slabshield_push", "shock_stuck", "shovel_heavy", "shovel_light", "shovel_medium", "shovel_smack", "ogryn_shovel_smack", "slashing_force_stuck", "slashing_force", "knife", "axe_light", "spiked_blunt", "bash", "ogryn_pipe_club", "ogryn_pipe_club_heavy", "blunt_powermaul_active", "ogryn_punch", "ogryn_slap", "punch", "weapon_butt", "piercing_heavy", "ogryn_hook", "auto_bullet", "boltshell", "boltshell_non_armed", "boltshell_small", "laser", "laser_charged", "laser_bfg", "overheat", "pellet", "pellet_heavy", "pellet_incendiary", "plasma", "rippergun_pellet", "rippergun_flechette", "throwing_knife", "throwing_knife_zealot", "heavy_stubber_bullet", "grenade_fire", "grenade_frag", "grenade_frag_ogryn", "grenade_krak", "minion_grenade", "ogryn_grenade_box", "ogryn_friend_rock", "bleeding", "burning", "corruption", "kinetic", "ogryn_bullet_bounce", "grimoire", "biomancer_soul", "smite", "electrocution", "force_sword_cleave", "force_staff_single_target", "force_staff_explosion", "force_staff_bfg", "psyker_biomancer_discharge", "warpfire", "warp", "warp_overload")
