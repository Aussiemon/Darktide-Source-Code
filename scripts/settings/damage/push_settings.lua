...
push_settings.push_templates = {
	...
	chaos_ogryn_houndmaster_push = {
		ignore_stun_immunity = true,
		max_speed_override = 4,
		push_through_block = true,
		speed = 4.2,
	},
	chaos_ogryn_houndmaster_push_ogryn = {
		ignore_stun_immunity = true,
		max_speed_override = 3.5,
		push_through_block = true,
		speed = 4,
	},
	chaos_ogryn_houndmaster_push_moving = {
		ignore_stun_immunity = true,
		max_speed_override = 5.5,
		push_through_block = true,
		speed = 4.5,
	},
	chaos_ogryn_houndmaster_push_moving_ogryn = {
		ignore_stun_immunity = true,
		max_speed_override = 4.5,
		push_through_block = true,
		speed = 5,
	},
	chaos_ogryn_houndmaster_charge = {
		ignore_stun_immunity = true,
		max_speed_override = 10,
		push_through_block = true,
		speed = 12,
	},
	chaos_ogryn_houndmaster_charge_ogryn = {
		ignore_stun_immunity = true,
		max_speed_override = 7,
		push_through_block = true,
		speed = 9,
	},
	chaos_ogryn_houndmaster_light_charge = {
		ignore_stun_immunity = true,
		max_speed_override = 7,
		push_through_block = true,
		speed = 9,
	},
	chaos_ogryn_houndmaster_charge_light_ogryn = {
		ignore_stun_immunity = true,
		max_speed_override = 6,
		push_through_block = true,
		speed = 7,
