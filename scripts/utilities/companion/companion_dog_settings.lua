-- chunkname: @scripts/utilities/companion/companion_dog_settings.lua

local PlayerCharacterConstants = require("scripts/settings/player_character/player_character_constants")
local CompanionDogSettings = {}

CompanionDogSettings.dog_forward_follow_config = {
...
CompanionDogSettings.dog_lrb_follow_config = {
	adapt_threshold_multiplier = 1,
	angle_rotation_for_check = 80,
	crouch_adapt_threshold_multiplier = 1,
	direction_timer = 0,
