...
local ExperiencePresentation = {
	...
	update_presentation = function (data, dt, t)
	...
	skip_to_next_timestamp = function (data)
		local experience_settings = data.experience_settings
		local start_level = data.start_level
	...
	setup_presentation_data = function (experience_settings, starting_experience, experience_gained, presentation_duration, level_up_delay)
