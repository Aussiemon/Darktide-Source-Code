...
local RangedAction = {
	...
	armor_explosion = function (is_server, world, physics_world, attacker_unit, hit_unit, hit_zone_name_or_nil, hit_position, hit_normal, hit_distance, attack_direction, damage_config, power_level, charge_level, weapon_item_or_nil)
		...
		Explosion.create_explosion(world, physics_world, estimated_exit_position, hit_normal, attacker_unit, armor_explosion_template, power_level, charge_level, attack_type, nil, weapon_item_or_nil)

		return true
	end,
	hitmass_explosion = function (is_server, world, physics_world, hit_mass_budget_attack, hit_mass_budget_impact, attacker_unit, hit_unit, hit_position, hit_normal, hit_distance, attack_direction, damage_config, attack_result, power_level, charge_level, weapon_item_or_nil)
		if not is_server then
			return false
		end
		...
		Explosion.create_explosion(world, physics_world, explosion_position, hit_normal, attacker_unit, explosion_template, power_level, charge_level, attack_type, nil, weapon_item_or_nil)
