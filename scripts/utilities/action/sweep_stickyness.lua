local SweepStickyness = {
	is_sticking_to_unit = function (action_sweep_component)
	...
	stick_to_position = function (action_sweep_component)
		local stick_to_unit = action_sweep_component.sweep_aborted_unit
	...
	num_damage_instances_this_frame = function (hit_stickyness_settings, start_t, t)
	...
	unit_which_aborted_sweep = function (action_sweep_component)
