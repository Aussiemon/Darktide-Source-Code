...
local WarpCharge = {
	...
	increase_over_time = function (dt, t, charge_level, warp_charge_component, charge_configuration, owner_unit, first_charge)
		local buff_extension = ScriptUnit.extension(owner_unit, "buff_system")
		local stat_buffs = buff_extension and buff_extension:stat_buffs()
	...
	update_observer = function (dt, t, player, unit, first_person_unit, world, follow_unit)
	...
	update = function (dt, t, warp_charge_component, player, unit, first_person_unit, is_local_unit, world)
		local archetype_warp_charge_template = WarpCharge.archetype_warp_charge_template(player)
	...
	can_vent = function (warp_charge_component)
	...
	start_venting = function (t, player, warp_charge_component)
		local archetype_warp_charge_template = WarpCharge.archetype_warp_charge_template(player)
	...
	update_venting = function (dt, t, player, warp_charge_component)
	...
	stop_venting = function (warp_charge_component)
		warp_charge_component.state = "idle"
	end,
	clear = function (warp_charge_component)
		warp_charge_component.state = "idle"
	...
	archetype_warp_charge_template = function (player)
	...
	weapon_warp_charge_template = function (player_unit)
	...
	wants_warp_charge_character_state = function (unit, unit_data_extension)
		local warp_charge_component = unit_data_extension:read_component("warp_charge")

		return warp_charge_component.state == "exploding"
	end,
	thresholds = function (player, warp_charge_component)
		local archetype_warp_charge_template = WarpCharge.archetype_warp_charge_template(player)
