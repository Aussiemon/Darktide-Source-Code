...
local Herding = {
	modify_ragdoll_push_direction = function (herding_template, original_push_direction, ragdoll_unit, hit_zone_name)
	...
	modify_stagger_direction = function (herding_template, original_attack_direction, attacking_unit, attacked_unit)
		...
		local unit_data_extension, first_person_component = nil
