-- chunkname: @scripts/utilities/threat.lua

local Threat = {}

Threat.add_threat = function (unit, threat_unit, damage_dealt_threat, damage_absorbed_threat, optional_damage_profile, optional_attack_type)
...
Threat.add_flat_threat = function (unit, threat_unit, threat)
	local perception_extension = ScriptUnit.has_extension(unit, "perception_system")
...
Threat.set_threat_decay_enabled = function (unit, enabled)
	local perception_extension = ScriptUnit.has_extension(unit, "perception_system")
