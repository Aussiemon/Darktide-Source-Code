...
local Overheat = {
	increase_immediate = function (t, charge_level, inventory_slot_component, charge_template, unit)
	...
	increase_over_time = function (dt, t, charge_level, inventory_slot_component, charge_template, unit)
		local buff_extension = ScriptUnit.extension(unit, "buff_system")
		local stat_buffs = buff_extension:stat_buffs()
	...
	update = function (dt, t, inventory_slot_component, overheat_configuration, unit, first_person_unit)
	...
	can_vent = function (inventory_slot_component)
	...
	start_venting = function (t, inventory_slot_component, vent_configuration)
	...
	update_venting = function (dt, t, player, inventory_slot_component, vent_configuration)
	...
	stop_venting = function (inventory_slot_component)
		inventory_slot_component.overheat_state = "idle"
	end,
	clear = function (inventory_slot_component)
		inventory_slot_component.overheat_state = "idle"
	...
	slot_percentage = function (unit, slot_name, threshold_type)
	...
	configuration = function (visual_loadout_extension, slot_name)
	...
	wants_overheat_character_state = function (unit, unit_data_extension)
		local visual_loadout_extension = ScriptUnit.extension(unit, "visual_loadout_system")
