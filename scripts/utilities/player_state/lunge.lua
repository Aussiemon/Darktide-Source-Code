-- chunkname: @scripts/utilities/player_state/lunge.lua

local Lunge = {}

Lunge.find_speed_settings_index = function (time_in_lunge, start_index, lunge_speed_at_times)
...
Lunge.find_current_lunge_speed = function (time_in_lunge, speed_settings_index, lunge_speed_at_times)
	local speed
