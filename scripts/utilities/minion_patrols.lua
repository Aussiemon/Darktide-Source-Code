...
local MinionPatrols = {
	...
	update_roamer_patrols = function (patrol_data, roamers, nav_world, zones)
		...
		for i = random_start_location_index, num_sub_zone_locations, 1 do
		...
		if not wanted_position then
			...
			for i = 1, num_sub_zone_locations, 1 do
				repeat
					local claimed_unit = claimed_sub_zone_indexes[i]
	...
	release_patrol_zone_location = function (claimed_patrol_zone_indexes, patrol_roamer)
