...
local HitZone = {}
local hit_zone_names = table.enum("head", "torso", "lower_tail", "upper_tail", "tongue", "upper_left_arm", "lower_left_arm", "upper_right_arm", "lower_right_arm", "upper_left_leg", "lower_left_leg", "upper_right_leg", "lower_right_leg", "afro", "center_mass", "hound_tail", "backpack", "tentacle", "captain_void_shield", "corruptor_armor", "shield", "weakspot", "right_shoulderguard", "canister", "delayed_gib")
