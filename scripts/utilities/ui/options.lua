local OptionsUtilities = {
	create_percent_slider_template = function (params)
		if not params.normalized_step_size then
			local normalized_step_size = (params.step_size_value or 1) / 100
		end
	...
	create_value_slider_template = function (params)
	...
	keybind_value_to_string = function (value)
		if not value then
			return
		end
