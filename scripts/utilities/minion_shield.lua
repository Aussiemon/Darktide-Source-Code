local MinionShield = {
	init_block_timings = function (scratchpad, action_data, anim_event, t)
	...
	reset_block_timings = function (scratchpad, unit)
	...
	update_block_timings = function (scratchpad, unit, t)
