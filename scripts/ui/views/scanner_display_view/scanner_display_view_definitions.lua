...
_extract_scanner_display_view_definitions("scripts/ui/views/scanner_display_view/scanner_display_view_definitions_decode_search")
...
_extract_scanner_display_view_definitions("scripts/ui/views/scanner_display_view/scanner_display_view_definitions_expedition_map")
