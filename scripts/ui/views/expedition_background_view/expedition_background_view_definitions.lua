-- chunkname: @scripts/ui/views/expedition_background_view/expedition_background_view_definitions.lua
				...
				tabs_params = {
					{
						...
						input_legend_buttons = {
							...
							{
								alignment = "right_alignment",
								display_name = "loc_popup_info",
								input_action = "hotkey_menu_special_2",
								on_pressed_callback = "cb_show_tutorial_window",
							},
						},
					},
				},
