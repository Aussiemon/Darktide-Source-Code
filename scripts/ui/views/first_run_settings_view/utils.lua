...
local utils = {
	extract_changed_values = function (template, new_value)
		local values = {}
	...
	add_side_effect_values = function (dest, new)
	...
	generate_settings_options = function (settings_definitions)
		local settings = {}
	...
	get_default_account_save_data = function (template)
