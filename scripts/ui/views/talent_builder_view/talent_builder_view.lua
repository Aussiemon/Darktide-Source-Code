...
TalentBuilderView._draw_connection_between_widgets = function (self, ui_renderer, visible, dt, parent_node, child_node, offset_x, offset_y, distance, angle)
	...
	anim_line_data.alpha_fraction = not (not can_progress and not progressing and not has_progressed) and math.clamp(anim_line_data.alpha_fraction + dt * alpha_anim_speed, 0, 1) or 0
...
TalentBuilderView._handeling_popup_window = function (self)
	return not (not self._summary_grid and not self._tutorial_grid) and true or false
end
