...
item_header_text_style.text_vertical_alignment = "top"
...
item_sub_header_text_style.text_vertical_alignment = "top"
...
item_description_text_style.text_horizontal_alignment = "left"
item_description_text_style.text_vertical_alignment = "bottom"
item_description_text_style.horizontal_alignment = "left"
...
local blueprints = {
	...
	button_old = {
		pass_template = ButtonPassTemplates.simple_button,
		init = function (parent, widget, element, callback_name)
	...
	aquila_button = {
		...
		init = function (parent, widget, element, callback_name)
			...
			content.element = element
			content.title = element.title or "<empty>"
			content.bonus_description = element.description or "<empty>"
			local title_style = style.title
			local title_width = content.size[1] + style.title.size_addition[1]
			local title_options = UIFonts.get_font_options_by_style(title_style)
