-- chunkname: @scripts/ui/views/crafting_mechanicus_replace_perk_view/crafting_mechanicus_replace_perk_view.lua
...
CraftingMechanicusReplacePerkView.init = function (self, settings, context)
...
CraftingMechanicusReplacePerkView.on_enter = function (self)
...
CraftingMechanicusReplacePerkView.on_exit = function (self)
...
CraftingMechanicusReplacePerkView._cb_fetch_perks_data = function (self)
...
CraftingMechanicusReplacePerkView._get_wallet = function (self)
...
CraftingMechanicusReplacePerkView._present_crafting = function (self, optional_present_callback)
...
CraftingMechanicusReplacePerkView._set_perks_item_focused = function (self, focus)
...
CraftingMechanicusReplacePerkView.on_back_pressed = function (self)
...
CraftingMechanicusReplacePerkView.cb_on_main_button_pressed = function (self)
	if self._craft_promise then
		return
	end
...
CraftingMechanicusReplacePerkView._perform_crafting = function (self)
	if self._craft_promise then
		return
	end
...
CraftingMechanicusReplacePerkView.cb_on_perk_selected = function (self, widget, config)
...
CraftingMechanicusReplacePerkView._on_perk_selected = function (self, widget, config)
...
CraftingMechanicusReplacePerkView._draw_elements = function (self, dt, t, ui_renderer, render_settings, input_service)
...
CraftingMechanicusReplacePerkView._update_elements = function (self, dt, t, input_service)
	local existing_perk_index = self._ingredients.existing_perk_index
	local elements_array = self._elements_array
...
CraftingMechanicusReplacePerkView.remove_ingredient = function (self, ingredient_index)
...
CraftingMechanicusReplacePerkView.update = function (self, dt, t, input_service)
...
CraftingMechanicusReplacePerkView.cb_on_new_perk_selected = function (self, widget, config)
	self._resync_can_craft = true
end

CraftingMechanicusReplacePerkView._handle_input = function (self, input_service)
...
CraftingMechanicusReplacePerkView._on_navigation_input_changed = function (self)
