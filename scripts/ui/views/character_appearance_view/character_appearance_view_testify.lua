-- chunkname: @scripts/ui/views/character_appearance_view/character_appearance_view_testify.lua

local CharacterAppearanceViewTestify = {
	character_appearance_view_continue = function (character_appearance_view)
		character_appearance_view:_on_continue_pressed()
	end,
	character_appearance_view_options_widgets = function (character_appearance_view)
	...
	character_appearance_view_set_item_per_slot = function (character_appearance_view, slot_name, item)
		local character_create = character_appearance_view:character_create()

		character_create:set_item_per_slot(slot_name, item)
	end,
	character_appearance_view_character_current_rotation = function (character_appearance_view)
		local profile_spawner = character_appearance_view:profile_spawner()

		return profile_spawner:rotation_angle()
	end,
	character_appearance_view_rotate_character_to_angle = function (character_appearance_view, dest_angle, increment)
		local profile_spawner = character_appearance_view:profile_spawner()
	...
	character_appearance_view_reset_rotation_angle = function (character_appearance_view)
		local profile_spawner = character_appearance_view:profile_spawner()
