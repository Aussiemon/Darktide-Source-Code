-- chunkname: @scripts/ui/views/crafting_mechanicus_modify_options_view/crafting_mechanicus_modify_options_view.lua
...
CraftingMechanicusModifyOptionsView.init = function (self, settings, context)
...
CraftingMechanicusModifyOptionsView.upgrade_item = function (self)
	self._wanted_tab_index = 1
end

CraftingMechanicusModifyOptionsView.extract_trait = function (self)
	self._wanted_tab_index = 3
end

CraftingMechanicusModifyOptionsView.replace_trait = function (self)
	self._wanted_tab_index = 2
end

CraftingMechanicusModifyOptionsView.on_enter = function (self)
...
CraftingMechanicusModifyOptionsView._fetch_inventory = function (self)
	local local_player_id = 1
...
CraftingMechanicusModifyOptionsView._get_wallet = function (self)
...
CraftingMechanicusModifyOptionsView._on_panel_option_pressed = function (self, index)
...
CraftingMechanicusModifyOptionsView.setup_prices_widget = function (self, costs, afford_by_type)
...
CraftingMechanicusModifyOptionsView._can_afford = function (self, costs)
...
CraftingMechanicusModifyOptionsView._remove_traits_widgets = function (self)
...
CraftingMechanicusModifyOptionsView._reset_state = function (self)
...
CraftingMechanicusModifyOptionsView._remove_trait_tooltip = function (self)
...
CraftingMechanicusModifyOptionsView._set_trait_tooltip = function (self, trait_info, direction)
...
CraftingMechanicusModifyOptionsView._set_tooltip_position = function (self, parent_widget, direction)
...
CraftingMechanicusModifyOptionsView._select_trait_extract = function (self, selected_widget)
	self:_remove_selected_widget()
	self:_remove_traits_widgets()
...
CraftingMechanicusModifyOptionsView._select_trait_modify = function (self, selected_widget)
	self:_remove_selected_widget()
	self:_remove_traits_widgets()
...
CraftingMechanicusModifyOptionsView._remove_selected_widget = function (self)
...
CraftingMechanicusModifyOptionsView._update_item_grid_position = function (self)
	if not self._inventory_traits_grid then
		return
	end
...
CraftingMechanicusModifyOptionsView._generate_weapon_traits = function (self)
	local traits = {}
...
CraftingMechanicusModifyOptionsView._setup_trait_tabs = function (self)
...
CraftingMechanicusModifyOptionsView._update_tab_bar_position = function (self)
...
CraftingMechanicusModifyOptionsView.cb_switch_trait_tab = function (self, index)
...
CraftingMechanicusModifyOptionsView._present_layout_by_trait_rarity = function (self, trait_rarity)
	local traits = {}
...
CraftingMechanicusModifyOptionsView.cb_on_grid_entry_left_pressed = function (self, widget, element)
...
CraftingMechanicusModifyOptionsView._destroy_weapon_preview = function (self)
...
CraftingMechanicusModifyOptionsView._set_preview_widgets_visibility = function (self, visible)
	CraftingMechanicusModifyOptionsView.super._set_preview_widgets_visibility(self, visible)
end

CraftingMechanicusModifyOptionsView.update = function (self, dt, t, input_service)
...
CraftingMechanicusModifyOptionsView.on_back_pressed = function (self, force_close)
...
CraftingMechanicusModifyOptionsView.on_exit = function (self)
...
CraftingMechanicusModifyOptionsView.draw = function (self, dt, t, input_service, layer)
...
CraftingMechanicusModifyOptionsView._on_navigation_input_changed = function (self)
	CraftingMechanicusModifyOptionsView.super._on_navigation_input_changed(self)
end

CraftingMechanicusModifyOptionsView._handle_input = function (self, input_service)
	local selected_trait = self._selected_trait
...
CraftingMechanicusModifyOptionsView.dialogue_system = function (self)
