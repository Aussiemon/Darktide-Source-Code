...
HudHealthBarLogic._sync_player_health = function (self, bar_progress, bar_max_progress)
	...
	if bar_progress ~= self._bar_progress or bar_max_progress ~= self._bar_max_progress then
		...
		local animating, health_anim_fraction = self:_set_bar_fraction(name, bar_progress, nil, settings.duration_health, health_animation_threshold, force_update)
...
HudHealthBarLogic._set_bar_fraction = function (self, name, fraction, current_fraction, total_duration, animation_threshold, force_update)
...
HudHealthBarLogic._update_bar_animation = function (self, anim_data, dt)
