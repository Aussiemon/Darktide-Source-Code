...
HudElementPrologueTutorialInfoBox._set_widget_info = function (self, info_data)
	...
	self:_set_widget_size_from_content(info_data.description, info_data.title)
...
HudElementPrologueTutorialInfoBox._set_widget_size_from_content = function (self, description, title_text)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.info_widget
	...
	local title_text_width = UIRenderer.text_size(self._ui_renderer, title_text_loc, style.title_text.font_type, style.title_text.font_size, title_text_default_size)
	...
	local description_text_height = 20 + text_height
