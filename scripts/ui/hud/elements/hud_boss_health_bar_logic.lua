...
HudBossHealthBarLogic.init = function (self, settings)
...
HudBossHealthBarLogic._sync_player_health = function (self, bar_progress, bar_max_progress)
...
HudBossHealthBarLogic.update = function (self, dt, t, bar_progress, bar_max_progress)
...
HudBossHealthBarLogic._set_bar_fraction = function (self, name, fraction, current_fraction, total_duration, animation_threshold, force_update)
...
HudBossHealthBarLogic._update_bar_animations = function (self, dt, t)
	local bar_animations = self._bar_animations
...
HudBossHealthBarLogic._reset_bar_alpha = function (self)
	self:_set_alpha(255)
...
HudBossHealthBarLogic._update_bar_alpha = function (self, dt, t)
...
HudBossHealthBarLogic._update_bar_animation = function (self, anim_data, dt)
...
HudBossHealthBarLogic.alpha_multiplier = function (self)
	return self._alpha_multiplier
end

HudBossHealthBarLogic.animated_health_fractions = function (self)
	return self._health_fraction, self._health_ghost_fraction, self._health_max_fraction
end

HudBossHealthBarLogic._set_animated_health_fractions = function (self, health_fraction, health_ghost_fraction, health_max_fraction)
