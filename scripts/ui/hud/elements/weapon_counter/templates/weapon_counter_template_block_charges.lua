-- chunkname: @scripts/ui/hud/elements/weapon_counter/templates/weapon_counter_template_block_charges.lua
...
weapon_counter_template_block_charges.on_enter = function (hud_element_weapon_counter, slot_name, widget, template)
...
weapon_counter_template_block_charges.update_function = function (hud_element_weapon_counter, ui_renderer, widget, is_currently_wielded, weapon_counter_settings, template, dt, t)
