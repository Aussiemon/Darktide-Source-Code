-- chunkname: @scripts/ui/pass_templates/keybind_pass_templates.lua
...
KeybindPassTemplates.settings_keybind = function (width, height, settings_area_width, use_is_focused, is_sub_setting)
