...
local PlayerManagerTestify = {
	...
	teleport_bots_forward_on_main_path_if_blocked = function (bots_data, player_manager)
	...
	teleport_players_to_main_path_point = function (main_path_point, player_manager)
		local players = player_manager:players()
		local human_players = table.filter(players, function (player)
			return player:is_human_controlled()
		end)
	...
	teleport_player_to_position = function (position, player_manager)
		local players = player_manager:players()
		local human_players = table.filter(players, function (player)
			return player:is_human_controlled()
		end)
	...
	wait_for_bots_to_reach_position = function (wait_for_bots_position_data, player_manager)
	...
	wait_for_item_equipped = function (data, _)
