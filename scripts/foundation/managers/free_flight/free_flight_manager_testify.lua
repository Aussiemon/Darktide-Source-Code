...
local FreeFlightManagerTestify = {
	enter_free_flight = function (_, free_flight_manager)
	...
	set_free_flight_camera_position = function (camera_data, free_flight_manager)
	...
	free_flight_camera_follow_main_path = function (speed, free_flight_manager)
		free_flight_manager:toggle_follow_path()
		free_flight_manager:set_follow_path_speed(speed)
	end,
	free_flight_camera_is_arrived_end_of_main_path = function (_, free_flight_manager)
