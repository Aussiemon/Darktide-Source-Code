-- chunkname: @scripts/foundation/managers/backend/backend_manager_testify.lua

local BackendManagerTestify = {
	fail_on_not_authenticated = function (backend_manager)
	...
	load_mission_in_mission_board = function (backend_manager, params)
