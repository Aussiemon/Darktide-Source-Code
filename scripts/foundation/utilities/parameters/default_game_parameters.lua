...
DefaultGameParameters.qos_config = ""
...
DefaultGameParameters.default_max_footstep_decals = DEDICATED_SERVER and 0 or 30
...
DefaultGameParameters.expedition_step = 1
DefaultGameParameters.expedition_layout_seed = false
DefaultGameParameters.expedition_layout_config_name = false
...
DefaultGameParameters.show_premium_currency_store = true
...
DefaultGameParameters.cap_ui_frame_rate = true
...
DefaultGameParameters.extra_persistent_package = ""
DefaultGameParameters.persistent_breeds_lockhart = false
DefaultGameParameters.subresource_tlsf_allocator_win32 = false
DefaultGameParameters.show_live_event_objective_in_adventure = true
DefaultGameParameters.enable_low_memory_lua_state_dumps = false
DefaultGameParameters.enable_direct_storage_debug_map = false
DefaultGameParameters.destroy_unmanaged_particles = true
DefaultGameParameters.prod_like_backend = true
