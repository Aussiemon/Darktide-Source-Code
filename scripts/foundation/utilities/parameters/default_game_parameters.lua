...
DefaultGameParameters.enable_path_of_trust = false
...
DefaultGameParameters.enable_EAC_feature = false
...
DefaultGameParameters.beta_label_overlay_text = "Pre-Release Build July 22 - Closed Technical Test - No Streaming or Capturing Allowed"
DefaultGameParameters.enable_string_tags = false
DefaultGameParameters.network_wan = true
DefaultGameParameters.skip_prologue = true
