-- chunkname: @scripts/foundation/utilities/script_gui.lua

local ScriptGui = {}

ScriptGui.text = function (gui, text, font_material, font_size, pos, color, drop_shadow_color)
...
ScriptGui.irect = function (gui, res_x, res_y, x1, y1, x2, y2, layer, color)
...
ScriptGui.itext = function (gui, res_x, res_y, text, font_material, font_size, x1, y1, layer, color)
	Gui.slug_text(gui, text, font_material, font_size, Vector3(x1 * res_x, y1 * res_y, layer), nil, color)
end

ScriptGui.itext_next_xy = function (gui, res_x, res_y, text, font_material, font_size, x1, y1, layer, color)
	Gui.slug_text(gui, text, font_material, font_size, Vector3(x1 * res_x, y1 * res_y, layer), nil, color)
...
ScriptGui.icrect = function (gui, res_x, res_y, x1, y1, x2, y2, layer, color)
...
ScriptGui.ictext = function (gui, res_x, res_y, text, font_material, font_size, x1, y1, layer, color)
